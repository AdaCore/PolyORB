...
package body PolyORB.Any is
   ...
   procedure Free is new PolyORB.Utils.Unchecked_Deallocation.Free (Object => Content'Class, Name => Content_Ptr);
   ...
   package body Elementary_Any is
      ...
      procedure Free is new PolyORB.Utils.Unchecked_Deallocation.Free (Object => T, Name => T_Ptr);
...
--               R : CORBA.Object.Ref := CORBA.Object.Helper.From_Any (Right);
   ...
   package body TypeCode is
      ...
      procedure Free is new PolyORB.Utils.Unchecked_Deallocation.Free (Object => Union_TC_Map'Class, Name => Union_TC_Map_Ptr);
