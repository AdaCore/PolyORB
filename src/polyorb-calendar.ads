...
--  This package is meant to be used in place of Ada.Calendar, which
--  cannot be used with some tasking profiles.  PolYORB.Calendar
--  provides the same API as Ada.Calendar, except for the variable
--  declaration
...
package PolyORB.Calendar is
   ...
   --  Same definitions as ada-calendar
   ...
   procedure Split
     (Date    : Time_Type;
      ...
      Day     : out Day_Number;
      Seconds : out Day_Duration) is abstract;
   ...
   function "+" (Left : Time_Type; Right : Duration)
                return Time_Type is abstract;
   function "+" (Left : Duration; Right : Time_Type)
                return Time_Type is abstract;
   function "-" (Left : Time_Type; Right : Duration)
                return Time_Type is abstract;
   function "-" (Left : Time_Type; Right : Time_Type)
   ...
   procedure Destroy (CF : access Clock_Factory_Type;
