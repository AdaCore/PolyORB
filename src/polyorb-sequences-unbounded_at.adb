...
package body PolyORB.Sequences.Unbounded_AT is
   ...
   function "&" (Left : in Sequence; Right : in Element_Access)
     return Sequence
   is
   begin
   ...
   function "&" (Left : in Element_Access; Right : in Sequence)
     return Sequence
   is
   begin
   ...
   function "*" (Left : in Natural; Right : in Element_Access)
     return Sequence
   is
   begin
      return Left * Element_Array'(1 => Right);
