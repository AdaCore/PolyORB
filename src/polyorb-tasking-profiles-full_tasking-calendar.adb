...
package body PolyORB.Tasking.Profiles.Full_Tasking.Calendar is
   ...
   procedure Free is new Ada.Unchecked_Deallocation
     (Full_Tasking_Time_Type, Full_Tasking_Time_Type_Access);
   ...
   is
      ...
      New_Time : Full_Tasking_Time_Type_Access;
   begin
      New_Time := new Full_Tasking_Time_Type;
   ...
   is
      ...
      pragma Warnings (On);
   begin
      Free (Full_Tasking_Time_Type_Access (Clock));
   end Destroy;
   ...
   function Year (Date : Full_Tasking_Time_Type) return Year_Number is
      DY : Year_Number;
      DM : Month_Number;
      DD : Day_Number;
      DS : Day_Duration;
   ...
   function Day (Date : Full_Tasking_Time_Type) return Day_Number is
      DY : Year_Number;
      DM : Month_Number;
      DD : Day_Number;
      DS : Day_Duration;
   ...
   function Month (Date : Full_Tasking_Time_Type) return Month_Number is
      DY : Year_Number;
      DM : Month_Number;
      DD : Day_Number;
      DS : Day_Duration;
   ...
   function Seconds (Date : Full_Tasking_Time_Type) return Day_Duration is
      DY : Year_Number;
      DM : Month_Number;
      DD : Day_Number;
      DS : Day_Duration;
   ...
   begin
      PolyORB.Calendar.Register_Clock_Factory
        (The_Full_Tasking_Clock_Factory'Access);
   end Initialize;
