...
package body PortableInterceptor.IORInterceptor_3_0.Helper is
   ...
   package body Internals is
      ...
      IORInterceptor_3_0_Initialized : PolyORB.Std.Boolean :=
        False;

      -----------------------------------
      -- Initialize_IORInterceptor_3_0 --
      -----------------------------------

      procedure Initialize_IORInterceptor_3_0 is
      ...
      begin
         if not IORInterceptor_3_0_Initialized
         then
            IORInterceptor_3_0_Initialized :=
              True;
            PortableInterceptor.IORInterceptor_3_0.Helper.TC_IORInterceptor_3_0 :=
      ...
      end Initialize_IORInterceptor_3_0;
   ...
   function Unchecked_To_Local_Ref
     ...
     return PortableInterceptor.IORInterceptor_3_0.Local_Ref
   is
   ...
   begin
      PortableInterceptor.IORInterceptor_3_0.Helper.Internals.Initialize_IORInterceptor_3_0;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"PortableInterceptor.IORInterceptor_3_0.Helper",
