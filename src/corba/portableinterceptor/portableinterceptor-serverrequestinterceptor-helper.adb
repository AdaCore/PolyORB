...
package body PortableInterceptor.ServerRequestInterceptor.Helper is

   
   package body Internals is

      ServerRequestInterceptor_Initialized : PolyORB.Std.Boolean :=
        False;
      ...
      procedure Initialize_ServerRequestInterceptor is
      ...
      begin
         if not ServerRequestInterceptor_Initialized
         then
            ServerRequestInterceptor_Initialized :=
              True;
            PortableInterceptor.ServerRequestInterceptor.Helper.TC_ServerRequestInterceptor :=
      ...
      end Initialize_ServerRequestInterceptor;
   ...
   is
      Result : PortableInterceptor.ServerRequestInterceptor.Local_Ref;
   begin
      Set
        (Result,
   ...
   begin
      PortableInterceptor.ServerRequestInterceptor.Helper.Internals.Initialize_ServerRequestInterceptor;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"PortableInterceptor.ServerRequestInterceptor.Helper",
