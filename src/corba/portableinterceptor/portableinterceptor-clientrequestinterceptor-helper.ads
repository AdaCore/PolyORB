...
package PortableInterceptor.ClientRequestInterceptor.Helper is

   TC_ClientRequestInterceptor : CORBA.TypeCode.Object;
   ...
   package Internals is
      ...
      procedure Initialize_ClientRequestInterceptor;
