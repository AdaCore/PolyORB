...
package CONV_FRAME.Helper is
   ...
   function From_Any (Item : CORBA.Any) return CodeSetId;

   function To_Any (Item : CodeSetId) return CORBA.Any;
   ...
   function From_Any (Item : CORBA.Any) return CodeSetComponent;

   function To_Any (Item : CodeSetComponent) return CORBA.Any;
   ...
   function From_Any (Item : CORBA.Any) return CodeSetComponentInfo;

   function To_Any (Item : CodeSetComponentInfo) return CORBA.Any;
   ...
   function From_Any (Item : CORBA.Any) return CodeSetContext;

   function To_Any (Item : CodeSetContext) return CORBA.Any;
