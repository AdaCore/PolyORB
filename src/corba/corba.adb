...
--          end if;
--          pragma Debug
--            (O ("Equal (TypeCode) : parameter number comparison"));
...
--          pragma Debug
--            (O ("Equal (TypeCode) : recursive comparison"));
...
--          --  the given TypeCode kind. If any of these operations do not
--          --  return equal results, then equivalent returns FALSE. If all
--          --  comparisons are equal, equivalent returns true.
...
--    --  Duplicate  --
--    -----------------
--    function Duplicate (List : in Content_List)
--      return Content_List is
--    begin
