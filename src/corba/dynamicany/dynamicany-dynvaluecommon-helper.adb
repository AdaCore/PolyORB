...
package body DynamicAny.DynValueCommon.Helper is

   
   package body Internals is

      DynValueCommon_Initialized : PolyORB.Std.Boolean :=
        False;
      ...
      procedure Initialize_DynValueCommon is
      ...
      begin
         if not DynValueCommon_Initialized
         then
            DynValueCommon_Initialized :=
              True;
            DynamicAny.DynValueCommon.Helper.TC_DynValueCommon :=
   ...
   is
      Result : DynamicAny.DynValueCommon.Local_Ref;
   begin
      Set
        (Result,
   ...
   begin
      DynamicAny.DynValueCommon.Helper.Internals.Initialize_DynValueCommon;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"DynamicAny.DynValueCommon.Helper",
