...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--     D Y N A M I C A N Y . D Y N V A L U E C O M M O N . H E L P E R      --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
   ...
   begin
      declare
         Name : constant CORBA.String
           := CORBA.To_CORBA_String ("DynValueCommon");
      ...
      begin
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynValueCommon, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynValueCommon, CORBA.To_Any (Id));
      end;
