...
package body DynamicAny.DynStruct is
   ...
   begin
      ...
      return DynamicAny.DynStruct.Impl.current_member_name
        (DynamicAny.DynStruct.Impl.Object_Ptr
           (Entity_Of
              (Self)));
   ...
   begin
      ...
      return DynamicAny.DynStruct.Impl.current_member_kind
        (DynamicAny.DynStruct.Impl.Object_Ptr
           (Entity_Of
              (Self)));
   ...
   begin
      ...
      return DynamicAny.DynStruct.Impl.get_members
        (DynamicAny.DynStruct.Impl.Object_Ptr
           (Entity_Of
              (Self)));
   end get_members;
   ...
   begin
      ...
      DynamicAny.DynStruct.Impl.set_members
        (DynamicAny.DynStruct.Impl.Object_Ptr
           (Entity_Of
              (Self)),
         value);
   ...
   begin
      ...
      return DynamicAny.DynStruct.Impl.get_members_as_dyn_any
        (DynamicAny.DynStruct.Impl.Object_Ptr
           (Entity_Of
              (Self)));
   ...
   begin
      ...
      DynamicAny.DynStruct.Impl.set_members_as_dyn_any
        (DynamicAny.DynStruct.Impl.Object_Ptr
           (Entity_Of
              (Self)),
         value);
