...
package body DynamicAny.DynUnion.Helper is
   ...
   begin
      declare
         Name : constant CORBA.String := CORBA.To_CORBA_String ("DynUnion");
         Id   : constant CORBA.String
           := CORBA.To_CORBA_String ("IDL:omg.org/DynamicAny/DynUnion:1.0");

      begin
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynUnion, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynUnion, CORBA.To_Any (Id));
      end;
