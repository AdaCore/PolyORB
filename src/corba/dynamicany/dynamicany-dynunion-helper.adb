...
package body DynamicAny.DynUnion.Helper is

   
   package body Internals is

      DynUnion_Initialized : PolyORB.Std.Boolean :=
        False;
      ...
      procedure Initialize_DynUnion is
      ...
      begin
         if not DynUnion_Initialized
         then
            DynUnion_Initialized :=
              True;
            DynamicAny.DynUnion.Helper.TC_DynUnion :=
   ...
   is
      Result : DynamicAny.DynUnion.Local_Ref;
   begin
      Set
        (Result,
   ...
   begin
      DynamicAny.DynUnion.Helper.Internals.Initialize_DynUnion;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"DynamicAny.DynUnion.Helper",
