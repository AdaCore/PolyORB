...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--             D Y N A M I C A N Y . D Y N A R R A Y . I M P L              --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body DynamicAny.DynArray.Impl is
   ...
   package body Internals is
      ...
      begin
         pragma Assert (Kind (CORBA.Get_Type (Value)) = Tk_Array);
   ...
   begin
      return
        CORBA.Is_Equivalent
          (Logical_Type_Id, DynamicAny.DynArray.Repository_Id)
          or else
        CORBA.Is_Equivalent
