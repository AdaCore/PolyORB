...
package body DynamicAny.DynValueCommon is
   ...
   function Is_Null (Self : Local_Ref) return CORBA.Boolean is
   ...
   begin
      ...
      return Impl.Is_Null (Impl.Object_Ptr (Entity_Of (Self)));
   end Is_Null;
   ...
   procedure Set_To_Null (Self : Local_Ref) is
      Self_Ref : constant CORBA.Object.Ref := CORBA.Object.Ref (Self);
   ...
   begin
      ...
      Impl.Set_To_Null (Impl.Object_Ptr (Entity_Of (Self)));
   end Set_To_Null;
   ...
   procedure Set_To_Value (Self : Local_Ref) is
      Self_Ref : constant CORBA.Object.Ref := CORBA.Object.Ref (Self);
   ...
   begin
      ...
      Impl.Set_To_Value (Impl.Object_Ptr (Entity_Of (Self)));
   end Set_To_Value;
