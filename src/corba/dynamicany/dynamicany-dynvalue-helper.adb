...
package body DynamicAny.DynValue.Helper is
   ...
   package body Internals is
      ...
      DynValue_Initialized : PolyORB.Std.Boolean :=
        False;
      ...
      procedure Initialize_DynValue is
      ...
      begin
         if not DynValue_Initialized
         then
            DynValue_Initialized :=
              True;
            DynamicAny.DynValue.Helper.TC_DynValue :=
   ...
   begin
      DynamicAny.DynValue.Helper.Internals.Initialize_DynValue;
