...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--            D Y N A M I C A N Y . D Y N E N U M . H E L P E R             --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body DynamicAny.DynEnum.Helper is
   ...
   begin
      declare
         Name : constant CORBA.String := CORBA.To_CORBA_String ("DynEnum");
         Id   : constant CORBA.String
           := CORBA.To_CORBA_String ("IDL:omg.org/DynamicAny/DynEnum:1.0");

      begin
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynEnum, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynEnum, CORBA.To_Any (Id));
      end;
