...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--           D Y N A M I C A N Y . D Y N F I X E D . H E L P E R            --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body DynamicAny.DynFixed.Helper is
   ...
   begin
      declare
         Name : constant CORBA.String := CORBA.To_CORBA_String ("DynFixed");
         Id   : constant CORBA.String
           := CORBA.To_CORBA_String ("IDL:omg.org/DynamicAny/DynFixed:1.0");

      begin
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynFixed, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynFixed, CORBA.To_Any (Id));
      end;
