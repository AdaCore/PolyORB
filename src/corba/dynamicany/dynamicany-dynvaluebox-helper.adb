...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--        D Y N A M I C A N Y . D Y N V A L U E B O X . H E L P E R         --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body DynamicAny.DynValueBox.Helper is
   ...
   begin
      declare
         Name : constant CORBA.String := CORBA.To_CORBA_String ("DynValueBox");
         Id   : constant CORBA.String
           := CORBA.To_CORBA_String ("IDL:omg.org/DynamicAny/DynValueBox:1.0");

      begin
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynValueBox, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynValueBox, CORBA.To_Any (Id));
      end;
