...
package body DynamicAny.DynStruct.Helper is
   ...
   package body Internals is
      ...
      DynStruct_Initialized : PolyORB.Std.Boolean :=
        False;
      ...
      procedure Initialize_DynStruct is
      ...
      begin
         if not DynStruct_Initialized
         then
            DynStruct_Initialized :=
              True;
            DynamicAny.DynStruct.Helper.TC_DynStruct :=
   ...
   begin
      DynamicAny.DynStruct.Helper.Internals.Initialize_DynStruct;
