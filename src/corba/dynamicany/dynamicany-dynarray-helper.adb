...
package body DynamicAny.DynArray.Helper is

   
   package body Internals is

      DynArray_Initialized : PolyORB.Std.Boolean :=
        False;
      ...
      procedure Initialize_DynArray is
      ...
      begin
         if not DynArray_Initialized
         then
            DynArray_Initialized :=
              True;
            DynamicAny.DynArray.Helper.TC_DynArray :=
   ...
   is
      Result : DynamicAny.DynArray.Local_Ref;
   begin
      Set
        (Result,
   ...
   begin
      DynamicAny.DynArray.Helper.Internals.Initialize_DynArray;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"DynamicAny.DynArray.Helper",
