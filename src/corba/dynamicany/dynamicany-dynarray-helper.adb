...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--           D Y N A M I C A N Y . D Y N A R R A Y . H E L P E R            --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body DynamicAny.DynArray.Helper is
   ...
   begin
      declare
         Name : constant CORBA.String := CORBA.To_CORBA_String ("DynArray");
         Id   : constant CORBA.String
           := CORBA.To_CORBA_String ("IDL:omg.org/DynamicAny/DynArray:1.0");

      begin
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynArray, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter
           (TC_DynArray, CORBA.To_Any (Id));
      end;
