...
package body DynamicAny.DynSequence.Helper is
   ...
   package body Internals is
      ...
      DynSequence_Initialized : PolyORB.Std.Boolean :=
        False;

      ----------------------------
      -- Initialize_DynSequence --
      ----------------------------

      procedure Initialize_DynSequence is
      ...
      begin
         if not DynSequence_Initialized
         then
            DynSequence_Initialized :=
              True;
            DynamicAny.DynSequence.Helper.TC_DynSequence :=
   ...
   function From_Any
     (Item : CORBA.Any)
     return DynamicAny.DynSequence.InvalidValue_Members
     renames DynamicAny.DynAny.Helper.From_Any;

   function To_Any
     (Item : DynamicAny.DynSequence.InvalidValue_Members)
     return CORBA.Any
     renames DynamicAny.DynAny.Helper.To_Any;

   function From_Any
     (Item : CORBA.Any)
     return DynamicAny.DynSequence.TypeMismatch_Members
     renames DynamicAny.DynAny.Helper.From_Any;

   function To_Any
     (Item : DynamicAny.DynSequence.TypeMismatch_Members)
     return CORBA.Any
     renames DynamicAny.DynAny.Helper.To_Any;
   ...
   begin
      DynamicAny.DynSequence.Helper.Internals.Initialize_DynSequence;
