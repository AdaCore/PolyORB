...
--    subtype Content is Droopi.Any.Content;
--    subtype Any_Content_Ptr is Droopi.Any.Any_Content_Ptr;
--    subtype Any_Content_Ptr_Ptr is Droopi.Any.Any_Content_Ptr_Ptr;
...
--    procedure Deallocate_Any_Content
--      (X : in out Any_Content_Ptr);
--    --  Frees an Any_Content_Ptr_Ptr
--    procedure Deallocate_Any_Content_Ptr
--      (X : in out Any_Content_Ptr_Ptr);
...
--    subtype Content_Octet is Droopi.Any.Content_Octet;
