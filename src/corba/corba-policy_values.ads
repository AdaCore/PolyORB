package CORBA.Policy_Values is
   ...
   subtype ThreadPolicyValue is Value
     range ORB_CTRL_MODEL .. MAIN_THREAD_MODEL;
   subtype LifespanPolicyValue is Value
     range TRANSIENT .. PERSISTENT;
   subtype IdUniquenessPolicyValue is Value
     range UNIQUE_ID .. MULTIPLE_ID;
   subtype IdAssignementPolicyValue is Value
     range USER_ID .. SYSTEM_ID;
   subtype ImplicitActivationPolicyValue is Value
     range IMPLICIT_ACTIVATION .. NO_IMPLICIT_ACTIVATION;
   subtype ServantRetentionPolicyValue is Value
     range RETAIN .. NON_RETAIN;
   subtype RequestProcessingPolicyValue is Value
