...
\subsubsection{Manipulation des données utilisateurs}

Le paquetage Droopi.Any permet de manipuler toute donnée
...
%%  ./droopi-annotations.ads

%%  ./droopi-binding_data-local.ads
%%  ./droopi-binding_data-srp.ads
%%  ./droopi-binding_data-test.ads
