...
\item[Aiguillage]\mbox{}
  ...
  (un fil de contrôle) doit être affecté à son traitement. L'exécutif
...
\item[Nommage]\mbox{}
  ...
  de suivre des changements technologique, ou des évolutions des besoins
...
\ifexamples
  ...
  le n{\oe}uds sur lequel chacune de ces unités réside.
...
\item[Référentiel des interfaces]\mbox{}
  ...
  base de données de descritpions d'interfaces accessible
...
\ifexamples
  ...
  on monte~\cite{mattern87:termination} que l'état de l'application
...
\item[Données partagées]\mbox{}
  ...
  utilisateurs. Plusieurs modèles de cohérences peuvent être
  définis.
...
\begin{description}
\item[Adressage] The caller determines a reference to the object.
