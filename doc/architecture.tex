...
alors ainsi~:
\begin{description}
\item[Adressage] L'appelant détermine une référence sur de l'objet.

\item[Transport] À partir de l'adresse réseau contenue dans
  la référence, le service de transport de l'intergiciel client
  crée une connection vers l'intergiciel serveur.

\item[Liaisons] La référence est associée à la connection de transport,
