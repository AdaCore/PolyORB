...
package body Chicken is
   ...
   Tc_Chicken : constant Corba.Typecode.Object :=
      Corba.Typecode.Object_Typecode
         ( Id => Chicken_R_Id, 
           Name => Corba.To_Unbounded_String( "Chicken"));


   function To_Chicken (Self : Corba.Object.Ref'class) return Ref'class is
      This : Ref ;
   begin
   ...
   function lay
      ( Self : in Ref)
         return chicken_egg_IDL_File.Egg_Forward.Ref is
   ...
   begin
      ...
      Corba.Orb.Client_Send_And_Receive ( Self    => Tgx_Orb,
                                          ...
                                          Stream  => Tgx_Stream'access);
      -- Get the result
      chicken_egg_IDL_File.Egg_Forward.Ref'Read (Tgx_Stream'access, Tgx_Result);
      return Tgx_Result;
   ...
   package Chicken_To_Any is new Corba.Object.Ref_To_Any_Conversion
      (Ref => Ref, Code => Tc_Chicken) ;

   function To_Any (From : in Ref) return Corba.Any renames
      Chicken_To_Any.Ref_To_Any ;

   function To_Ref (From : in Corba.Any) return Ref renames
      Chicken_To_Any.Any_To_Ref ;
end Chicken;
