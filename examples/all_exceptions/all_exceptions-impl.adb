...
package body all_exceptions.Impl is
   ...
   procedure Not_Implemented_Yet_exception_test (Self : access Object) is
   begin
      raise Not_Implemented_Yet;
   end;
   procedure Not_Initialized_Yet_exception_test (Self : access Object) is
   begin
   ...
   procedure Wrong_Union_Case_exception_test (Self : access Object) is
   begin
