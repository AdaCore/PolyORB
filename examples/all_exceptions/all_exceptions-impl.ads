...
package all_exceptions.Impl is
   ...
   procedure No_Resources_exception_test(Self : access Object);
   ...
   procedure Transient_exception_test(Self : access Object);
   procedure Free_Mem_exception_test(Self : access Object);
   procedure Inv_Ident_exception_test(Self : access Object);
   ...
   procedure Data_Conversion_exception_test(Self : access Object);
   procedure AdaBroker_Fatal_Error_exception_test(Self : access Object);
   procedure Not_Implemented_Yet_exception_test(Self : access Object);
   procedure Not_Initialized_Yet_exception_test(Self : access Object);
   procedure C_Out_Of_Range_exception_test(Self : access Object);
   procedure Wrong_Union_Case_exception_test(Self : access Object);
