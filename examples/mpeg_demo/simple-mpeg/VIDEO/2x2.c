...
void
imageMpegDecoder::Init2x2Dither()
{  
...
void imageMpegDecoder::RandInit(int h, int w)
{
  int i;
...
void
imageMpegDecoder::PostInit2x2Dither() 
{
  unsigned char *dith_ca;
  int i;
...
void 
imageMpegDecoder::Twox2DitherImage(unsigned char * lum, unsigned char * cr,unsigned char *  cb, unsigned char * out,int  h,int  w)
{
  int i, j;
