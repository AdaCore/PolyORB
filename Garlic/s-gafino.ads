...
package System.Garlic.Filters.None is

private

   type None_Filter_Type is new Filter_Type with null record;

   type None_Filter_Params_Type is new Filter_Params_Type with null record;
