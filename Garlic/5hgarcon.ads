...
package System.Garlic.Constants is
   ...
   Ewouldblock          : constant := 16#00F6#;
   Einprogress          : constant := 16#00F5#;
   Ealready             : constant := 16#00F4#;
   Eisconn              : constant := 16#00EA#;
   Econnrefused         : constant := 16#00EF#;
   Fndelay              : constant := 16#0004#;
   Fasync               : constant := -2147195267;
   F_Getfl              : constant := 16#0003#;
   F_Setfl              : constant := 16#0004#;
   F_Setown             : constant := 16#000C#;
   ...
   I_Setsig             : constant := 16#20005309#;
   S_Rdnorm             : constant := 16#0010#;
   S_Wrnorm             : constant := 16#0040#;
