...
--  this is the NT specific package.
...
private
   ...
   --  here we start the winsock service.
   function Start_Winsock return C.int;
   pragma Import (C, Start_Winsock);

   Started : C.int := Start_Winsock;
