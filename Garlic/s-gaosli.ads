...
package System.Garlic.OS_Lib is

   function C_Errno return Interfaces.C.int;
   --  Return C variable errno

   function Getenv (Name : String) return String;
   --  Return the value of the environment variable Name or an empty
   --  string if this variable doesn't exist.
