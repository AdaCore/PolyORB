...
pragma Elaborate (CosNotifyChannelAdmin.SequenceProxyPushSupplier.Helper);
pragma Warnings
   (Off, CosNotifyChannelAdmin.SequenceProxyPushSupplier.Helper);

with CosNotifyChannelAdmin.SequenceProxyPushSupplier.Skel;
pragma Elaborate (CosNotifyChannelAdmin.SequenceProxyPushSupplier.Skel);
...
package body CosNotifyChannelAdmin.SequenceProxyPushSupplier.Impl is
   ...
   procedure Connect_Sequence_Push_consumer
     (Self          : access Object;
      Push_Consumer : in CosNotifyComm.SequencePushConsumer.Ref) is
   begin
      Ensure_Initialization;
      pragma Debug
