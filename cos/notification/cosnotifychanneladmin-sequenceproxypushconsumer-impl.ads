...
package CosNotifyChannelAdmin.SequenceProxyPushConsumer.Impl is
   ...
   --  Inherited IDL operations from CosNotifyComm::SequencePushConsumer
...
private
   ...
   type Sequence_Proxy_Push_Consumer_Record;

   type Sequence_Proxy_Push_Consumer_Access is access
        Sequence_Proxy_Push_Consumer_Record;

   type Object is new PortableServer.Servant_Base with record
      X : Sequence_Proxy_Push_Consumer_Access;
   end record;
