...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--          COSNOTIFYCHANNELADMIN.SEQUENCEPROXYPULLCONSUMER.IMPL            --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
pragma Elaborate (CosNotifyChannelAdmin.SequenceProxyPullConsumer.Helper);
pragma Warnings
   (Off, CosNotifyChannelAdmin.SequenceProxyPullConsumer.Helper);

with CosNotifyChannelAdmin.SequenceProxyPullConsumer.Skel;
pragma Elaborate (CosNotifyChannelAdmin.SequenceProxyPullConsumer.Skel);
...
package body CosNotifyChannelAdmin.SequenceProxyPullConsumer.Impl is
   ...
   use PolyORB.Log;
   package L is new PolyORB.Log.Facility_Log ("sequenceproxypullconsumer");
   procedure O (Message : in Standard.String; Level : Log_Level := Debug)
     renames L.Output;

   type Sequence_Proxy_Pull_Consumer_Record is record
      This           : Object_Ptr;
   ...
   begin
      ...
      This := A_S;
      --  This is initialized
      --  we can let Connect_Sequence_Pull_Supplier go
      Enter  (Session_Mutex);
      ...
      loop
         ...
         exit when CosNotifyComm.SequencePullSupplier.Is_Nil (Peer);

         pragma Debug
         (O ("pull sequence of structured event from " &
             "sequenceproxypullconsumer engin"));

         begin
            Event := CosNotifyComm.SequencePullSupplier.pull_structured_events
                       (Peer, Max_Number);
         ...
         pragma Debug
         (O ("post sequence of structured events from " &
             "sequenceproxypullconsumer to admin"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug
      (O ("connect_sequence_pull_supplier in sequenceproxypullconsumer"));
   ...
   end Connect_Sequence_Pull_Supplier;
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("suspend_connection in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("resume_connection in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_mytype in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_myadmin in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug
      (O ("obtain_subscription_types in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("validate_event_qos in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_qos in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("set_qos in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("validate_qos in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("add_filter in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("remove_filter in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_filter in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_all_filters in sequenceproxypullconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("remove_all_filters in sequenceproxypullconsumer"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("offer_change in sequenceproxypullconsumer"));
   ...
   is
      Peer    : CosNotifyComm.SequencePullSupplier.Ref;
      Nil_Ref : CosNotifyComm.SequencePullSupplier.Ref;
   begin
      pragma Debug (O ("disconnect sequenceproxypullconsumer"));
      ...
      if not CosNotifyComm.SequencePullSupplier.Is_Nil (Peer) then
   ...
   is
      Consumer : Object_Ptr;
      My_Ref   : SequenceProxyPullConsumer.Ref;
   begin
      pragma Debug (O ("create sequenceproxypullconsumer"));

      Consumer              := new Object;
      Consumer.X            := new Sequence_Proxy_Pull_Consumer_Record;
...
end CosNotifyChannelAdmin.SequenceProxyPullConsumer.Impl;
