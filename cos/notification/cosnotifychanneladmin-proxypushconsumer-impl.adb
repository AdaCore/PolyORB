...
pragma Elaborate (CosNotifyChannelAdmin.ProxyPushConsumer.Helper);
pragma Warnings (Off, CosNotifyChannelAdmin.ProxyPushConsumer.Helper);

with CosNotifyChannelAdmin.ProxyPushConsumer.Skel;
pragma Elaborate (CosNotifyChannelAdmin.ProxyPushConsumer.Skel);
