...
package CosNotifyFilter.FilterFactory.Impl is
...
private
   ...
   type Filter_Factory_Record;
   type Filter_Factory_Access is access Filter_Factory_Record;

   type Object is new PortableServer.Servant_Base with record
      X : Filter_Factory_Access;
   end record;
