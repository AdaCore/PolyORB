...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--          COSNOTIFYCHANNELADMIN.SEQUENCEPROXYPUSHCONSUMER.IMPL            --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body CosNotifyChannelAdmin.SequenceProxyPushConsumer.Impl is
   ...
   procedure Connect_Sequence_Push_Supplier
     (Self          : access Object;
      Push_Supplier : in CosNotifyComm.SequencePushSupplier.Ref) is
   begin
      Ensure_Initialization;
      pragma Debug
      (O ("connect_sequence_push_supplier in sequenceproxypushconsumer"));

      Enter (Self_Mutex);
      if not CosNotifyComm.SequencePushSupplier.Is_Nil (Self.X.Peer) then
         Leave (Self_Mutex);
   ...
   end Connect_Sequence_Push_Supplier;
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_mytype in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_myadmin in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug
      (O ("obtain_subscription_types in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("validate_event_qos in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_qos in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("set_qos in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("validate_qos in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("add_filter in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("remove_filter in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_filter in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("get_all_filters in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("remove_all_filters in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug (O ("offer_change in sequenceproxypushconsumer"));
   ...
   begin
      Ensure_Initialization;
      pragma Debug
      (O ("push new structured event from sequenceproxypushconsumer " &
          "to supplier admin"));
   ...
   is
      Peer    : CosNotifyComm.SequencePushSupplier.Ref;
      Nil_Ref : CosNotifyComm.SequencePushSupplier.Ref;
   begin
      Ensure_Initialization;
      pragma Debug (O ("disconnect sequenceproxypushconsumer"));
      ...
      if not CosNotifyComm.SequencePushSupplier.Is_Nil (Peer) then
   ...
   is
      Consumer : Object_Ptr;
      My_Ref   : SequenceProxyPushConsumer.Ref;
   begin
      pragma Debug (O ("create sequenceproxypushconsumer"));

      Consumer              := new Object;
      Consumer.X            := new Sequence_Proxy_Push_Consumer_Record;
...
end CosNotifyChannelAdmin.SequenceProxyPushConsumer.Impl;
