...
package CosNotifyChannelAdmin.ProxySupplier.Impl is
...
private
   ...
   type Proxy_Supplier_Record;
   type Proxy_Supplier_Access is access Proxy_Supplier_Record;

   type Object is new PortableServer.Servant_Base with record
      X : Proxy_Supplier_Access;
   end record;
