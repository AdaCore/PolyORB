...
package CosNotifyChannelAdmin.StructuredProxyPushSupplier.Impl is
...
private
   ...
   type Structured_Proxy_Push_Supplier_Record;

   type Structured_Proxy_Push_Supplier_Access is access
      Structured_Proxy_Push_Supplier_Record;

   type Object is new PortableServer.Servant_Base with record
      X : Structured_Proxy_Push_Supplier_Access;
   end record;
