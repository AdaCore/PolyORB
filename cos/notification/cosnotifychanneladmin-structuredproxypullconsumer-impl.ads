...
package CosNotifyChannelAdmin.StructuredProxyPullConsumer.Impl is
   ...
   procedure Connect_Structured_Pull_Supplier
     (Self : access Object;
      Pull_Supplier : in CosNotifyComm.StructuredPullSupplier.Ref);
   ...
   --  Inherited IDL operations from CosNotifyComm::StructuredPullConsumer
...
private
   ...
   type Structured_Proxy_Pull_Consumer_Record;

   type Structured_Proxy_Pull_Consumer_Access is access
        Structured_Proxy_Pull_Consumer_Record;

   type Object is new PortableServer.Servant_Base with record
      X : Structured_Proxy_Pull_Consumer_Access;
   end record;
