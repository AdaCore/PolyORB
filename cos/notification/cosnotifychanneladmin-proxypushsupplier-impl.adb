...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--              COSNOTIFYCHANNELADMIN.PROXYPUSHSUPPLIER.IMPL                --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
pragma Elaborate (CosNotifyChannelAdmin.ProxyPushSupplier.Helper);
pragma Warnings (Off, CosNotifyChannelAdmin.ProxyPushSupplier.Helper);

with CosNotifyChannelAdmin.ProxyPushSupplier.Skel;
pragma Elaborate (CosNotifyChannelAdmin.ProxyPushSupplier.Skel);
pragma Warnings (Off, CosNotifyChannelAdmin.ProxyPushSupplier.Skel);
...
package body CosNotifyChannelAdmin.ProxyPushSupplier.Impl is
   ...
   type Proxy_Push_Supplier_Record is record
      ...
      Peer       : CosEventComm.PushConsumer.Ref;
   ...
   procedure Connect_Any_Push_Consumer
     (Self          : access Object;
      Push_Consumer : in     CosEventComm.PushConsumer.Ref)
   is
   begin
      pragma Debug (O ("connect_any_push_consumer in proxypushsupplier"));

      Ensure_Initialization;

      Enter (Self_Mutex);
      if not CosEventComm.PushConsumer.Is_Nil (Self.X.Peer) then
         Leave (Self_Mutex);
   ...
   begin
      pragma Debug (O ("suspend_connection in proxypushsupplier"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("resume_connection in proxypushsupplier"));
   ...
   is
      MyType : CosNotifyChannelAdmin.ProxyType;
   begin
      pragma Debug (O ("get_mytype in proxypushsupplier"));
   ...
   begin
      pragma Debug (O ("get_myadmin in proxypushsupplier"));
   ...
   begin
      pragma Debug (O ("get_priority_filter in proxypushsupplier"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("set_priority_filter in proxypushsupplier"));
   ...
   is
      ...
      MyFilter : CosNotifyFilter.MappingFilter.Ref;
   begin
      pragma Debug (O ("get_lifetime_filter in proxypushsupplier"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("set_lifetime_filter in proxypushsupplier"));
   ...
   begin
      pragma Debug (O ("obtain_offered_types in proxypushsupplier"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("validate_event_qos in proxypushsupplier"));
      Ensure_Initialization;
   ...
   begin
      pragma Debug (O ("get_qos in proxypushsupplier"));
   ...
   is
      ...
      SeqLen     : Integer;
   begin
      pragma Debug (O ("set_qos in proxypushsupplier"));
   ...
   is
      ...
      SeqLen       : Integer;
   begin
      pragma Debug (O ("validate_qos in proxypushsupplier"));
   ...
   is
      ...
      MyID       : CORBA.Long;
   begin
      pragma Debug (O ("add_filter in proxypushsupplier"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("remove_filter in proxypushsupplier"));
   ...
   begin
      pragma Debug (O ("get_filter in proxypushsupplier"));
   ...
   begin
      pragma Debug (O ("get_all_filters in proxypushsupplier"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("remove_all_filters in proxypushsupplier"));
   ...
   is
      ...
      pragma Warnings (On);  --  WAG:3.14
   begin
      pragma Debug (O ("subscription_change in proxypushsupplier"));
   ...
   is
      Peer    : CosEventComm.PushConsumer.Ref;
      Nil_Ref : CosEventComm.PushConsumer.Ref;
   begin
      pragma Debug (O ("disconnect proxypushsupplier"));
      ...
      if not CosEventComm.PushConsumer.Is_Nil (Peer) then
         CosEventComm.PushConsumer.disconnect_push_consumer (Peer);
      end if;
   ...
   begin
      pragma Debug (O ("create proxy pushsupplier"));
   ...
   procedure Post
     (Self : access Object;
      Data : in     CORBA.Any)
   is
      MyPeer : CosEventComm.PushConsumer.Ref;
   begin
      pragma Debug
        (O ("post new data from proxy pushsupplier to push consumer"));
      ...
      begin
         CosEventComm.PushConsumer.push (MyPeer, Data);
      exception
         when others =>
            pragma Debug (O ("Got exception in post at proxy push supplier"));
            raise;
      end;
   end Post;

end CosNotifyChannelAdmin.ProxyPushSupplier.Impl;
