...
pragma Elaborate (CosNotifyChannelAdmin.StructuredProxyPullConsumer.Helper);
pragma Warnings
   (Off, CosNotifyChannelAdmin.StructuredProxyPullConsumer.Helper);

with CosNotifyChannelAdmin.StructuredProxyPullConsumer.Skel;
pragma Elaborate (CosNotifyChannelAdmin.StructuredProxyPullConsumer.Skel);
...
package body CosNotifyChannelAdmin.StructuredProxyPullConsumer.Impl is
   ...
   procedure Connect_Structured_Pull_Supplier
     (Self          : access Object;
      Pull_Supplier : in CosNotifyComm.StructuredPullSupplier.Ref) is
   begin
      Ensure_Initialization;
      pragma Debug
