...
package CosNotifyChannelAdmin.SequenceProxyPushSupplier.Impl is
   ...
   procedure Connect_Sequence_Push_consumer
     (Self          : access Object;
      Push_Consumer : in CosNotifyComm.SequencePushConsumer.Ref);
   ...
   --  IDL operations inherited from CosNotifyComm::StructuredPushSupplier
...
private
   ...
   type Sequence_Proxy_Push_Supplier_Record;

   type Sequence_Proxy_Push_Supplier_Access is access
      Sequence_Proxy_Push_Supplier_Record;

   type Object is new PortableServer.Servant_Base with record
      X : Sequence_Proxy_Push_Supplier_Access;
   end record;
