...
package CosNotifyChannelAdmin.StructuredProxyPullSupplier.Impl is
   ...
   --  IDL operations inherited from CosNotifyComm::StructuredPullSupplier
...
private
   ...
   type Structured_Proxy_Pull_Supplier_Record;
   type Structured_Proxy_Pull_Supplier_Access is access
        Structured_Proxy_Pull_Supplier_Record;

   type Object is new PortableServer.Servant_Base with record
      X : Structured_Proxy_Pull_Supplier_Access;
   end record;
