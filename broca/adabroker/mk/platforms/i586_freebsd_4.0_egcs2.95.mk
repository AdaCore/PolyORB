#
# i586_freebsd_4.0.mk - make variables and rules specific to FreeBSD 4.0.
#
...
CXXDEBUGFLAGS =  -g
CXXOPTIONS    =  -fexceptions -Wall -Wno-unused -DHAS_Std_Namespace
...
IMPORT_CPPFLAGS += -D__x86__ -D__freebsd__ -D__OSVERSION__=2
