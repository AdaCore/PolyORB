...
procedure Dynclient is
   ...
   procedure Out_Proc (Self : in CORBA.Object.Ref;
      ...
      Request : CORBA.Request.Object;
      Ctx : CORBA.Context.Ref;
      Argument_A : CORBA.Any := To_Any (Corba.Short (0));
--  Get_Empty_Any (CORBA.TC_Short);
      Argument_B : CORBA.Any := To_Any (Corba.Short (0));
--  Get_Empty_Any (CORBA.TC_Short);
      Argument_C : CORBA.Any := To_Any (Corba.Short (0));
--  Get_Empty_Any (CORBA.TC_Short);
      Arg_List : CORBA.NVList.Ref;
      Result : CORBA.NamedValue;
      Result_Name : CORBA.String := To_CORBA_String ("Result");
