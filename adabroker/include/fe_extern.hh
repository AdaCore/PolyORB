...
extern void			FE_init_stage1();	// Initialize stage 1
extern void			FE_init_stage2();	// Initialize stage 2
...
extern int			FE_yyparse();		// Invode yyparse
extern void			FE_set_yyin(File *);	// Set yyin
...
extern UTL_Error *		FE_new_UTL_Error();
extern UTL_Indenter *	FE_new_UTL_Indenter();
extern UTL_String *  	FE_new_UTL_String(char *);
