...
lib_depend := $(patsubst %,$(DLLPattern),omniORB270)
omniORB_lib_depend := $(GENERATE_LIB_DEPEND)
lib_depend := $(patsubst %,$(DLLPattern),omniDynamic270)
...
OMNIORB2_LIB = $(patsubst %,$(DLLSearchPattern),omniORB270) \
		$(patsubst %,$(DLLSearchPattern),omniDynamic270) \
		$(OMNITHREAD_LIB) wsock32.lib advapi32.lib
OMNIORB2_LIB_NODYN = $(patsubst %,$(DLLSearchPattern),omniORB270) \
		$(OMNITHREAD_LIB) wsock32.lib advapi32.lib
