...
***                             file:  adabe_generator.cc                                      ***
***                                                                                            ***
***      This file provides the implementation of class adabe_generator declared in adabe.h    ***
***   (L 635). This class is the correspondant of the Sun's Front-End class AST_Generator.     ***
***   It contains the constructors for the node of the AST.                                    ***
***                                                                                            ***
***   Copyright 1999                                                                           ***
