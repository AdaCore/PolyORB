...
7		cerr << "A node type of the type : " << d->node_type ();
		...
		case AST_Decl::NT_interface:
		  {
			...
			// production and computing the interface string
    ...
    ////////////////////////////////////////////////
    // generation of the header of the proxy files
		...
		case AST_Decl::NT_module:
		  {
		    ...
		    module->produce_proxy_ads (proxy_header_module_with, proxy_header_module_body,
		...
		case AST_Decl::NT_interface:
		  {
		    ...
		    interface->produce_proxy_ads (proxy_header_interface_with,
		    ...
		    string proxy_header_interface_file_name =
		      remove_dot (interface->get_ada_full_name ())+"-proxy.ads";
    ...
    //////////////////////////////////////////
    // generation of body of the proxy files
		...
		case AST_Decl::NT_module:
		  {
		    ...
		    // tries to find interface in the module
		    module->produce_proxy_adb (proxy_body_module_with, proxy_body_module_body,
		...
		case AST_Decl::NT_interface:
		  {
		    ...
		    interface->produce_proxy_adb (proxy_body_interface_with, proxy_body_interface_body,
		    ...
		    string proxy_body_interface_file_name =
		      remove_dot (interface->get_ada_full_name ())+"-proxy.adb";
    ...
    ////////////////////////////////////////////////
    // generation of te header of the skel files
    
    {
      // skel files are only produced for interfaces
