...
package body Harness.Helper is
   ...
   begin
      ...
      declare
         Name : CORBA.String := CORBA.To_CORBA_String ("Harness");
         Id : CORBA.String := CORBA.To_CORBA_String ("IDL:Harness:1.0");
      begin
         CORBA.TypeCode.Internals.Add_Parameter (TC_Harness, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter (TC_Harness, CORBA.To_Any (Id));
      end;
