...
package body Inter1.Helper is
   ...
   begin
      CORBA.Internals.Set_Type (A, TC_Inter1);
      return A;
   end To_Any;
   ...
   begin
      ...
      begin
         CORBA.TypeCode.Internals.Add_Parameter (TC_Inter1, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter (TC_Inter1, CORBA.To_Any (Id));
      end;
