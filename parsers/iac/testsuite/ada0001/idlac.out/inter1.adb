...
package body Inter1 is
   ...
   begin
      ...
      Result_Ü
        := (Name => PolyORB.Types.Identifier (Result_Name_Ü),
            Argument => CORBA.Internals.To_PolyORB_Any 
        (CORBA.Internals.Get_Empty_Any (CORBA.TC_Boolean)),
         Arg_Modes => 0);
   ...
   begin
      ...
      Result_Ü
        := (Name => PolyORB.Types.Identifier (Result_Name_Ü),
            Argument => CORBA.Internals.To_PolyORB_Any 
        (CORBA.Internals.Get_Empty_Any (CORBA.TC_Long)),
         Arg_Modes => 0);
   ...
   begin
      ...
      Result_Ü
        := (Name => PolyORB.Types.Identifier (Result_Name_Ü),
            Argument => CORBA.Internals.To_PolyORB_Any 
        (CORBA.Internals.Get_Empty_Any (CORBA.TC_Long_Long)),
         Arg_Modes => 0);
   ...
   is
      ...
      Argument_Ü_code : CORBA.Any
        := CORBA.To_Any
        (code);Arg_Name_Ü_str : PolyORB.Types.Identifier
