...
package body m2.I21.Helper is
   ...
   begin
      ...
      begin
         CORBA.TypeCode.Internals.Add_Parameter (TC_I21, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter (TC_I21, CORBA.To_Any (Id));
      end;
      ...
      begin
         CORBA.TypeCode.Internals.Add_Parameter (TC_new_bool, CORBA.To_Any (Name));
         CORBA.TypeCode.Internals.Add_Parameter (TC_new_bool, CORBA.To_Any (Id));
         CORBA.TypeCode.Internals.Add_Parameter (TC_new_bool, CORBA.To_Any (CORBA.TC_Boolean));
      end;
