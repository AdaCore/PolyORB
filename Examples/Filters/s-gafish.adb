...
package body System.Garlic.Filters.Shuffling is
   ...
   Dummy_Name : constant String := "shuffling";
   ...
   begin
      for I in Result'First .. Middle loop
         Element := Result (Result'Last + Result'First - I);
         Result (Result'Last + Result'First - I) := Result (I);
         Result (I) := Element;
      end loop;
      return Result;
   end Filter_Outgoing;
