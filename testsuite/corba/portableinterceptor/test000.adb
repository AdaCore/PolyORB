...
begin
   ...
   declare
      TestObj : Test000_Idl.TestInterface.Ref;
   begin
      ...
      begin
         Initiate_Servant (new Test000_Idl.TestInterface.Impl.Object, Ref);
         TestObj := Test000_Idl.TestInterface.Helper.To_Ref (Ref);
      end;
      ...
      begin
         Test000_Idl.TestInterface.Proc (TestObj);
         if Get_Log = Log then
      ...
      Test000_Globals.Clear_Log;
      Test000_Idl.TestInterface.Raise_Exception (TestObj);
      Test000_Globals.Enable_Client_Interceptors;
      declare
         Log : constant Log_Array
           := ((Client, 'A', Client_Send_Request),
      ...
      Test000_Globals.Disable_Client_Interceptors;
      Test000_Idl.TestInterface.Process_Normal (TestObj);
...
--      CORBA.Object.Release (CORBA.Object.Ref (TestObj));
   end;
