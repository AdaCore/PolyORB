...
--                           POLYORB COMPONENTS                             --
--                                                                          --
--              T E S T _ N U L L A C T I V A T O R . I M P L               --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body Test_NullActivator.Impl is
   ...
   begin
      Test_ServantActivator.Null_Activator_Incarnate_Called := True;
   ...
   begin
      return
        CORBA.Is_Equivalent
          (Logical_Type_Id, Test_NullActivator.Repository_Id)
          or else
        CORBA.Is_Equivalent
