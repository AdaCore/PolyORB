...
procedure Test000 is
   ...
   procedure Invoke_On_Servant (Obj_Ref : Echo.Ref) is
   begin
      PolyORB.Report.Output
        ("Invocation on created servant",
         "Hello Ada World !" =
         To_Standard_String
         (Echo.echoString (Obj_Ref, To_CORBA_String ("Hello Ada World !"))));
...
begin
   ...
   delay 5.0;
   PolyORB.Report.Output ("Waiting for end of all tests", True);
