...
--  $Id: //depot/ciao/main/ciao-asis_queries.ads#12 $
...
package CIAO.Asis_Queries is
   ...
   -- Derived_Type_Declaration - Specifies the derived type declaration to query
   --
   ...
   -- given element.  If Element is a basic_declaration, return Element itself.
   --
   -- Appropriate Element_Kinds:
   --      A_Pragma
   --      A_Defining_Name
