...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Reviewable                     : constant Name_Id := N + 138;
   Name_Source_File_Name               : constant Name_Id := N + 139; -- GNAT
   Name_Style_Checks                   : constant Name_Id := N + 140; -- GNAT
   Name_Suppress                       : constant Name_Id := N + 141;
   ...
   Name_Warnings                       : constant Name_Id := N + 145; -- GNAT
   ...
   Name_Export_Valued_Procedure        : constant Name_Id := N + 173; -- GNAT
   Name_External                       : constant Name_Id := N + 174; -- GNAT
   Name_Finalize_Storage_Only          : constant Name_Id := N + 175; -- GNAT
   Name_Ident                          : constant Name_Id := N + 176; -- VMS
   Name_Import                         : constant Name_Id := N + 177;
   Name_Import_Exception               : constant Name_Id := N + 178; -- VMS
   Name_Import_Function                : constant Name_Id := N + 179; -- GNAT
   Name_Import_Object                  : constant Name_Id := N + 180; -- GNAT
   Name_Import_Procedure               : constant Name_Id := N + 181; -- GNAT
   Name_Import_Valued_Procedure        : constant Name_Id := N + 182; -- GNAT
   Name_Inline                         : constant Name_Id := N + 183;
   Name_Inline_Always                  : constant Name_Id := N + 184; -- GNAT
   Name_Inline_Generic                 : constant Name_Id := N + 185; -- GNAT
   Name_Inspection_Point               : constant Name_Id := N + 186;
   Name_Interface                      : constant Name_Id := N + 187; -- Ada 83
   Name_Interface_Name                 : constant Name_Id := N + 188; -- GNAT
   Name_Interrupt_Handler              : constant Name_Id := N + 189;
   Name_Interrupt_Priority             : constant Name_Id := N + 190;
   Name_Java_Constructor               : constant Name_Id := N + 191; -- GNAT
   Name_Java_Interface                 : constant Name_Id := N + 192; -- GNAT
   Name_Link_With                      : constant Name_Id := N + 193; -- GNAT
   Name_Linker_Alias                   : constant Name_Id := N + 194; -- GNAT
   Name_Linker_Options                 : constant Name_Id := N + 195;
   Name_Linker_Section                 : constant Name_Id := N + 196; -- GNAT
   Name_List                           : constant Name_Id := N + 197;
   Name_Machine_Attribute              : constant Name_Id := N + 198; -- GNAT
   Name_Main                           : constant Name_Id := N + 199; -- GNAT
   Name_Main_Storage                   : constant Name_Id := N + 200; -- GNAT
   Name_Memory_Size                    : constant Name_Id := N + 201; -- Ada 83
   Name_No_Return                      : constant Name_Id := N + 202; -- GNAT
   Name_Optimize                       : constant Name_Id := N + 203;
   Name_Pack                           : constant Name_Id := N + 204;
   Name_Page                           : constant Name_Id := N + 205;
   Name_Passive                        : constant Name_Id := N + 206; -- GNAT
   Name_Preelaborate                   : constant Name_Id := N + 207;
   Name_Priority                       : constant Name_Id := N + 208;
   Name_Psect_Object                   : constant Name_Id := N + 209; -- VMS
   Name_Pure                           : constant Name_Id := N + 210;
   Name_Pure_Function                  : constant Name_Id := N + 211; -- GNAT
   Name_Remote_Call_Interface          : constant Name_Id := N + 212;
   Name_Remote_Types                   : constant Name_Id := N + 213;
   Name_Share_Generic                  : constant Name_Id := N + 214; -- GNAT
   Name_Shared                         : constant Name_Id := N + 215; -- Ada 83
   Name_Shared_Passive                 : constant Name_Id := N + 216;
   ...
   Name_Source_Reference               : constant Name_Id := N + 217; -- GNAT
   Name_Stream_Convert                 : constant Name_Id := N + 218; -- GNAT
   Name_Subtitle                       : constant Name_Id := N + 219; -- GNAT
   Name_Suppress_All                   : constant Name_Id := N + 220; -- GNAT
   Name_Suppress_Debug_Info            : constant Name_Id := N + 221; -- GNAT
   Name_Suppress_Initialization        : constant Name_Id := N + 222; -- GNAT
   Name_System_Name                    : constant Name_Id := N + 223; -- Ada 83
   Name_Task_Info                      : constant Name_Id := N + 224; -- GNAT
   Name_Task_Name                      : constant Name_Id := N + 225; -- GNAT
   Name_Task_Storage                   : constant Name_Id := N + 226; -- VMS
   Name_Time_Slice                     : constant Name_Id := N + 227; -- GNAT
   Name_Title                          : constant Name_Id := N + 228; -- GNAT
   Name_Unchecked_Union                : constant Name_Id := N + 229; -- GNAT
   Name_Unimplemented_Unit             : constant Name_Id := N + 230; -- GNAT
   Name_Universal_Data                 : constant Name_Id := N + 231; -- AAMP
   ...
   Name_SB                             : constant Name_Id := N + 288;
   Name_Section                        : constant Name_Id := N + 289;
   Name_Semaphore                      : constant Name_Id := N + 290;
   Name_Spec_File_Name                 : constant Name_Id := N + 291;
   Name_Static                         : constant Name_Id := N + 292;
   Name_Stack_Size                     : constant Name_Id := N + 293;
   Name_Subunit_File_Name              : constant Name_Id := N + 294;
   Name_Task_Stack_Size_Default        : constant Name_Id := N + 295;
   Name_Task_Type                      : constant Name_Id := N + 296;
   Name_Time_Slicing_Enabled           : constant Name_Id := N + 297;
   Name_Top_Guard                      : constant Name_Id := N + 298;
   Name_UBA                            : constant Name_Id := N + 299;
   Name_UBS                            : constant Name_Id := N + 300;
   Name_UBSB                           : constant Name_Id := N + 301;
   Name_Unit_Name                      : constant Name_Id := N + 302;
   Name_Unknown                        : constant Name_Id := N + 303;
   Name_Unrestricted                   : constant Name_Id := N + 304;
   Name_Uppercase                      : constant Name_Id := N + 305;
   Name_VAX_Float                      : constant Name_Id := N + 306;
   Name_VMS                            : constant Name_Id := N + 307;
   Name_Working_Storage                : constant Name_Id := N + 308;
   ...
   First_Attribute_Name                : constant Name_Id := N + 309;
   Name_Abort_Signal                   : constant Name_Id := N + 309;  -- GNAT
   Name_Access                         : constant Name_Id := N + 310;
   Name_Address                        : constant Name_Id := N + 311;
   Name_Address_Size                   : constant Name_Id := N + 312;  -- GNAT
   Name_Aft                            : constant Name_Id := N + 313;
   Name_Alignment                      : constant Name_Id := N + 314;
   Name_Asm_Input                      : constant Name_Id := N + 315;  -- GNAT
   Name_Asm_Output                     : constant Name_Id := N + 316;  -- GNAT
   Name_AST_Entry                      : constant Name_Id := N + 317;  -- VMS
   Name_Bit                            : constant Name_Id := N + 318;  -- GNAT
   Name_Bit_Order                      : constant Name_Id := N + 319;
   Name_Bit_Position                   : constant Name_Id := N + 320;  -- GNAT
   Name_Body_Version                   : constant Name_Id := N + 321;
   Name_Callable                       : constant Name_Id := N + 322;
   Name_Caller                         : constant Name_Id := N + 323;
   Name_Code_Address                   : constant Name_Id := N + 324;  -- GNAT
   Name_Component_Size                 : constant Name_Id := N + 325;
   Name_Compose                        : constant Name_Id := N + 326;
   Name_Constrained                    : constant Name_Id := N + 327;
   Name_Count                          : constant Name_Id := N + 328;
   Name_Default_Bit_Order              : constant Name_Id := N + 329; -- GNAT
   Name_Definite                       : constant Name_Id := N + 330;
   Name_Delta                          : constant Name_Id := N + 331;
   Name_Denorm                         : constant Name_Id := N + 332;
   Name_Digits                         : constant Name_Id := N + 333;
   Name_Elaborated                     : constant Name_Id := N + 334; -- GNAT
   Name_Emax                           : constant Name_Id := N + 335; -- Ada 83
   Name_Enum_Rep                       : constant Name_Id := N + 336; -- GNAT
   Name_Epsilon                        : constant Name_Id := N + 337; -- Ada 83
   Name_Exponent                       : constant Name_Id := N + 338;
   Name_External_Tag                   : constant Name_Id := N + 339;
   Name_First                          : constant Name_Id := N + 340;
   Name_First_Bit                      : constant Name_Id := N + 341;
   Name_Fixed_Value                    : constant Name_Id := N + 342; -- GNAT
   Name_Fore                           : constant Name_Id := N + 343;
   Name_Has_Discriminants              : constant Name_Id := N + 344; -- GNAT
   Name_Identity                       : constant Name_Id := N + 345;
   Name_Img                            : constant Name_Id := N + 346; -- GNAT
   Name_Integer_Value                  : constant Name_Id := N + 347; -- GNAT
   Name_Large                          : constant Name_Id := N + 348; -- Ada 83
   Name_Last                           : constant Name_Id := N + 349;
   Name_Last_Bit                       : constant Name_Id := N + 350;
   Name_Leading_Part                   : constant Name_Id := N + 351;
   Name_Length                         : constant Name_Id := N + 352;
   Name_Machine_Emax                   : constant Name_Id := N + 353;
   Name_Machine_Emin                   : constant Name_Id := N + 354;
   Name_Machine_Mantissa               : constant Name_Id := N + 355;
   Name_Machine_Overflows              : constant Name_Id := N + 356;
   Name_Machine_Radix                  : constant Name_Id := N + 357;
   Name_Machine_Rounds                 : constant Name_Id := N + 358;
   Name_Machine_Size                   : constant Name_Id := N + 359; -- GNAT
   Name_Mantissa                       : constant Name_Id := N + 360; -- Ada 83
   Name_Max_Size_In_Storage_Elements   : constant Name_Id := N + 361;
   Name_Maximum_Alignment              : constant Name_Id := N + 362; -- GNAT
   Name_Mechanism_Code                 : constant Name_Id := N + 363; -- GNAT
   Name_Model_Emin                     : constant Name_Id := N + 364;
   Name_Model_Epsilon                  : constant Name_Id := N + 365;
   Name_Model_Mantissa                 : constant Name_Id := N + 366;
   Name_Model_Small                    : constant Name_Id := N + 367;
   Name_Modulus                        : constant Name_Id := N + 368;
   Name_Null_Parameter                 : constant Name_Id := N + 369; -- GNAT
   Name_Object_Size                    : constant Name_Id := N + 370; -- GNAT
   Name_Partition_ID                   : constant Name_Id := N + 371;
   Name_Passed_By_Reference            : constant Name_Id := N + 372; -- GNAT
   ...
   Name_Subtype_Alignment              : constant Name_Id := N + 390; -- GNAT
   Name_Tag                            : constant Name_Id := N + 391;
   ...
   Name_Extends                        : constant Name_Id := N + 544;
   Name_Finder                         : constant Name_Id := N + 545;
   Name_Gnatls                         : constant Name_Id := N + 546;
   Name_Pretty_Printer                 : constant Name_Id := N + 547;
   Name_Implementation                 : constant Name_Id := N + 548;
   Name_Implementation_Exceptions      : constant Name_Id := N + 549;
   Name_Implementation_Suffix          : constant Name_Id := N + 550;
   Name_Languages                      : constant Name_Id := N + 551;
   Name_Library_Dir                    : constant Name_Id := N + 552;
   Name_Library_Elaboration            : constant Name_Id := N + 553;
   Name_Library_Kind                   : constant Name_Id := N + 554;
   Name_Library_Name                   : constant Name_Id := N + 555;
   Name_Library_Version                : constant Name_Id := N + 556;
   Name_Linker                         : constant Name_Id := N + 557;
   Name_Naming                         : constant Name_Id := N + 558;
   Name_Object_Dir                     : constant Name_Id := N + 559;
   Name_Project                        : constant Name_Id := N + 560;
   Name_Separate_Suffix                : constant Name_Id := N + 561;
   Name_Source_Dirs                    : constant Name_Id := N + 562;
   Name_Source_Files                   : constant Name_Id := N + 563;
   Name_Source_List_File               : constant Name_Id := N + 564;
   Name_Specification                  : constant Name_Id := N + 565;
   Name_Specification_Exceptions       : constant Name_Id := N + 566;
   Name_Specification_Suffix           : constant Name_Id := N + 567;
   Name_Switches                       : constant Name_Id := N + 568;
   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 568;
