...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_uAssign                        : constant Name_Id := N + 008;
   ...
   Name_uService                       : constant Name_Id := N + 021;
   Name_uSize                          : constant Name_Id := N + 022;
   ...
   Name_uTypeCode                      : constant Name_Id := N + 045;
   Name_uFrom_Any                      : constant Name_Id := N + 046;
   Name_uTo_Any                        : constant Name_Id := N + 047;

   --  Names of allocation routines, also needed by expander

   Name_Allocate                       : constant Name_Id := N + 048;
   Name_Deallocate                     : constant Name_Id := N + 049;
   Name_Dereference                    : constant Name_Id := N + 050;

   --  Names of Text_IO generic subpackages (see Rtsfind.Text_IO_Kludge)

   First_Text_IO_Package               : constant Name_Id := N + 051;
   Name_Decimal_IO                     : constant Name_Id := N + 051;
   Name_Enumeration_IO                 : constant Name_Id := N + 052;
   Name_Fixed_IO                       : constant Name_Id := N + 053;
   Name_Float_IO                       : constant Name_Id := N + 054;
   Name_Integer_IO                     : constant Name_Id := N + 055;
   Name_Modular_IO                     : constant Name_Id := N + 056;
   Last_Text_IO_Package                : constant Name_Id := N + 056;
   ...
   Name_a_textio                       : constant Name_Id := N + 057;
   Name_a_witeio                       : constant Name_Id := N + 058;

   --  Some miscellaneous names used for error detection/recovery

   Name_Const                          : constant Name_Id := N + 059;
   Name_Error                          : constant Name_Id := N + 060;
   Name_Go                             : constant Name_Id := N + 061;
   Name_Put                            : constant Name_Id := N + 062;
   Name_Put_Line                       : constant Name_Id := N + 063;
   Name_To                             : constant Name_Id := N + 064;
   ...
   Name_Standard                       : constant Name_Id := N + 068;
   Name_System                         : constant Name_Id := N + 069;
   Name_Text_IO                        : constant Name_Id := N + 070;
   Name_Wide_Text_IO                   : constant Name_Id := N + 071;

   --  Names of identifiers used in expanding distribution stubs

   Name_Addr                           : constant Name_Id := N + 072;
   ...
   Name_C_Pass_By_Copy                 : constant Name_Id := N + 115; -- GNAT
   Name_Compile_Time_Warning           : constant Name_Id := N + 116; -- GNAT
   ...
   Name_High_Integrity_Mode            : constant Name_Id := N + 126; -- GNAT
   ...
   Name_High_Integrity                 : constant Name_Id := N + 181; -- GNAT
   ...
   Name_Pack                           : constant Name_Id := N + 212;
   Name_Page                           : constant Name_Id := N + 213;
   Name_Passive                        : constant Name_Id := N + 214; -- GNAT
   Name_Preelaborate                   : constant Name_Id := N + 215;
   Name_Priority                       : constant Name_Id := N + 216;
   Name_Psect_Object                   : constant Name_Id := N + 217; -- VMS
   Name_Pure                           : constant Name_Id := N + 218;
   Name_Pure_Function                  : constant Name_Id := N + 219; -- GNAT
   Name_Remote_Call_Interface          : constant Name_Id := N + 220;
   Name_Remote_Types                   : constant Name_Id := N + 221;
   Name_Share_Generic                  : constant Name_Id := N + 222; -- GNAT
   Name_Shared                         : constant Name_Id := N + 223; -- Ada 83
   Name_Shared_Passive                 : constant Name_Id := N + 224;
   ...
   Name_Source_Reference               : constant Name_Id := N + 225; -- GNAT
   Name_Stream_Convert                 : constant Name_Id := N + 226; -- GNAT
   Name_Subtitle                       : constant Name_Id := N + 227; -- GNAT
   Name_Suppress_All                   : constant Name_Id := N + 228; -- GNAT
   Name_Suppress_Debug_Info            : constant Name_Id := N + 229; -- GNAT
   Name_Suppress_Initialization        : constant Name_Id := N + 230; -- GNAT
   Name_System_Name                    : constant Name_Id := N + 231; -- Ada 83
   Name_Task_Info                      : constant Name_Id := N + 232; -- GNAT
   Name_Task_Name                      : constant Name_Id := N + 233; -- GNAT
   Name_Task_Storage                   : constant Name_Id := N + 234; -- VMS
   Name_Time_Slice                     : constant Name_Id := N + 235; -- GNAT
   Name_Title                          : constant Name_Id := N + 236; -- GNAT
   Name_Unchecked_Union                : constant Name_Id := N + 237; -- GNAT
   Name_Unimplemented_Unit             : constant Name_Id := N + 238; -- GNAT
   Name_Unreferenced                   : constant Name_Id := N + 239; -- GNAT
   Name_Unreserve_All_Interrupts       : constant Name_Id := N + 240; -- GNAT
   Name_Volatile                       : constant Name_Id := N + 241;
   Name_Volatile_Components            : constant Name_Id := N + 242;
   Name_Weak_External                  : constant Name_Id := N + 243; -- GNAT
   Last_Pragma_Name                    : constant Name_Id := N + 243;
   ...
   First_Convention_Name               : constant Name_Id := N + 244;
   Name_Ada                            : constant Name_Id := N + 244;
   Name_Assembler                      : constant Name_Id := N + 245;
   Name_COBOL                          : constant Name_Id := N + 246;
   Name_CPP                            : constant Name_Id := N + 247;
   Name_Fortran                        : constant Name_Id := N + 248;
   Name_Intrinsic                      : constant Name_Id := N + 249;
   Name_Java                           : constant Name_Id := N + 250;
   Name_Stdcall                        : constant Name_Id := N + 251;
   Name_Stubbed                        : constant Name_Id := N + 252;
   Last_Convention_Name                : constant Name_Id := N + 252;

   --  The following names are preset as synonyms for Assembler

   Name_Asm                            : constant Name_Id := N + 253;
   Name_Assembly                       : constant Name_Id := N + 254;

   --  The following names are preset as synonyms for C

   Name_Default                        : constant Name_Id := N + 255;
   --  Name_Exernal (previously defined as pragma)

   --  The following names are present as synonyms for Stdcall

   Name_DLL                            : constant Name_Id := N + 256;
   Name_Win32                          : constant Name_Id := N + 257;

   --  Other special names used in processing pragma arguments

   Name_As_Is                          : constant Name_Id := N + 258;
   Name_Body_File_Name                 : constant Name_Id := N + 259;
   Name_Casing                         : constant Name_Id := N + 260;
   Name_Code                           : constant Name_Id := N + 261;
   Name_Component                      : constant Name_Id := N + 262;
   Name_Component_Size_4               : constant Name_Id := N + 263;
   Name_Copy                           : constant Name_Id := N + 264;
   Name_D_Float                        : constant Name_Id := N + 265;
   Name_Descriptor                     : constant Name_Id := N + 266;
   Name_Dot_Replacement                : constant Name_Id := N + 267;
   Name_Dynamic                        : constant Name_Id := N + 268;
   Name_Entity                         : constant Name_Id := N + 269;
   Name_External_Name                  : constant Name_Id := N + 270;
   Name_First_Optional_Parameter       : constant Name_Id := N + 271;
   Name_Form                           : constant Name_Id := N + 272;
   Name_G_Float                        : constant Name_Id := N + 273;
   Name_Gcc                            : constant Name_Id := N + 274;
   Name_Gnat                           : constant Name_Id := N + 275;
   Name_GPL                            : constant Name_Id := N + 276;
   Name_IEEE_Float                     : constant Name_Id := N + 277;
   Name_Homonym_Number                 : constant Name_Id := N + 278;
   Name_Internal                       : constant Name_Id := N + 279;
   Name_Link_Name                      : constant Name_Id := N + 280;
   Name_Lowercase                      : constant Name_Id := N + 281;
   Name_Max_Size                       : constant Name_Id := N + 282;
   Name_Mechanism                      : constant Name_Id := N + 283;
   Name_Mixedcase                      : constant Name_Id := N + 284;
   Name_Modified_GPL                   : constant Name_Id := N + 285;
   Name_Name                           : constant Name_Id := N + 286;
   Name_NCA                            : constant Name_Id := N + 287;
   Name_No                             : constant Name_Id := N + 288;
   Name_On                             : constant Name_Id := N + 289;
   Name_Parameter_Types                : constant Name_Id := N + 290;
   Name_Reference                      : constant Name_Id := N + 291;
   ...
   Name_Section                        : constant Name_Id := N + 297;
   Name_Semaphore                      : constant Name_Id := N + 298;
   Name_Spec_File_Name                 : constant Name_Id := N + 299;
   Name_Static                         : constant Name_Id := N + 300;
   Name_Stack_Size                     : constant Name_Id := N + 301;
   Name_Subunit_File_Name              : constant Name_Id := N + 302;
   Name_Task_Stack_Size_Default        : constant Name_Id := N + 303;
   Name_Task_Type                      : constant Name_Id := N + 304;
   Name_Time_Slicing_Enabled           : constant Name_Id := N + 305;
   Name_Top_Guard                      : constant Name_Id := N + 306;
   Name_UBA                            : constant Name_Id := N + 307;
   Name_UBS                            : constant Name_Id := N + 308;
   Name_UBSB                           : constant Name_Id := N + 309;
   Name_Unit_Name                      : constant Name_Id := N + 310;
   Name_Unknown                        : constant Name_Id := N + 311;
   Name_Unrestricted                   : constant Name_Id := N + 312;
   Name_Uppercase                      : constant Name_Id := N + 313;
   Name_User                           : constant Name_Id := N + 314;
   Name_VAX_Float                      : constant Name_Id := N + 315;
   Name_VMS                            : constant Name_Id := N + 316;
   Name_Working_Storage                : constant Name_Id := N + 317;
   ...
   First_Attribute_Name                : constant Name_Id := N + 318;
   Name_Abort_Signal                   : constant Name_Id := N + 318;  -- GNAT
   Name_Access                         : constant Name_Id := N + 319;
   Name_Address                        : constant Name_Id := N + 320;
   Name_Address_Size                   : constant Name_Id := N + 321;  -- GNAT
   Name_Aft                            : constant Name_Id := N + 322;
   Name_Alignment                      : constant Name_Id := N + 323;
   Name_Asm_Input                      : constant Name_Id := N + 324;  -- GNAT
   Name_Asm_Output                     : constant Name_Id := N + 325;  -- GNAT
   Name_AST_Entry                      : constant Name_Id := N + 326;  -- VMS
   Name_Bit                            : constant Name_Id := N + 327;  -- GNAT
   Name_Bit_Order                      : constant Name_Id := N + 328;
   Name_Bit_Position                   : constant Name_Id := N + 329;  -- GNAT
   Name_Body_Version                   : constant Name_Id := N + 330;
   Name_Callable                       : constant Name_Id := N + 331;
   Name_Caller                         : constant Name_Id := N + 332;
   Name_Code_Address                   : constant Name_Id := N + 333;  -- GNAT
   Name_Component_Size                 : constant Name_Id := N + 334;
   Name_Compose                        : constant Name_Id := N + 335;
   Name_Constrained                    : constant Name_Id := N + 336;
   Name_Count                          : constant Name_Id := N + 337;
   Name_Default_Bit_Order              : constant Name_Id := N + 338; -- GNAT
   Name_Definite                       : constant Name_Id := N + 339;
   Name_Delta                          : constant Name_Id := N + 340;
   Name_Denorm                         : constant Name_Id := N + 341;
   Name_Digits                         : constant Name_Id := N + 342;
   Name_Elaborated                     : constant Name_Id := N + 343; -- GNAT
   Name_Emax                           : constant Name_Id := N + 344; -- Ada 83
   Name_Enum_Rep                       : constant Name_Id := N + 345; -- GNAT
   Name_Epsilon                        : constant Name_Id := N + 346; -- Ada 83
   Name_Exponent                       : constant Name_Id := N + 347;
   Name_External_Tag                   : constant Name_Id := N + 348;
   Name_First                          : constant Name_Id := N + 349;
   Name_First_Bit                      : constant Name_Id := N + 350;
   Name_Fixed_Value                    : constant Name_Id := N + 351; -- GNAT
   Name_Fore                           : constant Name_Id := N + 352;
   Name_Has_Discriminants              : constant Name_Id := N + 353; -- GNAT
   Name_Identity                       : constant Name_Id := N + 354;
   Name_Img                            : constant Name_Id := N + 355; -- GNAT
   Name_Integer_Value                  : constant Name_Id := N + 356; -- GNAT
   Name_Large                          : constant Name_Id := N + 357; -- Ada 83
   Name_Last                           : constant Name_Id := N + 358;
   Name_Last_Bit                       : constant Name_Id := N + 359;
   Name_Leading_Part                   : constant Name_Id := N + 360;
   Name_Length                         : constant Name_Id := N + 361;
   Name_Machine_Emax                   : constant Name_Id := N + 362;
   Name_Machine_Emin                   : constant Name_Id := N + 363;
   Name_Machine_Mantissa               : constant Name_Id := N + 364;
   Name_Machine_Overflows              : constant Name_Id := N + 365;
   Name_Machine_Radix                  : constant Name_Id := N + 366;
   Name_Machine_Rounds                 : constant Name_Id := N + 367;
   Name_Machine_Size                   : constant Name_Id := N + 368; -- GNAT
   Name_Mantissa                       : constant Name_Id := N + 369; -- Ada 83
   Name_Max_Size_In_Storage_Elements   : constant Name_Id := N + 370;
   Name_Maximum_Alignment              : constant Name_Id := N + 371; -- GNAT
   Name_Mechanism_Code                 : constant Name_Id := N + 372; -- GNAT
   Name_Model_Emin                     : constant Name_Id := N + 373;
   Name_Model_Epsilon                  : constant Name_Id := N + 374;
   Name_Model_Mantissa                 : constant Name_Id := N + 375;
   Name_Model_Small                    : constant Name_Id := N + 376;
   Name_Modulus                        : constant Name_Id := N + 377;
   Name_Null_Parameter                 : constant Name_Id := N + 378; -- GNAT
   Name_Object_Size                    : constant Name_Id := N + 379; -- GNAT
   Name_Partition_ID                   : constant Name_Id := N + 380;
   Name_Passed_By_Reference            : constant Name_Id := N + 381; -- GNAT
   Name_Pool_Address                   : constant Name_Id := N + 382;
   Name_Pos                            : constant Name_Id := N + 383;
   Name_Position                       : constant Name_Id := N + 384;
   Name_Range                          : constant Name_Id := N + 385;
   Name_Range_Length                   : constant Name_Id := N + 386; -- GNAT
   Name_Round                          : constant Name_Id := N + 387;
   Name_Safe_Emax                      : constant Name_Id := N + 388; -- Ada 83
   Name_Safe_First                     : constant Name_Id := N + 389;
   Name_Safe_Large                     : constant Name_Id := N + 390; -- Ada 83
   Name_Safe_Last                      : constant Name_Id := N + 391;
   Name_Safe_Small                     : constant Name_Id := N + 392; -- Ada 83
   Name_Scale                          : constant Name_Id := N + 393;
   Name_Scaling                        : constant Name_Id := N + 394;
   Name_Signed_Zeros                   : constant Name_Id := N + 395;
   Name_Size                           : constant Name_Id := N + 396;
   Name_Small                          : constant Name_Id := N + 397;
   Name_Storage_Size                   : constant Name_Id := N + 398;
   Name_Storage_Unit                   : constant Name_Id := N + 399; -- GNAT
   Name_Tag                            : constant Name_Id := N + 400;
   Name_Terminated                     : constant Name_Id := N + 401;
   Name_To_Address                     : constant Name_Id := N + 402; -- GNAT
   Name_Type_Class                     : constant Name_Id := N + 403; -- GNAT
   Name_UET_Address                    : constant Name_Id := N + 404; -- GNAT
   Name_Unbiased_Rounding              : constant Name_Id := N + 405;
   Name_Unchecked_Access               : constant Name_Id := N + 406;
   Name_Unconstrained_Array            : constant Name_Id := N + 407;
   Name_Universal_Literal_String       : constant Name_Id := N + 408; -- GNAT
   Name_Unrestricted_Access            : constant Name_Id := N + 409; -- GNAT
   Name_VADS_Size                      : constant Name_Id := N + 410; -- GNAT
   Name_Val                            : constant Name_Id := N + 411;
   Name_Valid                          : constant Name_Id := N + 412;
   Name_Value_Size                     : constant Name_Id := N + 413; -- GNAT
   Name_Version                        : constant Name_Id := N + 414;
   Name_Wchar_T_Size                   : constant Name_Id := N + 415; -- GNAT
   Name_Wide_Width                     : constant Name_Id := N + 416;
   Name_Width                          : constant Name_Id := N + 417;
   Name_Word_Size                      : constant Name_Id := N + 418; -- GNAT

   --  Attributes that designate attributes returning renamable functions,
   --  i.e. functions that return other than a universal value.

   First_Renamable_Function_Attribute  : constant Name_Id := N + 419;
   Name_Adjacent                       : constant Name_Id := N + 419;
   Name_Ceiling                        : constant Name_Id := N + 420;
   Name_Copy_Sign                      : constant Name_Id := N + 421;
   Name_Floor                          : constant Name_Id := N + 422;
   Name_Fraction                       : constant Name_Id := N + 423;
   Name_Image                          : constant Name_Id := N + 424;
   Name_Input                          : constant Name_Id := N + 425;
   Name_Machine                        : constant Name_Id := N + 426;
   Name_Max                            : constant Name_Id := N + 427;
   Name_Min                            : constant Name_Id := N + 428;
   Name_Model                          : constant Name_Id := N + 429;
   Name_Pred                           : constant Name_Id := N + 430;
   Name_Remainder                      : constant Name_Id := N + 431;
   Name_Rounding                       : constant Name_Id := N + 432;
   Name_Succ                           : constant Name_Id := N + 433;
   Name_Truncation                     : constant Name_Id := N + 434;
   Name_Value                          : constant Name_Id := N + 435;
   Name_Wide_Image                     : constant Name_Id := N + 436;
   Name_Wide_Value                     : constant Name_Id := N + 437;
   Last_Renamable_Function_Attribute   : constant Name_Id := N + 437;

   --  Attributes that designate procedures

   First_Procedure_Attribute           : constant Name_Id := N + 438;
   Name_Output                         : constant Name_Id := N + 438;
   Name_Read                           : constant Name_Id := N + 439;
   Name_Write                          : constant Name_Id := N + 440;
   Last_Procedure_Attribute            : constant Name_Id := N + 440;

   --  Remaining attributes are ones that return entities

   First_Entity_Attribute_Name         : constant Name_Id := N + 441;
   Name_Elab_Body                      : constant Name_Id := N + 441; -- GNAT
   Name_Elab_Spec                      : constant Name_Id := N + 442; -- GNAT
   Name_Storage_Pool                   : constant Name_Id := N + 443;

   --  These attributes are the ones that return types

   First_Type_Attribute_Name           : constant Name_Id := N + 444;
   Name_Base                           : constant Name_Id := N + 444;
   Name_Class                          : constant Name_Id := N + 445;
   Last_Type_Attribute_Name            : constant Name_Id := N + 445;
   Last_Entity_Attribute_Name          : constant Name_Id := N + 445;
   Last_Attribute_Name                 : constant Name_Id := N + 445;
   ...
   First_Locking_Policy_Name           : constant Name_Id := N + 446;
   Name_Ceiling_Locking                : constant Name_Id := N + 446;
   Name_Inheritance_Locking            : constant Name_Id := N + 447;
   Last_Locking_Policy_Name            : constant Name_Id := N + 447;
   ...
   First_Queuing_Policy_Name           : constant Name_Id := N + 448;
   Name_FIFO_Queuing                   : constant Name_Id := N + 448;
   Name_Priority_Queuing               : constant Name_Id := N + 449;
   Last_Queuing_Policy_Name            : constant Name_Id := N + 449;
   ...
   First_Task_Dispatching_Policy_Name  : constant Name_Id := N + 450;
   Name_Fifo_Within_Priorities         : constant Name_Id := N + 450;
   Last_Task_Dispatching_Policy_Name   : constant Name_Id := N + 450;

   --  Names of recognized checks for pragma Suppress

   First_Check_Name                    : constant Name_Id := N + 451;
   Name_Access_Check                   : constant Name_Id := N + 451;
   Name_Accessibility_Check            : constant Name_Id := N + 452;
   Name_Discriminant_Check             : constant Name_Id := N + 453;
   Name_Division_Check                 : constant Name_Id := N + 454;
   Name_Elaboration_Check              : constant Name_Id := N + 455;
   Name_Index_Check                    : constant Name_Id := N + 456;
   Name_Length_Check                   : constant Name_Id := N + 457;
   Name_Overflow_Check                 : constant Name_Id := N + 458;
   Name_Range_Check                    : constant Name_Id := N + 459;
   Name_Storage_Check                  : constant Name_Id := N + 460;
   Name_Tag_Check                      : constant Name_Id := N + 461;
   Name_All_Checks                     : constant Name_Id := N + 462;
   Last_Check_Name                     : constant Name_Id := N + 462;

   --  Names corresponding to reserved keywords, excluding those already
   --  declared in the attribute list (Access, Delta, Digits, Range).

   Name_Abort                          : constant Name_Id := N + 463;
   Name_Abs                            : constant Name_Id := N + 464;
   Name_Accept                         : constant Name_Id := N + 465;
   Name_And                            : constant Name_Id := N + 466;
   Name_All                            : constant Name_Id := N + 467;
   Name_Array                          : constant Name_Id := N + 468;
   Name_At                             : constant Name_Id := N + 469;
   Name_Begin                          : constant Name_Id := N + 470;
   Name_Body                           : constant Name_Id := N + 471;
   Name_Case                           : constant Name_Id := N + 472;
   Name_Constant                       : constant Name_Id := N + 473;
   Name_Declare                        : constant Name_Id := N + 474;
   Name_Delay                          : constant Name_Id := N + 475;
   Name_Do                             : constant Name_Id := N + 476;
   Name_Else                           : constant Name_Id := N + 477;
   Name_Elsif                          : constant Name_Id := N + 478;
   Name_End                            : constant Name_Id := N + 479;
   Name_Entry                          : constant Name_Id := N + 480;
   Name_Exception                      : constant Name_Id := N + 481;
   Name_Exit                           : constant Name_Id := N + 482;
   Name_For                            : constant Name_Id := N + 483;
   Name_Function                       : constant Name_Id := N + 484;
   Name_Generic                        : constant Name_Id := N + 485;
   Name_Goto                           : constant Name_Id := N + 486;
   Name_If                             : constant Name_Id := N + 487;
   Name_In                             : constant Name_Id := N + 488;
   Name_Is                             : constant Name_Id := N + 489;
   Name_Limited                        : constant Name_Id := N + 490;
   Name_Loop                           : constant Name_Id := N + 491;
   Name_Mod                            : constant Name_Id := N + 492;
   Name_New                            : constant Name_Id := N + 493;
   Name_Not                            : constant Name_Id := N + 494;
   Name_Null                           : constant Name_Id := N + 495;
   Name_Of                             : constant Name_Id := N + 496;
   Name_Or                             : constant Name_Id := N + 497;
   Name_Others                         : constant Name_Id := N + 498;
   Name_Out                            : constant Name_Id := N + 499;
   Name_Package                        : constant Name_Id := N + 500;
   Name_Pragma                         : constant Name_Id := N + 501;
   Name_Private                        : constant Name_Id := N + 502;
   Name_Procedure                      : constant Name_Id := N + 503;
   Name_Raise                          : constant Name_Id := N + 504;
   Name_Record                         : constant Name_Id := N + 505;
   Name_Rem                            : constant Name_Id := N + 506;
   Name_Renames                        : constant Name_Id := N + 507;
   Name_Return                         : constant Name_Id := N + 508;
   Name_Reverse                        : constant Name_Id := N + 509;
   Name_Select                         : constant Name_Id := N + 510;
   Name_Separate                       : constant Name_Id := N + 511;
   Name_Subtype                        : constant Name_Id := N + 512;
   Name_Task                           : constant Name_Id := N + 513;
   Name_Terminate                      : constant Name_Id := N + 514;
   Name_Then                           : constant Name_Id := N + 515;
   Name_Type                           : constant Name_Id := N + 516;
   Name_Use                            : constant Name_Id := N + 517;
   Name_When                           : constant Name_Id := N + 518;
   Name_While                          : constant Name_Id := N + 519;
   Name_With                           : constant Name_Id := N + 520;
   Name_Xor                            : constant Name_Id := N + 521;
   ...
   First_Intrinsic_Name                : constant Name_Id := N + 522;
   Name_Divide                         : constant Name_Id := N + 522;
   Name_Enclosing_Entity               : constant Name_Id := N + 523;
   Name_Exception_Information          : constant Name_Id := N + 524;
   Name_Exception_Message              : constant Name_Id := N + 525;
   Name_Exception_Name                 : constant Name_Id := N + 526;
   Name_File                           : constant Name_Id := N + 527;
   Name_Import_Address                 : constant Name_Id := N + 528;
   Name_Import_Largest_Value           : constant Name_Id := N + 529;
   Name_Import_Value                   : constant Name_Id := N + 530;
   Name_Is_Negative                    : constant Name_Id := N + 531;
   Name_Line                           : constant Name_Id := N + 532;
   Name_Rotate_Left                    : constant Name_Id := N + 533;
   Name_Rotate_Right                   : constant Name_Id := N + 534;
   Name_Shift_Left                     : constant Name_Id := N + 535;
   Name_Shift_Right                    : constant Name_Id := N + 536;
   Name_Shift_Right_Arithmetic         : constant Name_Id := N + 537;
   Name_Source_Location                : constant Name_Id := N + 538;
   Name_Unchecked_Conversion           : constant Name_Id := N + 539;
   Name_Unchecked_Deallocation         : constant Name_Id := N + 540;
   Last_Intrinsic_Name                 : constant Name_Id := N + 540;

   --  Reserved words used only in Ada 95

   First_95_Reserved_Word              : constant Name_Id := N + 541;
   Name_Abstract                       : constant Name_Id := N + 541;
   Name_Aliased                        : constant Name_Id := N + 542;
   Name_Protected                      : constant Name_Id := N + 543;
   Name_Until                          : constant Name_Id := N + 544;
   Name_Requeue                        : constant Name_Id := N + 545;
   Name_Tagged                         : constant Name_Id := N + 546;
   Last_95_Reserved_Word               : constant Name_Id := N + 546;
   ...
   Name_Raise_Exception                : constant Name_Id := N + 547;

   --  Additional reserved words in GNAT Project Files
   --  Note that Name_External is already previously declared

   Name_Binder                         : constant Name_Id := N + 548;
   Name_Body_Suffix                    : constant Name_Id := N + 549;
   Name_Builder                        : constant Name_Id := N + 550;
   Name_Compiler                       : constant Name_Id := N + 551;
   Name_Cross_Reference                : constant Name_Id := N + 552;
   Name_Default_Switches               : constant Name_Id := N + 553;
   Name_Exec_Dir                       : constant Name_Id := N + 554;
   Name_Extends                        : constant Name_Id := N + 555;
   Name_Finder                         : constant Name_Id := N + 556;
   Name_Gnatls                         : constant Name_Id := N + 557;
   Name_Gnatstub                       : constant Name_Id := N + 558;
   Name_Implementation                 : constant Name_Id := N + 559;
   Name_Implementation_Exceptions      : constant Name_Id := N + 560;
   Name_Implementation_Suffix          : constant Name_Id := N + 561;
   Name_Languages                      : constant Name_Id := N + 562;
   Name_Library_Dir                    : constant Name_Id := N + 563;
   Name_Library_Auto_Init              : constant Name_Id := N + 564;
   Name_Library_Interface              : constant Name_Id := N + 565;
   Name_Library_Kind                   : constant Name_Id := N + 566;
   Name_Library_Name                   : constant Name_Id := N + 567;
