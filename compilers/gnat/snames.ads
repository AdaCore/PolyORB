...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Normalize_Scalars              : constant Name_Id := N + 127;
   Name_Polling                        : constant Name_Id := N + 128; -- GNAT
   ...
   Name_Reviewable                     : constant Name_Id := N + 134;
   Name_Source_File_Name               : constant Name_Id := N + 135; -- GNAT
   Name_Style_Checks                   : constant Name_Id := N + 136; -- GNAT
   Name_Suppress                       : constant Name_Id := N + 137;
   Name_Task_Dispatching_Policy        : constant Name_Id := N + 138;
   Name_Unsuppress                     : constant Name_Id := N + 139; -- GNAT
   Name_Use_VADS_Size                  : constant Name_Id := N + 140; -- GNAT
   Name_Warnings                       : constant Name_Id := N + 141; -- GNAT
   Name_Validity_Checks                : constant Name_Id := N + 142; -- GNAT
   ...
   Name_Export_Valued_Procedure        : constant Name_Id := N + 169; -- GNAT
   Name_External                       : constant Name_Id := N + 170; -- GNAT
   Name_Finalize_Storage_Only          : constant Name_Id := N + 171; -- GNAT
   Name_Ident                          : constant Name_Id := N + 172; -- VMS
   Name_Import                         : constant Name_Id := N + 173;
   Name_Import_Exception               : constant Name_Id := N + 174; -- VMS
   Name_Import_Function                : constant Name_Id := N + 175; -- GNAT
   Name_Import_Object                  : constant Name_Id := N + 176; -- GNAT
   Name_Import_Procedure               : constant Name_Id := N + 177; -- GNAT
   Name_Import_Valued_Procedure        : constant Name_Id := N + 178; -- GNAT
   Name_Inline                         : constant Name_Id := N + 179;
   Name_Inline_Always                  : constant Name_Id := N + 180; -- GNAT
   Name_Inline_Generic                 : constant Name_Id := N + 181; -- GNAT
   Name_Inspection_Point               : constant Name_Id := N + 182;
   Name_Interface                      : constant Name_Id := N + 183; -- Ada 83
   Name_Interface_Name                 : constant Name_Id := N + 184; -- GNAT
   Name_Interrupt_Handler              : constant Name_Id := N + 185;
   Name_Interrupt_Priority             : constant Name_Id := N + 186;
   Name_Java_Constructor               : constant Name_Id := N + 187; -- GNAT
   Name_Java_Interface                 : constant Name_Id := N + 188; -- GNAT
   Name_Link_With                      : constant Name_Id := N + 189; -- GNAT
   Name_Linker_Alias                   : constant Name_Id := N + 190; -- GNAT
   Name_Linker_Options                 : constant Name_Id := N + 191;
   Name_Linker_Section                 : constant Name_Id := N + 192; -- GNAT
   Name_List                           : constant Name_Id := N + 193;
   Name_Machine_Attribute              : constant Name_Id := N + 194; -- GNAT
   Name_Main                           : constant Name_Id := N + 195; -- GNAT
   Name_Main_Storage                   : constant Name_Id := N + 196; -- GNAT
   Name_Memory_Size                    : constant Name_Id := N + 197; -- Ada 83
   Name_No_Return                      : constant Name_Id := N + 198; -- GNAT
   Name_Optimize                       : constant Name_Id := N + 199;
   Name_Pack                           : constant Name_Id := N + 200;
   Name_Page                           : constant Name_Id := N + 201;
   Name_Passive                        : constant Name_Id := N + 202; -- GNAT
   Name_Preelaborate                   : constant Name_Id := N + 203;
   Name_Priority                       : constant Name_Id := N + 204;
   Name_Psect_Object                   : constant Name_Id := N + 205; -- VMS
   Name_Pure                           : constant Name_Id := N + 206;
   Name_Pure_Function                  : constant Name_Id := N + 207; -- GNAT
   Name_Remote_Call_Interface          : constant Name_Id := N + 208;
   Name_Remote_Types                   : constant Name_Id := N + 209;
   Name_Share_Generic                  : constant Name_Id := N + 210; -- GNAT
   Name_Shared                         : constant Name_Id := N + 211; -- Ada 83
   Name_Shared_Passive                 : constant Name_Id := N + 212;
   ...
   Name_Source_Reference               : constant Name_Id := N + 213; -- GNAT
   Name_Stream_Convert                 : constant Name_Id := N + 214; -- GNAT
   Name_Subtitle                       : constant Name_Id := N + 215; -- GNAT
   Name_Suppress_All                   : constant Name_Id := N + 216; -- GNAT
   Name_Suppress_Debug_Info            : constant Name_Id := N + 217; -- GNAT
   Name_Suppress_Initialization        : constant Name_Id := N + 218; -- GNAT
   Name_System_Name                    : constant Name_Id := N + 219; -- Ada 83
   Name_Task_Info                      : constant Name_Id := N + 220; -- GNAT
   Name_Task_Name                      : constant Name_Id := N + 221; -- GNAT
   Name_Task_Storage                   : constant Name_Id := N + 222; -- VMS
   Name_Time_Slice                     : constant Name_Id := N + 223; -- GNAT
   Name_Title                          : constant Name_Id := N + 224; -- GNAT
   Name_Unchecked_Union                : constant Name_Id := N + 225; -- GNAT
   Name_Unimplemented_Unit             : constant Name_Id := N + 226; -- GNAT
   Name_Universal_Data                 : constant Name_Id := N + 227; -- AAMP
   Name_Unreferenced                   : constant Name_Id := N + 228; -- GNAT
   Name_Unreserve_All_Interrupts       : constant Name_Id := N + 229; -- GNAT
   Name_Volatile                       : constant Name_Id := N + 230;
   Name_Volatile_Components            : constant Name_Id := N + 231;
   Name_Weak_External                  : constant Name_Id := N + 232; -- GNAT
   Last_Pragma_Name                    : constant Name_Id := N + 232;
   ...
   First_Convention_Name               : constant Name_Id := N + 233;
   Name_Ada                            : constant Name_Id := N + 233;
   Name_Assembler                      : constant Name_Id := N + 234;
   Name_COBOL                          : constant Name_Id := N + 235;
   Name_CPP                            : constant Name_Id := N + 236;
   Name_Fortran                        : constant Name_Id := N + 237;
   Name_Intrinsic                      : constant Name_Id := N + 238;
   Name_Java                           : constant Name_Id := N + 239;
   Name_Stdcall                        : constant Name_Id := N + 240;
   Name_Stubbed                        : constant Name_Id := N + 241;
   Last_Convention_Name                : constant Name_Id := N + 241;

   --  The following names are preset as synonyms for Assembler

   Name_Asm                            : constant Name_Id := N + 242;
   Name_Assembly                       : constant Name_Id := N + 243;

   --  The following names are preset as synonyms for C

   Name_Default                        : constant Name_Id := N + 244;
   --  Name_Exernal (previously defined as pragma)

   --  The following names are present as synonyms for Stdcall

   Name_DLL                            : constant Name_Id := N + 245;
   Name_Win32                          : constant Name_Id := N + 246;

   --  Other special names used in processing pragma arguments

   Name_As_Is                          : constant Name_Id := N + 247;
   Name_Body_File_Name                 : constant Name_Id := N + 248;
   Name_Casing                         : constant Name_Id := N + 249;
   Name_Code                           : constant Name_Id := N + 250;
   Name_Component                      : constant Name_Id := N + 251;
   Name_Component_Size_4               : constant Name_Id := N + 252;
   Name_Copy                           : constant Name_Id := N + 253;
   Name_D_Float                        : constant Name_Id := N + 254;
   Name_Descriptor                     : constant Name_Id := N + 255;
   Name_Dot_Replacement                : constant Name_Id := N + 256;
   Name_Dynamic                        : constant Name_Id := N + 257;
   Name_Entity                         : constant Name_Id := N + 258;
   Name_External_Name                  : constant Name_Id := N + 259;
   Name_First_Optional_Parameter       : constant Name_Id := N + 260;
   Name_Form                           : constant Name_Id := N + 261;
   Name_G_Float                        : constant Name_Id := N + 262;
   Name_Gcc                            : constant Name_Id := N + 263;
   Name_Gnat                           : constant Name_Id := N + 264;
   Name_GPL                            : constant Name_Id := N + 265;
   Name_IEEE_Float                     : constant Name_Id := N + 266;
   Name_Homonym_Number                 : constant Name_Id := N + 267;
   Name_Internal                       : constant Name_Id := N + 268;
   Name_Link_Name                      : constant Name_Id := N + 269;
   Name_Lowercase                      : constant Name_Id := N + 270;
   Name_Max_Size                       : constant Name_Id := N + 271;
   Name_Mechanism                      : constant Name_Id := N + 272;
   Name_Mixedcase                      : constant Name_Id := N + 273;
   Name_Modified_GPL                   : constant Name_Id := N + 274;
   Name_Name                           : constant Name_Id := N + 275;
   Name_NCA                            : constant Name_Id := N + 276;
   Name_No                             : constant Name_Id := N + 277;
   Name_On                             : constant Name_Id := N + 278;
   Name_Parameter_Types                : constant Name_Id := N + 279;
   Name_Reference                      : constant Name_Id := N + 280;
   ...
   Name_Subtype_Alignment              : constant Name_Id := N + 386; -- GNAT
   ...
   Name_Universal_Literal_String       : constant Name_Id := N + 394; -- GNAT
   Name_Unrestricted_Access            : constant Name_Id := N + 395; -- GNAT
   Name_VADS_Size                      : constant Name_Id := N + 396; -- GNAT
   Name_Val                            : constant Name_Id := N + 397;
   Name_Valid                          : constant Name_Id := N + 398;
   Name_Value_Size                     : constant Name_Id := N + 399; -- GNAT
   Name_Version                        : constant Name_Id := N + 400;
   Name_Wchar_T_Size                   : constant Name_Id := N + 401; -- GNAT
   Name_Wide_Width                     : constant Name_Id := N + 402;
   Name_Width                          : constant Name_Id := N + 403;
   Name_Word_Size                      : constant Name_Id := N + 404; -- GNAT

   --  Attributes that designate attributes returning renamable functions,
   --  i.e. functions that return other than a universal value.

   First_Renamable_Function_Attribute  : constant Name_Id := N + 405;
   Name_Adjacent                       : constant Name_Id := N + 405;
   Name_Ceiling                        : constant Name_Id := N + 406;
   Name_Copy_Sign                      : constant Name_Id := N + 407;
   Name_Floor                          : constant Name_Id := N + 408;
   Name_Fraction                       : constant Name_Id := N + 409;
   Name_Image                          : constant Name_Id := N + 410;
   Name_Input                          : constant Name_Id := N + 411;
   Name_Machine                        : constant Name_Id := N + 412;
   Name_Max                            : constant Name_Id := N + 413;
   Name_Min                            : constant Name_Id := N + 414;
   Name_Model                          : constant Name_Id := N + 415;
   Name_Pred                           : constant Name_Id := N + 416;
   Name_Remainder                      : constant Name_Id := N + 417;
   Name_Rounding                       : constant Name_Id := N + 418;
   Name_Succ                           : constant Name_Id := N + 419;
   Name_Truncation                     : constant Name_Id := N + 420;
   Name_Value                          : constant Name_Id := N + 421;
   Name_Wide_Image                     : constant Name_Id := N + 422;
   Name_Wide_Value                     : constant Name_Id := N + 423;
   Last_Renamable_Function_Attribute   : constant Name_Id := N + 423;

   --  Attributes that designate procedures

   First_Procedure_Attribute           : constant Name_Id := N + 424;
   Name_Output                         : constant Name_Id := N + 424;
   Name_Read                           : constant Name_Id := N + 425;
   Name_Write                          : constant Name_Id := N + 426;
   Last_Procedure_Attribute            : constant Name_Id := N + 426;

   --  Remaining attributes are ones that return entities

   First_Entity_Attribute_Name         : constant Name_Id := N + 427;
   Name_Elab_Body                      : constant Name_Id := N + 427; -- GNAT
   Name_Elab_Spec                      : constant Name_Id := N + 428; -- GNAT
   Name_Storage_Pool                   : constant Name_Id := N + 429;

   --  These attributes are the ones that return types

   First_Type_Attribute_Name           : constant Name_Id := N + 430;
   Name_Base                           : constant Name_Id := N + 430;
   Name_Class                          : constant Name_Id := N + 431;
   Last_Type_Attribute_Name            : constant Name_Id := N + 431;
   Last_Entity_Attribute_Name          : constant Name_Id := N + 431;
   Last_Attribute_Name                 : constant Name_Id := N + 431;
   ...
   First_Locking_Policy_Name           : constant Name_Id := N + 432;
   Name_Ceiling_Locking                : constant Name_Id := N + 432;
   Name_Inheritance_Locking            : constant Name_Id := N + 433;
   Last_Locking_Policy_Name            : constant Name_Id := N + 433;
   ...
   First_Queuing_Policy_Name           : constant Name_Id := N + 434;
   Name_FIFO_Queuing                   : constant Name_Id := N + 434;
   Name_Priority_Queuing               : constant Name_Id := N + 435;
   Last_Queuing_Policy_Name            : constant Name_Id := N + 435;
   ...
   First_Task_Dispatching_Policy_Name  : constant Name_Id := N + 436;
   Name_Fifo_Within_Priorities         : constant Name_Id := N + 436;
   Last_Task_Dispatching_Policy_Name   : constant Name_Id := N + 436;

   --  Names of recognized checks for pragma Suppress

   First_Check_Name                    : constant Name_Id := N + 437;
   Name_Access_Check                   : constant Name_Id := N + 437;
   Name_Accessibility_Check            : constant Name_Id := N + 438;
   Name_Discriminant_Check             : constant Name_Id := N + 439;
   Name_Division_Check                 : constant Name_Id := N + 440;
   Name_Elaboration_Check              : constant Name_Id := N + 441;
   Name_Index_Check                    : constant Name_Id := N + 442;
   Name_Length_Check                   : constant Name_Id := N + 443;
   Name_Overflow_Check                 : constant Name_Id := N + 444;
   Name_Range_Check                    : constant Name_Id := N + 445;
   Name_Storage_Check                  : constant Name_Id := N + 446;
   Name_Tag_Check                      : constant Name_Id := N + 447;
   Name_All_Checks                     : constant Name_Id := N + 448;
   Last_Check_Name                     : constant Name_Id := N + 448;

   --  Names corresponding to reserved keywords, excluding those already
   --  declared in the attribute list (Access, Delta, Digits, Range).

   Name_Abort                          : constant Name_Id := N + 449;
   Name_Abs                            : constant Name_Id := N + 450;
   Name_Accept                         : constant Name_Id := N + 451;
   Name_And                            : constant Name_Id := N + 452;
   Name_All                            : constant Name_Id := N + 453;
   Name_Array                          : constant Name_Id := N + 454;
   Name_At                             : constant Name_Id := N + 455;
   Name_Begin                          : constant Name_Id := N + 456;
   Name_Body                           : constant Name_Id := N + 457;
   Name_Case                           : constant Name_Id := N + 458;
   Name_Constant                       : constant Name_Id := N + 459;
   Name_Declare                        : constant Name_Id := N + 460;
   Name_Delay                          : constant Name_Id := N + 461;
   Name_Do                             : constant Name_Id := N + 462;
   Name_Else                           : constant Name_Id := N + 463;
   Name_Elsif                          : constant Name_Id := N + 464;
   Name_End                            : constant Name_Id := N + 465;
   Name_Entry                          : constant Name_Id := N + 466;
   Name_Exception                      : constant Name_Id := N + 467;
   Name_Exit                           : constant Name_Id := N + 468;
   Name_For                            : constant Name_Id := N + 469;
   Name_Function                       : constant Name_Id := N + 470;
   Name_Generic                        : constant Name_Id := N + 471;
   Name_Goto                           : constant Name_Id := N + 472;
   Name_If                             : constant Name_Id := N + 473;
   Name_In                             : constant Name_Id := N + 474;
   Name_Is                             : constant Name_Id := N + 475;
   Name_Limited                        : constant Name_Id := N + 476;
   Name_Loop                           : constant Name_Id := N + 477;
   Name_Mod                            : constant Name_Id := N + 478;
   Name_New                            : constant Name_Id := N + 479;
   Name_Not                            : constant Name_Id := N + 480;
   Name_Null                           : constant Name_Id := N + 481;
   Name_Of                             : constant Name_Id := N + 482;
   Name_Or                             : constant Name_Id := N + 483;
   Name_Others                         : constant Name_Id := N + 484;
   Name_Out                            : constant Name_Id := N + 485;
   Name_Package                        : constant Name_Id := N + 486;
   Name_Pragma                         : constant Name_Id := N + 487;
   Name_Private                        : constant Name_Id := N + 488;
   Name_Procedure                      : constant Name_Id := N + 489;
   Name_Raise                          : constant Name_Id := N + 490;
   Name_Record                         : constant Name_Id := N + 491;
   Name_Rem                            : constant Name_Id := N + 492;
   Name_Renames                        : constant Name_Id := N + 493;
   Name_Return                         : constant Name_Id := N + 494;
   Name_Reverse                        : constant Name_Id := N + 495;
   Name_Select                         : constant Name_Id := N + 496;
   Name_Separate                       : constant Name_Id := N + 497;
   Name_Subtype                        : constant Name_Id := N + 498;
   Name_Task                           : constant Name_Id := N + 499;
   Name_Terminate                      : constant Name_Id := N + 500;
   Name_Then                           : constant Name_Id := N + 501;
   Name_Type                           : constant Name_Id := N + 502;
   Name_Use                            : constant Name_Id := N + 503;
   Name_When                           : constant Name_Id := N + 504;
   Name_While                          : constant Name_Id := N + 505;
   Name_With                           : constant Name_Id := N + 506;
   Name_Xor                            : constant Name_Id := N + 507;
   ...
   First_Intrinsic_Name                : constant Name_Id := N + 508;
   Name_Divide                         : constant Name_Id := N + 508;
   Name_Enclosing_Entity               : constant Name_Id := N + 509;
   Name_Exception_Information          : constant Name_Id := N + 510;
   Name_Exception_Message              : constant Name_Id := N + 511;
   Name_Exception_Name                 : constant Name_Id := N + 512;
   Name_File                           : constant Name_Id := N + 513;
   Name_Import_Address                 : constant Name_Id := N + 514;
   Name_Import_Largest_Value           : constant Name_Id := N + 515;
   Name_Import_Value                   : constant Name_Id := N + 516;
   Name_Is_Negative                    : constant Name_Id := N + 517;
   Name_Line                           : constant Name_Id := N + 518;
   Name_Rotate_Left                    : constant Name_Id := N + 519;
   Name_Rotate_Right                   : constant Name_Id := N + 520;
   Name_Shift_Left                     : constant Name_Id := N + 521;
   Name_Shift_Right                    : constant Name_Id := N + 522;
   Name_Shift_Right_Arithmetic         : constant Name_Id := N + 523;
   Name_Source_Location                : constant Name_Id := N + 524;
   Name_Unchecked_Conversion           : constant Name_Id := N + 525;
   Name_Unchecked_Deallocation         : constant Name_Id := N + 526;
   Last_Intrinsic_Name                 : constant Name_Id := N + 526;

   --  Reserved words used only in Ada 95

   First_95_Reserved_Word              : constant Name_Id := N + 527;
   Name_Abstract                       : constant Name_Id := N + 527;
   Name_Aliased                        : constant Name_Id := N + 528;
   Name_Protected                      : constant Name_Id := N + 529;
   Name_Until                          : constant Name_Id := N + 530;
   Name_Requeue                        : constant Name_Id := N + 531;
   Name_Tagged                         : constant Name_Id := N + 532;
   Last_95_Reserved_Word               : constant Name_Id := N + 532;
   ...
   Name_Raise_Exception                : constant Name_Id := N + 533;

   --  Additional reserved words in GNAT Project Files
   --  Note that Name_External is already previously declared

   Name_Binder                         : constant Name_Id := N + 534;
   Name_Builder                        : constant Name_Id := N + 535;
   Name_Compiler                       : constant Name_Id := N + 536;
   Name_Cross_Reference                : constant Name_Id := N + 537;
   Name_Default_Switches               : constant Name_Id := N + 538;
   Name_Exec_Dir                       : constant Name_Id := N + 539;
   Name_Extends                        : constant Name_Id := N + 540;
   Name_Finder                         : constant Name_Id := N + 541;
   Name_Gnatls                         : constant Name_Id := N + 542;
   Name_Pretty_Printer                 : constant Name_Id := N + 543;
   Name_Implementation                 : constant Name_Id := N + 544;
   Name_Implementation_Exceptions      : constant Name_Id := N + 545;
   Name_Implementation_Suffix          : constant Name_Id := N + 546;
   Name_Languages                      : constant Name_Id := N + 547;
   Name_Library_Dir                    : constant Name_Id := N + 548;
   Name_Library_Elaboration            : constant Name_Id := N + 549;
   Name_Library_Kind                   : constant Name_Id := N + 550;
   Name_Library_Name                   : constant Name_Id := N + 551;
   Name_Library_Version                : constant Name_Id := N + 552;
   Name_Linker                         : constant Name_Id := N + 553;
   Name_Naming                         : constant Name_Id := N + 554;
   Name_Object_Dir                     : constant Name_Id := N + 555;
   Name_Project                        : constant Name_Id := N + 556;
   Name_Separate_Suffix                : constant Name_Id := N + 557;
   Name_Source_Dirs                    : constant Name_Id := N + 558;
   Name_Source_Files                   : constant Name_Id := N + 559;
   Name_Source_List_File               : constant Name_Id := N + 560;
   Name_Specification                  : constant Name_Id := N + 561;
   Name_Specification_Exceptions       : constant Name_Id := N + 562;
   Name_Specification_Suffix           : constant Name_Id := N + 563;
   Name_Switches                       : constant Name_Id := N + 564;
   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 564;
