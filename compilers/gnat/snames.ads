...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Explicit_Overriding            : constant Name_Id := N + 122;
   ...
   Name_Homonym_Number                 : constant Name_Id := N + 282;
   ...
   Last_Intrinsic_Name                 : constant Name_Id := N + 545;

   --  Reserved words used only in Ada 95

   First_95_Reserved_Word              : constant Name_Id := N + 546;
   Name_Abstract                       : constant Name_Id := N + 546;
   Name_Aliased                        : constant Name_Id := N + 547;
   Name_Protected                      : constant Name_Id := N + 548;
   Name_Until                          : constant Name_Id := N + 549;
   Name_Requeue                        : constant Name_Id := N + 550;
   Name_Tagged                         : constant Name_Id := N + 551;
   Last_95_Reserved_Word               : constant Name_Id := N + 551;
   ...
   Name_Raise_Exception                : constant Name_Id := N + 552;

   --  Additional reserved words in GNAT Project Files
   --  Note that Name_External is already previously declared

   Name_Binder                         : constant Name_Id := N + 553;
   Name_Body_Suffix                    : constant Name_Id := N + 554;
   Name_Builder                        : constant Name_Id := N + 555;
   Name_Compiler                       : constant Name_Id := N + 556;
   Name_Cross_Reference                : constant Name_Id := N + 557;
   Name_Default_Switches               : constant Name_Id := N + 558;
   Name_Exec_Dir                       : constant Name_Id := N + 559;
   Name_Executable                     : constant Name_Id := N + 560;
   Name_Executable_Suffix              : constant Name_Id := N + 561;
   Name_Extends                        : constant Name_Id := N + 562;
   Name_Finder                         : constant Name_Id := N + 563;
   ...
   Name_Library_Version                : constant Name_Id := N + 577;
   Name_Linker                         : constant Name_Id := N + 578;
   Name_Locally_Removed_Files          : constant Name_Id := N + 579;
   Name_Naming                         : constant Name_Id := N + 580;
   Name_Object_Dir                     : constant Name_Id := N + 581;
   Name_Pretty_Printer                 : constant Name_Id := N + 582;
   Name_Project                        : constant Name_Id := N + 583;
   Name_Separate_Suffix                : constant Name_Id := N + 584;
   Name_Source_Dirs                    : constant Name_Id := N + 585;
   Name_Source_Files                   : constant Name_Id := N + 586;
   Name_Source_List_File               : constant Name_Id := N + 587;
   Name_Spec                           : constant Name_Id := N + 588;
   Name_Spec_Suffix                    : constant Name_Id := N + 589;
   Name_Specification                  : constant Name_Id := N + 590;
   Name_Specification_Exceptions       : constant Name_Id := N + 591;
   Name_Specification_Suffix           : constant Name_Id := N + 592;
   Name_Switches                       : constant Name_Id := N + 593;
   --  Other miscellaneous names used in front end

   Name_Unaligned_Valid                : constant Name_Id := N + 594;

   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 594;
