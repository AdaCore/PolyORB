...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Target                         : constant Name_Id := N + 000;
   ...
   First_Operator_Name                 : constant Name_Id := N + 093;
   Name_Op_Abs                         : constant Name_Id := N + 093; -- "abs"
   Name_Op_And                         : constant Name_Id := N + 094; -- "and"
   Name_Op_Mod                         : constant Name_Id := N + 095; -- "mod"
   Name_Op_Not                         : constant Name_Id := N + 096; -- "not"
   Name_Op_Or                          : constant Name_Id := N + 097; -- "or"
   Name_Op_Rem                         : constant Name_Id := N + 098; -- "rem"
   Name_Op_Xor                         : constant Name_Id := N + 099; -- "xor"
   Name_Op_Eq                          : constant Name_Id := N + 100; -- "="
   Name_Op_Ne                          : constant Name_Id := N + 101; -- "/="
   Name_Op_Lt                          : constant Name_Id := N + 102; -- "<"
   Name_Op_Le                          : constant Name_Id := N + 103; -- "<="
   Name_Op_Gt                          : constant Name_Id := N + 104; -- ">"
   Name_Op_Ge                          : constant Name_Id := N + 105; -- ">="
   Name_Op_Add                         : constant Name_Id := N + 106; -- "+"
   Name_Op_Subtract                    : constant Name_Id := N + 107; -- "-"
   Name_Op_Concat                      : constant Name_Id := N + 108; -- "&"
   Name_Op_Multiply                    : constant Name_Id := N + 109; -- "*"
   Name_Op_Divide                      : constant Name_Id := N + 110; -- "/"
   Name_Op_Expon                       : constant Name_Id := N + 111; -- "**"
   Last_Operator_Name                  : constant Name_Id := N + 111;
   ...
   First_Pragma_Name                   : constant Name_Id := N + 112;

   --  Configuration pragmas are grouped at start

   Name_Ada_83                         : constant Name_Id := N + 112; -- GNAT
   Name_Ada_95                         : constant Name_Id := N + 113; -- GNAT
   Name_C_Pass_By_Copy                 : constant Name_Id := N + 114; -- GNAT
   ...
   Name_Propagate_Exceptions           : constant Name_Id := N + 131; -- GNAT
   Name_Queuing_Policy                 : constant Name_Id := N + 132;
   Name_Ravenscar                      : constant Name_Id := N + 133;
   Name_Restricted_Run_Time            : constant Name_Id := N + 134;
   Name_Restrictions                   : constant Name_Id := N + 135;
   ...
   Name_Task_Dispatching_Policy        : constant Name_Id := N + 140;
   Name_Unsuppress                     : constant Name_Id := N + 141; -- GNAT
   Name_Use_VADS_Size                  : constant Name_Id := N + 142; -- GNAT
   Name_Warnings                       : constant Name_Id := N + 143; -- GNAT
   Name_Validity_Checks                : constant Name_Id := N + 144; -- GNAT
   Last_Configuration_Pragma_Name      : constant Name_Id := N + 144;

   --  Remaining pragma names

   Name_Abort_Defer                    : constant Name_Id := N + 145; -- GNAT
   Name_All_Calls_Remote               : constant Name_Id := N + 146;
   Name_Annotate                       : constant Name_Id := N + 147; -- GNAT
   ...
   Name_Assert                         : constant Name_Id := N + 148; -- GNAT
   Name_Asynchronous                   : constant Name_Id := N + 149;
   Name_Atomic                         : constant Name_Id := N + 150;
   Name_Atomic_Components              : constant Name_Id := N + 151;
   Name_Attach_Handler                 : constant Name_Id := N + 152;
   Name_Comment                        : constant Name_Id := N + 153; -- GNAT
   Name_Common_Object                  : constant Name_Id := N + 154; -- GNAT
   Name_Complex_Representation         : constant Name_Id := N + 155; -- GNAT
   Name_Controlled                     : constant Name_Id := N + 156;
   Name_Convention                     : constant Name_Id := N + 157;
   Name_CPP_Class                      : constant Name_Id := N + 158; -- GNAT
   Name_CPP_Constructor                : constant Name_Id := N + 159; -- GNAT
   Name_CPP_Virtual                    : constant Name_Id := N + 160; -- GNAT
   Name_CPP_Vtable                     : constant Name_Id := N + 161; -- GNAT
   Name_Debug                          : constant Name_Id := N + 162; -- GNAT
   Name_Elaborate                      : constant Name_Id := N + 163; -- Ada 83
   Name_Elaborate_All                  : constant Name_Id := N + 164;
   Name_Elaborate_Body                 : constant Name_Id := N + 165;
   Name_Export                         : constant Name_Id := N + 166;
   Name_Export_Exception               : constant Name_Id := N + 167; -- VMS
   Name_Export_Function                : constant Name_Id := N + 168; -- GNAT
   Name_Export_Object                  : constant Name_Id := N + 169; -- GNAT
   Name_Export_Procedure               : constant Name_Id := N + 170; -- GNAT
   Name_Export_Valued_Procedure        : constant Name_Id := N + 171; -- GNAT
   Name_External                       : constant Name_Id := N + 172; -- GNAT
   Name_Finalize_Storage_Only          : constant Name_Id := N + 173; -- GNAT
   Name_Ident                          : constant Name_Id := N + 174; -- VMS
   Name_Import                         : constant Name_Id := N + 175;
   Name_Import_Exception               : constant Name_Id := N + 176; -- VMS
   Name_Import_Function                : constant Name_Id := N + 177; -- GNAT
   Name_Import_Object                  : constant Name_Id := N + 178; -- GNAT
   Name_Import_Procedure               : constant Name_Id := N + 179; -- GNAT
   Name_Import_Valued_Procedure        : constant Name_Id := N + 180; -- GNAT
   Name_Inline                         : constant Name_Id := N + 181;
   Name_Inline_Always                  : constant Name_Id := N + 182; -- GNAT
   Name_Inline_Generic                 : constant Name_Id := N + 183; -- GNAT
   Name_Inspection_Point               : constant Name_Id := N + 184;
   Name_Interface                      : constant Name_Id := N + 185; -- Ada 83
   Name_Interface_Name                 : constant Name_Id := N + 186; -- GNAT
   Name_Interrupt_Handler              : constant Name_Id := N + 187;
   Name_Interrupt_Priority             : constant Name_Id := N + 188;
   Name_Java_Constructor               : constant Name_Id := N + 189; -- GNAT
   Name_Java_Interface                 : constant Name_Id := N + 190; -- GNAT
   ...
   Name_Optimize                       : constant Name_Id := N + 201;
   Name_Pack                           : constant Name_Id := N + 202;
   Name_Page                           : constant Name_Id := N + 203;
   Name_Passive                        : constant Name_Id := N + 204; -- GNAT
   Name_Preelaborate                   : constant Name_Id := N + 205;
   Name_Priority                       : constant Name_Id := N + 206;
   Name_Psect_Object                   : constant Name_Id := N + 207; -- VMS
   Name_Pure                           : constant Name_Id := N + 208;
   Name_Pure_Function                  : constant Name_Id := N + 209; -- GNAT
   Name_Remote_Call_Interface          : constant Name_Id := N + 210;
   Name_Remote_Types                   : constant Name_Id := N + 211;
   Name_Share_Generic                  : constant Name_Id := N + 212; -- GNAT
   Name_Shared                         : constant Name_Id := N + 213; -- Ada 83
   Name_Shared_Passive                 : constant Name_Id := N + 214;
   ...
   Name_Source_Reference               : constant Name_Id := N + 215; -- GNAT
   Name_Stream_Convert                 : constant Name_Id := N + 216; -- GNAT
   Name_Subtitle                       : constant Name_Id := N + 217; -- GNAT
   Name_Suppress_All                   : constant Name_Id := N + 218; -- GNAT
   Name_Suppress_Debug_Info            : constant Name_Id := N + 219; -- GNAT
   Name_Suppress_Initialization        : constant Name_Id := N + 220; -- GNAT
   Name_System_Name                    : constant Name_Id := N + 221; -- Ada 83
   Name_Task_Info                      : constant Name_Id := N + 222; -- GNAT
   Name_Task_Name                      : constant Name_Id := N + 223; -- GNAT
   Name_Task_Storage                   : constant Name_Id := N + 224; -- VMS
   Name_Time_Slice                     : constant Name_Id := N + 225; -- GNAT
   Name_Title                          : constant Name_Id := N + 226; -- GNAT
   Name_Unchecked_Union                : constant Name_Id := N + 227; -- GNAT
   Name_Unimplemented_Unit             : constant Name_Id := N + 228; -- GNAT
   Name_Universal_Data                 : constant Name_Id := N + 229; -- AAMP
   Name_Unreferenced                   : constant Name_Id := N + 230; -- GNAT
   Name_Unreserve_All_Interrupts       : constant Name_Id := N + 231; -- GNAT
   Name_Volatile                       : constant Name_Id := N + 232;
   Name_Volatile_Components            : constant Name_Id := N + 233;
   Name_Weak_External                  : constant Name_Id := N + 234; -- GNAT
   Last_Pragma_Name                    : constant Name_Id := N + 234;
   ...
   First_Convention_Name               : constant Name_Id := N + 235;
   Name_Ada                            : constant Name_Id := N + 235;
   Name_Assembler                      : constant Name_Id := N + 236;
   Name_COBOL                          : constant Name_Id := N + 237;
   Name_CPP                            : constant Name_Id := N + 238;
   Name_Fortran                        : constant Name_Id := N + 239;
   Name_Intrinsic                      : constant Name_Id := N + 240;
   Name_Java                           : constant Name_Id := N + 241;
   Name_Stdcall                        : constant Name_Id := N + 242;
   Name_Stubbed                        : constant Name_Id := N + 243;
   Last_Convention_Name                : constant Name_Id := N + 243;

   --  The following names are preset as synonyms for Assembler

   Name_Asm                            : constant Name_Id := N + 244;
   Name_Assembly                       : constant Name_Id := N + 245;

   --  The following names are preset as synonyms for C

   Name_Default                        : constant Name_Id := N + 246;
   --  Name_Exernal (previously defined as pragma)

   --  The following names are present as synonyms for Stdcall

   Name_DLL                            : constant Name_Id := N + 247;
   Name_Win32                          : constant Name_Id := N + 248;

   --  Other special names used in processing pragma arguments

   Name_As_Is                          : constant Name_Id := N + 249;
   Name_Body_File_Name                 : constant Name_Id := N + 250;
   Name_Casing                         : constant Name_Id := N + 251;
   Name_Code                           : constant Name_Id := N + 252;
   Name_Component                      : constant Name_Id := N + 253;
   Name_Component_Size_4               : constant Name_Id := N + 254;
   Name_Copy                           : constant Name_Id := N + 255;
   Name_D_Float                        : constant Name_Id := N + 256;
   Name_Descriptor                     : constant Name_Id := N + 257;
   Name_Dot_Replacement                : constant Name_Id := N + 258;
   Name_Dynamic                        : constant Name_Id := N + 259;
   Name_Entity                         : constant Name_Id := N + 260;
   Name_External_Name                  : constant Name_Id := N + 261;
   Name_First_Optional_Parameter       : constant Name_Id := N + 262;
   Name_Form                           : constant Name_Id := N + 263;
   Name_G_Float                        : constant Name_Id := N + 264;
   Name_Gcc                            : constant Name_Id := N + 265;
   Name_Gnat                           : constant Name_Id := N + 266;
   Name_GPL                            : constant Name_Id := N + 267;
   Name_IEEE_Float                     : constant Name_Id := N + 268;
   Name_Homonym_Number                 : constant Name_Id := N + 269;
   Name_Internal                       : constant Name_Id := N + 270;
   Name_Link_Name                      : constant Name_Id := N + 271;
   Name_Lowercase                      : constant Name_Id := N + 272;
   Name_Max_Size                       : constant Name_Id := N + 273;
   Name_Mechanism                      : constant Name_Id := N + 274;
   Name_Mixedcase                      : constant Name_Id := N + 275;
   Name_Modified_GPL                   : constant Name_Id := N + 276;
   Name_Name                           : constant Name_Id := N + 277;
   Name_NCA                            : constant Name_Id := N + 278;
   Name_No                             : constant Name_Id := N + 279;
   Name_On                             : constant Name_Id := N + 280;
   Name_Parameter_Types                : constant Name_Id := N + 281;
   Name_Reference                      : constant Name_Id := N + 282;
   Name_Restricted                     : constant Name_Id := N + 283;
   Name_Result_Mechanism               : constant Name_Id := N + 284;
   Name_Result_Type                    : constant Name_Id := N + 285;
   Name_SB                             : constant Name_Id := N + 286;
   ...
   Name_Subtype_Alignment              : constant Name_Id := N + 388; -- GNAT
   ...
   Name_Builder                        : constant Name_Id := N + 537;
   Name_Compiler                       : constant Name_Id := N + 538;
   Name_Cross_Reference                : constant Name_Id := N + 539;
   Name_Default_Switches               : constant Name_Id := N + 540;
   Name_Exec_Dir                       : constant Name_Id := N + 541;
   Name_Extends                        : constant Name_Id := N + 542;
   Name_Finder                         : constant Name_Id := N + 543;
   Name_Gnatls                         : constant Name_Id := N + 544;
   Name_Pretty_Printer                 : constant Name_Id := N + 545;
   ...
   Name_Library_Elaboration            : constant Name_Id := N + 551;
   Name_Library_Kind                   : constant Name_Id := N + 552;
   Name_Library_Name                   : constant Name_Id := N + 553;
   Name_Library_Version                : constant Name_Id := N + 554;
   Name_Linker                         : constant Name_Id := N + 555;
   Name_Naming                         : constant Name_Id := N + 556;
   Name_Object_Dir                     : constant Name_Id := N + 557;
   Name_Project                        : constant Name_Id := N + 558;
   Name_Separate_Suffix                : constant Name_Id := N + 559;
   Name_Source_Dirs                    : constant Name_Id := N + 560;
   Name_Source_Files                   : constant Name_Id := N + 561;
   Name_Source_List_File               : constant Name_Id := N + 562;
   Name_Specification                  : constant Name_Id := N + 563;
   Name_Specification_Exceptions       : constant Name_Id := N + 564;
   Name_Specification_Suffix           : constant Name_Id := N + 565;
   Name_Switches                       : constant Name_Id := N + 566;
   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 566;
