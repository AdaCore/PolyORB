...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Gnatls                         : constant Name_Id := N + 543;
   Name_Gnatstub                       : constant Name_Id := N + 544;
   Name_Implementation                 : constant Name_Id := N + 545;
   Name_Implementation_Exceptions      : constant Name_Id := N + 546;
   Name_Implementation_Suffix          : constant Name_Id := N + 547;
   Name_Languages                      : constant Name_Id := N + 548;
   Name_Library_Dir                    : constant Name_Id := N + 549;
   Name_Library_Auto_Init              : constant Name_Id := N + 550;
   Name_Library_GCC                    : constant Name_Id := N + 551;
   Name_Library_Interface              : constant Name_Id := N + 552;
   Name_Library_Kind                   : constant Name_Id := N + 553;
   Name_Library_Name                   : constant Name_Id := N + 554;
   Name_Library_Options                : constant Name_Id := N + 555;
   Name_Library_Src_Dir                : constant Name_Id := N + 556;
   Name_Library_Version                : constant Name_Id := N + 557;
   Name_Linker                         : constant Name_Id := N + 558;
   Name_Locally_Removed_Files          : constant Name_Id := N + 559;
   Name_Naming                         : constant Name_Id := N + 560;
   Name_Object_Dir                     : constant Name_Id := N + 561;
   Name_Pretty_Printer                 : constant Name_Id := N + 562;
   Name_Project                        : constant Name_Id := N + 563;
   Name_Separate_Suffix                : constant Name_Id := N + 564;
   Name_Source_Dirs                    : constant Name_Id := N + 565;
   Name_Source_Files                   : constant Name_Id := N + 566;
   Name_Source_List_File               : constant Name_Id := N + 567;
   Name_Spec                           : constant Name_Id := N + 568;
   Name_Spec_Suffix                    : constant Name_Id := N + 569;
   ...
   Name_Unaligned_Valid                : constant Name_Id := N + 574;
