...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Component_Alignment            : constant Name_Id := N + 116; -- GNAT
   Name_Convention_Identifier          : constant Name_Id := N + 117; -- GNAT
   ...
   Name_Propagate_Exceptions           : constant Name_Id := N + 132; -- GNAT
   Name_Queuing_Policy                 : constant Name_Id := N + 133;
   Name_Ravenscar                      : constant Name_Id := N + 134;
   Name_Restricted_Run_Time            : constant Name_Id := N + 135;
   Name_Restrictions                   : constant Name_Id := N + 136;
   Name_Reviewable                     : constant Name_Id := N + 137;
   Name_Source_File_Name               : constant Name_Id := N + 138; -- GNAT
   ...
   Name_Unsuppress                     : constant Name_Id := N + 142; -- GNAT
   Name_Use_VADS_Size                  : constant Name_Id := N + 143; -- GNAT
   Name_Warnings                       : constant Name_Id := N + 144; -- GNAT
   Name_Validity_Checks                : constant Name_Id := N + 145; -- GNAT
   Last_Configuration_Pragma_Name      : constant Name_Id := N + 145;

   --  Remaining pragma names

   Name_Abort_Defer                    : constant Name_Id := N + 146; -- GNAT
   Name_All_Calls_Remote               : constant Name_Id := N + 147;
   Name_Annotate                       : constant Name_Id := N + 148; -- GNAT
   ...
   Name_Assert                         : constant Name_Id := N + 149; -- GNAT
   Name_Asynchronous                   : constant Name_Id := N + 150;
   Name_Atomic                         : constant Name_Id := N + 151;
   Name_Atomic_Components              : constant Name_Id := N + 152;
   Name_Attach_Handler                 : constant Name_Id := N + 153;
   Name_Comment                        : constant Name_Id := N + 154; -- GNAT
   Name_Common_Object                  : constant Name_Id := N + 155; -- GNAT
   Name_Complex_Representation         : constant Name_Id := N + 156; -- GNAT
   Name_Controlled                     : constant Name_Id := N + 157;
   Name_Convention                     : constant Name_Id := N + 158;
   Name_CPP_Class                      : constant Name_Id := N + 159; -- GNAT
   Name_CPP_Constructor                : constant Name_Id := N + 160; -- GNAT
   Name_CPP_Virtual                    : constant Name_Id := N + 161; -- GNAT
   Name_CPP_Vtable                     : constant Name_Id := N + 162; -- GNAT
   Name_Debug                          : constant Name_Id := N + 163; -- GNAT
   Name_Elaborate                      : constant Name_Id := N + 164; -- Ada 83
   Name_Elaborate_All                  : constant Name_Id := N + 165;
   Name_Elaborate_Body                 : constant Name_Id := N + 166;
   Name_Export                         : constant Name_Id := N + 167;
   Name_Export_Exception               : constant Name_Id := N + 168; -- VMS
   Name_Export_Function                : constant Name_Id := N + 169; -- GNAT
   Name_Export_Object                  : constant Name_Id := N + 170; -- GNAT
   Name_Export_Procedure               : constant Name_Id := N + 171; -- GNAT
   Name_Export_Valued_Procedure        : constant Name_Id := N + 172; -- GNAT
   Name_External                       : constant Name_Id := N + 173; -- GNAT
   Name_Finalize_Storage_Only          : constant Name_Id := N + 174; -- GNAT
   Name_Ident                          : constant Name_Id := N + 175; -- VMS
   Name_Import                         : constant Name_Id := N + 176;
   Name_Import_Exception               : constant Name_Id := N + 177; -- VMS
   Name_Import_Function                : constant Name_Id := N + 178; -- GNAT
   Name_Import_Object                  : constant Name_Id := N + 179; -- GNAT
   Name_Import_Procedure               : constant Name_Id := N + 180; -- GNAT
   Name_Import_Valued_Procedure        : constant Name_Id := N + 181; -- GNAT
   Name_Inline                         : constant Name_Id := N + 182;
   Name_Inline_Always                  : constant Name_Id := N + 183; -- GNAT
   Name_Inline_Generic                 : constant Name_Id := N + 184; -- GNAT
   Name_Inspection_Point               : constant Name_Id := N + 185;
   Name_Interface                      : constant Name_Id := N + 186; -- Ada 83
   Name_Interface_Name                 : constant Name_Id := N + 187; -- GNAT
   Name_Interrupt_Handler              : constant Name_Id := N + 188;
   Name_Interrupt_Priority             : constant Name_Id := N + 189;
   Name_Java_Constructor               : constant Name_Id := N + 190; -- GNAT
   Name_Java_Interface                 : constant Name_Id := N + 191; -- GNAT
   Name_Link_With                      : constant Name_Id := N + 192; -- GNAT
   Name_Linker_Alias                   : constant Name_Id := N + 193; -- GNAT
   Name_Linker_Options                 : constant Name_Id := N + 194;
   Name_Linker_Section                 : constant Name_Id := N + 195; -- GNAT
   Name_List                           : constant Name_Id := N + 196;
   Name_Machine_Attribute              : constant Name_Id := N + 197; -- GNAT
   Name_Main                           : constant Name_Id := N + 198; -- GNAT
   Name_Main_Storage                   : constant Name_Id := N + 199; -- GNAT
   Name_Memory_Size                    : constant Name_Id := N + 200; -- Ada 83
   Name_No_Return                      : constant Name_Id := N + 201; -- GNAT
   Name_Optimize                       : constant Name_Id := N + 202;
   Name_Pack                           : constant Name_Id := N + 203;
   Name_Page                           : constant Name_Id := N + 204;
   Name_Passive                        : constant Name_Id := N + 205; -- GNAT
   Name_Preelaborate                   : constant Name_Id := N + 206;
   Name_Priority                       : constant Name_Id := N + 207;
   Name_Psect_Object                   : constant Name_Id := N + 208; -- VMS
   Name_Pure                           : constant Name_Id := N + 209;
   Name_Pure_Function                  : constant Name_Id := N + 210; -- GNAT
   Name_Remote_Call_Interface          : constant Name_Id := N + 211;
   Name_Remote_Types                   : constant Name_Id := N + 212;
   Name_Share_Generic                  : constant Name_Id := N + 213; -- GNAT
   Name_Shared                         : constant Name_Id := N + 214; -- Ada 83
   Name_Shared_Passive                 : constant Name_Id := N + 215;
   ...
   Name_Source_Reference               : constant Name_Id := N + 216; -- GNAT
   Name_Stream_Convert                 : constant Name_Id := N + 217; -- GNAT
   Name_Subtitle                       : constant Name_Id := N + 218; -- GNAT
   Name_Suppress_All                   : constant Name_Id := N + 219; -- GNAT
   Name_Suppress_Debug_Info            : constant Name_Id := N + 220; -- GNAT
   Name_Suppress_Initialization        : constant Name_Id := N + 221; -- GNAT
   Name_System_Name                    : constant Name_Id := N + 222; -- Ada 83
   Name_Task_Info                      : constant Name_Id := N + 223; -- GNAT
   Name_Task_Name                      : constant Name_Id := N + 224; -- GNAT
   Name_Task_Storage                   : constant Name_Id := N + 225; -- VMS
   Name_Time_Slice                     : constant Name_Id := N + 226; -- GNAT
   Name_Title                          : constant Name_Id := N + 227; -- GNAT
   Name_Unchecked_Union                : constant Name_Id := N + 228; -- GNAT
   Name_Unimplemented_Unit             : constant Name_Id := N + 229; -- GNAT
   Name_Universal_Data                 : constant Name_Id := N + 230; -- AAMP
   Name_Unreferenced                   : constant Name_Id := N + 231; -- GNAT
   Name_Unreserve_All_Interrupts       : constant Name_Id := N + 232; -- GNAT
   Name_Volatile                       : constant Name_Id := N + 233;
   Name_Volatile_Components            : constant Name_Id := N + 234;
   Name_Weak_External                  : constant Name_Id := N + 235; -- GNAT
   Last_Pragma_Name                    : constant Name_Id := N + 235;
   ...
   First_Convention_Name               : constant Name_Id := N + 236;
   Name_Ada                            : constant Name_Id := N + 236;
   Name_Assembler                      : constant Name_Id := N + 237;
   Name_COBOL                          : constant Name_Id := N + 238;
   Name_CPP                            : constant Name_Id := N + 239;
   Name_Fortran                        : constant Name_Id := N + 240;
   Name_Intrinsic                      : constant Name_Id := N + 241;
   Name_Java                           : constant Name_Id := N + 242;
   Name_Stdcall                        : constant Name_Id := N + 243;
   Name_Stubbed                        : constant Name_Id := N + 244;
   Last_Convention_Name                : constant Name_Id := N + 244;

   --  The following names are preset as synonyms for Assembler

   Name_Asm                            : constant Name_Id := N + 245;
   Name_Assembly                       : constant Name_Id := N + 246;

   --  The following names are preset as synonyms for C

   Name_Default                        : constant Name_Id := N + 247;
   --  Name_Exernal (previously defined as pragma)

   --  The following names are present as synonyms for Stdcall

   Name_DLL                            : constant Name_Id := N + 248;
   Name_Win32                          : constant Name_Id := N + 249;

   --  Other special names used in processing pragma arguments

   Name_As_Is                          : constant Name_Id := N + 250;
   Name_Body_File_Name                 : constant Name_Id := N + 251;
   Name_Casing                         : constant Name_Id := N + 252;
   Name_Code                           : constant Name_Id := N + 253;
   Name_Component                      : constant Name_Id := N + 254;
   Name_Component_Size_4               : constant Name_Id := N + 255;
   Name_Copy                           : constant Name_Id := N + 256;
   Name_D_Float                        : constant Name_Id := N + 257;
   Name_Descriptor                     : constant Name_Id := N + 258;
   Name_Dot_Replacement                : constant Name_Id := N + 259;
   Name_Dynamic                        : constant Name_Id := N + 260;
   Name_Entity                         : constant Name_Id := N + 261;
   Name_External_Name                  : constant Name_Id := N + 262;
   Name_First_Optional_Parameter       : constant Name_Id := N + 263;
   Name_Form                           : constant Name_Id := N + 264;
   Name_G_Float                        : constant Name_Id := N + 265;
   Name_Gcc                            : constant Name_Id := N + 266;
   Name_Gnat                           : constant Name_Id := N + 267;
   Name_GPL                            : constant Name_Id := N + 268;
   Name_IEEE_Float                     : constant Name_Id := N + 269;
   Name_Homonym_Number                 : constant Name_Id := N + 270;
   Name_Internal                       : constant Name_Id := N + 271;
   Name_Link_Name                      : constant Name_Id := N + 272;
   Name_Lowercase                      : constant Name_Id := N + 273;
   Name_Max_Size                       : constant Name_Id := N + 274;
   Name_Mechanism                      : constant Name_Id := N + 275;
   Name_Mixedcase                      : constant Name_Id := N + 276;
   Name_Modified_GPL                   : constant Name_Id := N + 277;
   Name_Name                           : constant Name_Id := N + 278;
   Name_NCA                            : constant Name_Id := N + 279;
   Name_No                             : constant Name_Id := N + 280;
   Name_On                             : constant Name_Id := N + 281;
   Name_Parameter_Types                : constant Name_Id := N + 282;
   Name_Reference                      : constant Name_Id := N + 283;
   Name_Restricted                     : constant Name_Id := N + 284;
   Name_Result_Mechanism               : constant Name_Id := N + 285;
   Name_Result_Type                    : constant Name_Id := N + 286;
   Name_SB                             : constant Name_Id := N + 287;
   Name_Section                        : constant Name_Id := N + 288;
   Name_Semaphore                      : constant Name_Id := N + 289;
   Name_Spec_File_Name                 : constant Name_Id := N + 290;
   Name_Static                         : constant Name_Id := N + 291;
   Name_Stack_Size                     : constant Name_Id := N + 292;
   Name_Subunit_File_Name              : constant Name_Id := N + 293;
   Name_Task_Stack_Size_Default        : constant Name_Id := N + 294;
   Name_Task_Type                      : constant Name_Id := N + 295;
   Name_Time_Slicing_Enabled           : constant Name_Id := N + 296;
   Name_Top_Guard                      : constant Name_Id := N + 297;
   Name_UBA                            : constant Name_Id := N + 298;
   Name_UBS                            : constant Name_Id := N + 299;
   Name_UBSB                           : constant Name_Id := N + 300;
   Name_Unit_Name                      : constant Name_Id := N + 301;
   Name_Unknown                        : constant Name_Id := N + 302;
   Name_Unrestricted                   : constant Name_Id := N + 303;
   Name_Uppercase                      : constant Name_Id := N + 304;
   ...
   Name_Subtype_Alignment              : constant Name_Id := N + 389; -- GNAT
   ...
   Name_Extends                        : constant Name_Id := N + 543;
   Name_Finder                         : constant Name_Id := N + 544;
   Name_Gnatls                         : constant Name_Id := N + 545;
   Name_Pretty_Printer                 : constant Name_Id := N + 546;
   Name_Implementation                 : constant Name_Id := N + 547;
   Name_Implementation_Exceptions      : constant Name_Id := N + 548;
   Name_Implementation_Suffix          : constant Name_Id := N + 549;
   Name_Languages                      : constant Name_Id := N + 550;
   Name_Library_Dir                    : constant Name_Id := N + 551;
   Name_Library_Elaboration            : constant Name_Id := N + 552;
   Name_Library_Kind                   : constant Name_Id := N + 553;
   Name_Library_Name                   : constant Name_Id := N + 554;
   Name_Library_Version                : constant Name_Id := N + 555;
   Name_Linker                         : constant Name_Id := N + 556;
   Name_Naming                         : constant Name_Id := N + 557;
   Name_Object_Dir                     : constant Name_Id := N + 558;
   Name_Project                        : constant Name_Id := N + 559;
   Name_Separate_Suffix                : constant Name_Id := N + 560;
   Name_Source_Dirs                    : constant Name_Id := N + 561;
   Name_Source_Files                   : constant Name_Id := N + 562;
   Name_Source_List_File               : constant Name_Id := N + 563;
   Name_Specification                  : constant Name_Id := N + 564;
   Name_Specification_Exceptions       : constant Name_Id := N + 565;
   Name_Specification_Suffix           : constant Name_Id := N + 566;
   Name_Switches                       : constant Name_Id := N + 567;
   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 567;
