...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Component_Alignment            : constant Name_Id := N + 110; -- GNAT
   Name_Convention_Identifier          : constant Name_Id := N + 111; -- GNAT
   Name_Discard_Names                  : constant Name_Id := N + 112;
   Name_Elaboration_Checks             : constant Name_Id := N + 113; -- GNAT
   Name_Eliminate                      : constant Name_Id := N + 114; -- GNAT
   Name_Extend_System                  : constant Name_Id := N + 115; -- GNAT
   Name_Extensions_Allowed             : constant Name_Id := N + 116; -- GNAT
   Name_External_Name_Casing           : constant Name_Id := N + 117; -- GNAT
   Name_Float_Representation           : constant Name_Id := N + 118; -- GNAT
   Name_Initialize_Scalars             : constant Name_Id := N + 119; -- GNAT
   ...
   Name_Propagate_Exceptions           : constant Name_Id := N + 126; -- GNAT
   Name_Queuing_Policy                 : constant Name_Id := N + 127;
   Name_Ravenscar                      : constant Name_Id := N + 128;
   Name_Restricted_Run_Time            : constant Name_Id := N + 129;
   Name_Restrictions                   : constant Name_Id := N + 130;
   Name_Reviewable                     : constant Name_Id := N + 131;
   Name_Source_File_Name               : constant Name_Id := N + 132; -- GNAT
   Name_Style_Checks                   : constant Name_Id := N + 133; -- GNAT
   Name_Suppress                       : constant Name_Id := N + 134;
   Name_Task_Dispatching_Policy        : constant Name_Id := N + 135;
   Name_Unsuppress                     : constant Name_Id := N + 136; -- GNAT
   Name_Use_VADS_Size                  : constant Name_Id := N + 137; -- GNAT
   Name_Warnings                       : constant Name_Id := N + 138; -- GNAT
   Name_Validity_Checks                : constant Name_Id := N + 139; -- GNAT
   Last_Configuration_Pragma_Name      : constant Name_Id := N + 139;

   --  Remaining pragma names

   Name_Abort_Defer                    : constant Name_Id := N + 140; -- GNAT
   Name_All_Calls_Remote               : constant Name_Id := N + 141;
   Name_Annotate                       : constant Name_Id := N + 142; -- GNAT
   ...
   Name_Assert                         : constant Name_Id := N + 143; -- GNAT
   Name_Asynchronous                   : constant Name_Id := N + 144;
   Name_Atomic                         : constant Name_Id := N + 145;
   Name_Atomic_Components              : constant Name_Id := N + 146;
   Name_Attach_Handler                 : constant Name_Id := N + 147;
   Name_Comment                        : constant Name_Id := N + 148; -- GNAT
   Name_Common_Object                  : constant Name_Id := N + 149; -- GNAT
   Name_Complex_Representation         : constant Name_Id := N + 150; -- GNAT
   Name_Controlled                     : constant Name_Id := N + 151;
   Name_Convention                     : constant Name_Id := N + 152;
   Name_CPP_Class                      : constant Name_Id := N + 153; -- GNAT
   Name_CPP_Constructor                : constant Name_Id := N + 154; -- GNAT
   Name_CPP_Virtual                    : constant Name_Id := N + 155; -- GNAT
   Name_CPP_Vtable                     : constant Name_Id := N + 156; -- GNAT
   Name_Debug                          : constant Name_Id := N + 157; -- GNAT
   Name_Elaborate                      : constant Name_Id := N + 158; -- Ada 83
   Name_Elaborate_All                  : constant Name_Id := N + 159;
   Name_Elaborate_Body                 : constant Name_Id := N + 160;
   Name_Export                         : constant Name_Id := N + 161;
   Name_Export_Exception               : constant Name_Id := N + 162; -- VMS
   Name_Export_Function                : constant Name_Id := N + 163; -- GNAT
   Name_Export_Object                  : constant Name_Id := N + 164; -- GNAT
   Name_Export_Procedure               : constant Name_Id := N + 165; -- GNAT
   Name_Export_Valued_Procedure        : constant Name_Id := N + 166; -- GNAT
   Name_External                       : constant Name_Id := N + 167; -- GNAT
   Name_Finalize_Storage_Only          : constant Name_Id := N + 168; -- GNAT
   Name_Ident                          : constant Name_Id := N + 169; -- VMS
   Name_Import                         : constant Name_Id := N + 170;
   Name_Import_Exception               : constant Name_Id := N + 171; -- VMS
   Name_Import_Function                : constant Name_Id := N + 172; -- GNAT
   Name_Import_Object                  : constant Name_Id := N + 173; -- GNAT
   Name_Import_Procedure               : constant Name_Id := N + 174; -- GNAT
   Name_Import_Valued_Procedure        : constant Name_Id := N + 175; -- GNAT
   Name_Inline                         : constant Name_Id := N + 176;
   Name_Inline_Always                  : constant Name_Id := N + 177; -- GNAT
   Name_Inline_Generic                 : constant Name_Id := N + 178; -- GNAT
   Name_Inspection_Point               : constant Name_Id := N + 179;
   Name_Interface                      : constant Name_Id := N + 180; -- Ada 83
   Name_Interface_Name                 : constant Name_Id := N + 181; -- GNAT
   Name_Interrupt_Handler              : constant Name_Id := N + 182;
   Name_Interrupt_Priority             : constant Name_Id := N + 183;
   Name_Java_Constructor               : constant Name_Id := N + 184; -- GNAT
   Name_Java_Interface                 : constant Name_Id := N + 185; -- GNAT
   Name_Link_With                      : constant Name_Id := N + 186; -- GNAT
   Name_Linker_Alias                   : constant Name_Id := N + 187; -- GNAT
   Name_Linker_Options                 : constant Name_Id := N + 188;
   Name_Linker_Section                 : constant Name_Id := N + 189; -- GNAT
   Name_List                           : constant Name_Id := N + 190;
   Name_Machine_Attribute              : constant Name_Id := N + 191; -- GNAT
   Name_Main                           : constant Name_Id := N + 192; -- GNAT
   Name_Main_Storage                   : constant Name_Id := N + 193; -- GNAT
   Name_Memory_Size                    : constant Name_Id := N + 194; -- Ada 83
   Name_No_Return                      : constant Name_Id := N + 195; -- GNAT
   Name_Optimize                       : constant Name_Id := N + 196;
   ...
   Name_Universal_Data                 : constant Name_Id := N + 224; -- AAMP
   ...
   Name_Section                        : constant Name_Id := N + 282;
   Name_Semaphore                      : constant Name_Id := N + 283;
   Name_Spec_File_Name                 : constant Name_Id := N + 284;
   Name_Static                         : constant Name_Id := N + 285;
   Name_Stack_Size                     : constant Name_Id := N + 286;
   Name_Subunit_File_Name              : constant Name_Id := N + 287;
   Name_Task_Stack_Size_Default        : constant Name_Id := N + 288;
   Name_Task_Type                      : constant Name_Id := N + 289;
   Name_Time_Slicing_Enabled           : constant Name_Id := N + 290;
   Name_Top_Guard                      : constant Name_Id := N + 291;
   Name_UBA                            : constant Name_Id := N + 292;
   Name_UBS                            : constant Name_Id := N + 293;
   Name_UBSB                           : constant Name_Id := N + 294;
   Name_Unit_Name                      : constant Name_Id := N + 295;
   Name_Unknown                        : constant Name_Id := N + 296;
   Name_Unrestricted                   : constant Name_Id := N + 297;
   Name_Uppercase                      : constant Name_Id := N + 298;
   Name_VAX_Float                      : constant Name_Id := N + 299;
   Name_VMS                            : constant Name_Id := N + 300;
   Name_Working_Storage                : constant Name_Id := N + 301;
   ...
   First_Attribute_Name                : constant Name_Id := N + 302;
   Name_Abort_Signal                   : constant Name_Id := N + 302;  -- GNAT
   Name_Access                         : constant Name_Id := N + 303;
   Name_Address                        : constant Name_Id := N + 304;
   Name_Address_Size                   : constant Name_Id := N + 305;  -- GNAT
   Name_Aft                            : constant Name_Id := N + 306;
   Name_Alignment                      : constant Name_Id := N + 307;
   Name_Asm_Input                      : constant Name_Id := N + 308;  -- GNAT
   Name_Asm_Output                     : constant Name_Id := N + 309;  -- GNAT
   Name_AST_Entry                      : constant Name_Id := N + 310;  -- VMS
   Name_Bit                            : constant Name_Id := N + 311;  -- GNAT
   Name_Bit_Order                      : constant Name_Id := N + 312;
   Name_Bit_Position                   : constant Name_Id := N + 313;  -- GNAT
   Name_Body_Version                   : constant Name_Id := N + 314;
   Name_Callable                       : constant Name_Id := N + 315;
   Name_Caller                         : constant Name_Id := N + 316;
   Name_Code_Address                   : constant Name_Id := N + 317;  -- GNAT
   Name_Component_Size                 : constant Name_Id := N + 318;
   Name_Compose                        : constant Name_Id := N + 319;
   Name_Constrained                    : constant Name_Id := N + 320;
   Name_Count                          : constant Name_Id := N + 321;
   Name_Default_Bit_Order              : constant Name_Id := N + 322; -- GNAT
   Name_Definite                       : constant Name_Id := N + 323;
   Name_Delta                          : constant Name_Id := N + 324;
   Name_Denorm                         : constant Name_Id := N + 325;
   Name_Digits                         : constant Name_Id := N + 326;
   Name_Elaborated                     : constant Name_Id := N + 327; -- GNAT
   Name_Emax                           : constant Name_Id := N + 328; -- Ada 83
   Name_Enum_Rep                       : constant Name_Id := N + 329; -- GNAT
   Name_Epsilon                        : constant Name_Id := N + 330; -- Ada 83
   Name_Exponent                       : constant Name_Id := N + 331;
   Name_External_Tag                   : constant Name_Id := N + 332;
   Name_First                          : constant Name_Id := N + 333;
   Name_First_Bit                      : constant Name_Id := N + 334;
   Name_Fixed_Value                    : constant Name_Id := N + 335; -- GNAT
   Name_Fore                           : constant Name_Id := N + 336;
   Name_Has_Discriminants              : constant Name_Id := N + 337; -- GNAT
   Name_Identity                       : constant Name_Id := N + 338;
   Name_Img                            : constant Name_Id := N + 339; -- GNAT
   Name_Integer_Value                  : constant Name_Id := N + 340; -- GNAT
   Name_Large                          : constant Name_Id := N + 341; -- Ada 83
   Name_Last                           : constant Name_Id := N + 342;
   Name_Last_Bit                       : constant Name_Id := N + 343;
   Name_Leading_Part                   : constant Name_Id := N + 344;
   Name_Length                         : constant Name_Id := N + 345;
   Name_Machine_Emax                   : constant Name_Id := N + 346;
   Name_Machine_Emin                   : constant Name_Id := N + 347;
   Name_Machine_Mantissa               : constant Name_Id := N + 348;
   Name_Machine_Overflows              : constant Name_Id := N + 349;
   Name_Machine_Radix                  : constant Name_Id := N + 350;
   Name_Machine_Rounds                 : constant Name_Id := N + 351;
   Name_Machine_Size                   : constant Name_Id := N + 352; -- GNAT
   Name_Mantissa                       : constant Name_Id := N + 353; -- Ada 83
   Name_Max_Size_In_Storage_Elements   : constant Name_Id := N + 354;
   Name_Maximum_Alignment              : constant Name_Id := N + 355; -- GNAT
   Name_Mechanism_Code                 : constant Name_Id := N + 356; -- GNAT
   Name_Model_Emin                     : constant Name_Id := N + 357;
   Name_Model_Epsilon                  : constant Name_Id := N + 358;
   Name_Model_Mantissa                 : constant Name_Id := N + 359;
   Name_Model_Small                    : constant Name_Id := N + 360;
   Name_Modulus                        : constant Name_Id := N + 361;
   Name_Null_Parameter                 : constant Name_Id := N + 362; -- GNAT
   Name_Object_Size                    : constant Name_Id := N + 363; -- GNAT
   Name_Partition_ID                   : constant Name_Id := N + 364;
   Name_Passed_By_Reference            : constant Name_Id := N + 365; -- GNAT
   Name_Pos                            : constant Name_Id := N + 366;
   Name_Position                       : constant Name_Id := N + 367;
   Name_Range                          : constant Name_Id := N + 368;
   Name_Range_Length                   : constant Name_Id := N + 369; -- GNAT
   Name_Round                          : constant Name_Id := N + 370;
   Name_Safe_Emax                      : constant Name_Id := N + 371; -- Ada 83
   Name_Safe_First                     : constant Name_Id := N + 372;
   Name_Safe_Large                     : constant Name_Id := N + 373; -- Ada 83
   Name_Safe_Last                      : constant Name_Id := N + 374;
   Name_Safe_Small                     : constant Name_Id := N + 375; -- Ada 83
   Name_Scale                          : constant Name_Id := N + 376;
   Name_Scaling                        : constant Name_Id := N + 377;
   Name_Signed_Zeros                   : constant Name_Id := N + 378;
   Name_Size                           : constant Name_Id := N + 379;
   Name_Small                          : constant Name_Id := N + 380;
   Name_Storage_Size                   : constant Name_Id := N + 381;
   Name_Storage_Unit                   : constant Name_Id := N + 382; -- GNAT
   Name_Subtype_Alignment              : constant Name_Id := N + 383; -- GNAT
   Name_Tag                            : constant Name_Id := N + 384;
   Name_Terminated                     : constant Name_Id := N + 385;
   Name_To_Address                     : constant Name_Id := N + 386; -- GNAT
   Name_Type_Class                     : constant Name_Id := N + 387; -- GNAT
   Name_UET_Address                    : constant Name_Id := N + 388; -- GNAT
   Name_Unbiased_Rounding              : constant Name_Id := N + 389;
   Name_Unchecked_Access               : constant Name_Id := N + 390;
   ...
   Last_Intrinsic_Name                 : constant Name_Id := N + 523;

   --  Reserved words used only in Ada 95

   First_95_Reserved_Word              : constant Name_Id := N + 524;
   Name_Abstract                       : constant Name_Id := N + 524;
   Name_Aliased                        : constant Name_Id := N + 525;
   Name_Protected                      : constant Name_Id := N + 526;
   Name_Until                          : constant Name_Id := N + 527;
   Name_Requeue                        : constant Name_Id := N + 528;
   Name_Tagged                         : constant Name_Id := N + 529;
   Last_95_Reserved_Word               : constant Name_Id := N + 529;
   ...
   Name_Raise_Exception                : constant Name_Id := N + 530;

   --  Additional reserved words in GNAT Project Files
   --  Note that Name_External is already previously declared

   Name_Binder                         : constant Name_Id := N + 531;
   Name_Builder                        : constant Name_Id := N + 532;
   Name_Compiler                       : constant Name_Id := N + 533;
   Name_Cross_Reference                : constant Name_Id := N + 534;
   Name_Default_Switches               : constant Name_Id := N + 535;
   Name_Exec_Dir                       : constant Name_Id := N + 536;
   Name_Extends                        : constant Name_Id := N + 537;
   Name_Finder                         : constant Name_Id := N + 538;
   Name_Gnatls                         : constant Name_Id := N + 539;
   Name_Pretty_Printer                 : constant Name_Id := N + 540;
   Name_Implementation                 : constant Name_Id := N + 541;
   Name_Implementation_Exceptions      : constant Name_Id := N + 542;
   Name_Implementation_Suffix          : constant Name_Id := N + 543;
   Name_Languages                      : constant Name_Id := N + 544;
   Name_Library_Dir                    : constant Name_Id := N + 545;
   Name_Library_Elaboration            : constant Name_Id := N + 546;
   Name_Library_Kind                   : constant Name_Id := N + 547;
   Name_Library_Name                   : constant Name_Id := N + 548;
   Name_Library_Version                : constant Name_Id := N + 549;
   Name_Linker                         : constant Name_Id := N + 550;
   Name_Naming                         : constant Name_Id := N + 551;
   Name_Object_Dir                     : constant Name_Id := N + 552;
   Name_Project                        : constant Name_Id := N + 553;
   Name_Separate_Suffix                : constant Name_Id := N + 554;
   Name_Source_Dirs                    : constant Name_Id := N + 555;
   Name_Source_Files                   : constant Name_Id := N + 556;
   Name_Source_List_File               : constant Name_Id := N + 557;
   Name_Specification                  : constant Name_Id := N + 558;
   Name_Specification_Exceptions       : constant Name_Id := N + 559;
   Name_Specification_Suffix           : constant Name_Id := N + 560;
   Name_Switches                       : constant Name_Id := N + 561;
   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 561;
