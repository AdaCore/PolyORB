...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Argument                       : constant Name_Id := N + 086;

   --  Operator Symbol entries. The actual names have an upper case O at
   --  the start in place of the Op_ prefix (e.g. the actual name that
   --  corresponds to Name_Op_Abs is "Oabs".

   First_Operator_Name                 : constant Name_Id := N + 087;
   Name_Op_Abs                         : constant Name_Id := N + 087; -- "abs"
   Name_Op_And                         : constant Name_Id := N + 088; -- "and"
   Name_Op_Mod                         : constant Name_Id := N + 089; -- "mod"
   Name_Op_Not                         : constant Name_Id := N + 090; -- "not"
   Name_Op_Or                          : constant Name_Id := N + 091; -- "or"
   Name_Op_Rem                         : constant Name_Id := N + 092; -- "rem"
   Name_Op_Xor                         : constant Name_Id := N + 093; -- "xor"
   Name_Op_Eq                          : constant Name_Id := N + 094; -- "="
   Name_Op_Ne                          : constant Name_Id := N + 095; -- "/="
   Name_Op_Lt                          : constant Name_Id := N + 096; -- "<"
   Name_Op_Le                          : constant Name_Id := N + 097; -- "<="
   Name_Op_Gt                          : constant Name_Id := N + 098; -- ">"
   Name_Op_Ge                          : constant Name_Id := N + 099; -- ">="
   Name_Op_Add                         : constant Name_Id := N + 100; -- "+"
   Name_Op_Subtract                    : constant Name_Id := N + 101; -- "-"
   Name_Op_Concat                      : constant Name_Id := N + 102; -- "&"
   Name_Op_Multiply                    : constant Name_Id := N + 103; -- "*"
   Name_Op_Divide                      : constant Name_Id := N + 104; -- "/"
   Name_Op_Expon                       : constant Name_Id := N + 105; -- "**"
   Last_Operator_Name                  : constant Name_Id := N + 105;
   ...
   First_Pragma_Name                   : constant Name_Id := N + 106;

   --  Configuration pragmas are grouped at start

   Name_Ada_83                         : constant Name_Id := N + 106; -- GNAT
   Name_Ada_95                         : constant Name_Id := N + 107; -- GNAT
   Name_C_Pass_By_Copy                 : constant Name_Id := N + 108; -- GNAT
   Name_Component_Alignment            : constant Name_Id := N + 109; -- GNAT
   Name_Convention_Identifier          : constant Name_Id := N + 110; -- GNAT
   Name_Discard_Names                  : constant Name_Id := N + 111;
   Name_Elaboration_Checks             : constant Name_Id := N + 112; -- GNAT
   Name_Eliminate                      : constant Name_Id := N + 113; -- GNAT
   ...
   Name_Normalize_Scalars              : constant Name_Id := N + 123;
   Name_Polling                        : constant Name_Id := N + 124; -- GNAT
   ...
   Name_Reviewable                     : constant Name_Id := N + 130;
   Name_Source_File_Name               : constant Name_Id := N + 131; -- GNAT
   Name_Style_Checks                   : constant Name_Id := N + 132; -- GNAT
   Name_Suppress                       : constant Name_Id := N + 133;
   Name_Task_Dispatching_Policy        : constant Name_Id := N + 134;
   Name_Unsuppress                     : constant Name_Id := N + 135; -- GNAT
   Name_Use_VADS_Size                  : constant Name_Id := N + 136; -- GNAT
   Name_Warnings                       : constant Name_Id := N + 137; -- GNAT
   Name_Validity_Checks                : constant Name_Id := N + 138; -- GNAT
   Last_Configuration_Pragma_Name      : constant Name_Id := N + 138;

   --  Remaining pragma names

   Name_Abort_Defer                    : constant Name_Id := N + 139; -- GNAT
   Name_All_Calls_Remote               : constant Name_Id := N + 140;
   Name_Annotate                       : constant Name_Id := N + 141; -- GNAT
   ...
   Name_Assert                         : constant Name_Id := N + 142; -- GNAT
   Name_Asynchronous                   : constant Name_Id := N + 143;
   Name_Atomic                         : constant Name_Id := N + 144;
   Name_Atomic_Components              : constant Name_Id := N + 145;
   Name_Attach_Handler                 : constant Name_Id := N + 146;
   Name_Comment                        : constant Name_Id := N + 147; -- GNAT
   Name_Common_Object                  : constant Name_Id := N + 148; -- GNAT
   Name_Complex_Representation         : constant Name_Id := N + 149; -- GNAT
   Name_Controlled                     : constant Name_Id := N + 150;
   Name_Convention                     : constant Name_Id := N + 151;
   Name_CPP_Class                      : constant Name_Id := N + 152; -- GNAT
   Name_CPP_Constructor                : constant Name_Id := N + 153; -- GNAT
   Name_CPP_Virtual                    : constant Name_Id := N + 154; -- GNAT
   Name_CPP_Vtable                     : constant Name_Id := N + 155; -- GNAT
   Name_Debug                          : constant Name_Id := N + 156; -- GNAT
   Name_Elaborate                      : constant Name_Id := N + 157; -- Ada 83
   Name_Elaborate_All                  : constant Name_Id := N + 158;
   Name_Elaborate_Body                 : constant Name_Id := N + 159;
   Name_Export                         : constant Name_Id := N + 160;
   Name_Export_Exception               : constant Name_Id := N + 161; -- VMS
   Name_Export_Function                : constant Name_Id := N + 162; -- GNAT
   Name_Export_Object                  : constant Name_Id := N + 163; -- GNAT
   Name_Export_Procedure               : constant Name_Id := N + 164; -- GNAT
   Name_Export_Valued_Procedure        : constant Name_Id := N + 165; -- GNAT
   Name_External                       : constant Name_Id := N + 166; -- GNAT
   Name_Finalize_Storage_Only          : constant Name_Id := N + 167; -- GNAT
   Name_Ident                          : constant Name_Id := N + 168; -- VMS
   Name_Import                         : constant Name_Id := N + 169;
   Name_Import_Exception               : constant Name_Id := N + 170; -- VMS
   Name_Import_Function                : constant Name_Id := N + 171; -- GNAT
   Name_Import_Object                  : constant Name_Id := N + 172; -- GNAT
   Name_Import_Procedure               : constant Name_Id := N + 173; -- GNAT
   Name_Import_Valued_Procedure        : constant Name_Id := N + 174; -- GNAT
   Name_Inline                         : constant Name_Id := N + 175;
   Name_Inline_Always                  : constant Name_Id := N + 176; -- GNAT
   Name_Inline_Generic                 : constant Name_Id := N + 177; -- GNAT
   Name_Inspection_Point               : constant Name_Id := N + 178;
   Name_Interface                      : constant Name_Id := N + 179; -- Ada 83
   Name_Interface_Name                 : constant Name_Id := N + 180; -- GNAT
   Name_Interrupt_Handler              : constant Name_Id := N + 181;
   Name_Interrupt_Priority             : constant Name_Id := N + 182;
   Name_Java_Constructor               : constant Name_Id := N + 183; -- GNAT
   Name_Java_Interface                 : constant Name_Id := N + 184; -- GNAT
   Name_Link_With                      : constant Name_Id := N + 185; -- GNAT
   Name_Linker_Alias                   : constant Name_Id := N + 186; -- GNAT
   Name_Linker_Options                 : constant Name_Id := N + 187;
   Name_Linker_Section                 : constant Name_Id := N + 188; -- GNAT
   Name_List                           : constant Name_Id := N + 189;
   Name_Machine_Attribute              : constant Name_Id := N + 190; -- GNAT
   Name_Main                           : constant Name_Id := N + 191; -- GNAT
   Name_Main_Storage                   : constant Name_Id := N + 192; -- GNAT
   Name_Memory_Size                    : constant Name_Id := N + 193; -- Ada 83
   Name_No_Return                      : constant Name_Id := N + 194; -- GNAT
   ...
   Name_Time_Slice                     : constant Name_Id := N + 219; -- GNAT
   Name_Title                          : constant Name_Id := N + 220; -- GNAT
   Name_Unchecked_Union                : constant Name_Id := N + 221; -- GNAT
   Name_Unimplemented_Unit             : constant Name_Id := N + 222; -- GNAT
   Name_Universal_Data                 : constant Name_Id := N + 223; -- AAMP
   ...
   Name_SB                             : constant Name_Id := N + 280;
   Name_Section                        : constant Name_Id := N + 281;
   Name_Semaphore                      : constant Name_Id := N + 282;
   Name_Spec_File_Name                 : constant Name_Id := N + 283;
   Name_Static                         : constant Name_Id := N + 284;
   Name_Stack_Size                     : constant Name_Id := N + 285;
   Name_Subunit_File_Name              : constant Name_Id := N + 286;
   Name_Task_Stack_Size_Default        : constant Name_Id := N + 287;
   Name_Task_Type                      : constant Name_Id := N + 288;
   Name_Time_Slicing_Enabled           : constant Name_Id := N + 289;
   Name_Top_Guard                      : constant Name_Id := N + 290;
   Name_UBA                            : constant Name_Id := N + 291;
   Name_UBS                            : constant Name_Id := N + 292;
   Name_UBSB                           : constant Name_Id := N + 293;
   Name_Unit_Name                      : constant Name_Id := N + 294;
   Name_Unknown                        : constant Name_Id := N + 295;
   Name_Unrestricted                   : constant Name_Id := N + 296;
   Name_Uppercase                      : constant Name_Id := N + 297;
   Name_VAX_Float                      : constant Name_Id := N + 298;
   Name_VMS                            : constant Name_Id := N + 299;
   Name_Working_Storage                : constant Name_Id := N + 300;
   ...
   First_Attribute_Name                : constant Name_Id := N + 301;
   Name_Abort_Signal                   : constant Name_Id := N + 301;  -- GNAT
   Name_Access                         : constant Name_Id := N + 302;
   Name_Address                        : constant Name_Id := N + 303;
   Name_Address_Size                   : constant Name_Id := N + 304;  -- GNAT
   Name_Aft                            : constant Name_Id := N + 305;
   Name_Alignment                      : constant Name_Id := N + 306;
   Name_Asm_Input                      : constant Name_Id := N + 307;  -- GNAT
   Name_Asm_Output                     : constant Name_Id := N + 308;  -- GNAT
   Name_AST_Entry                      : constant Name_Id := N + 309;  -- VMS
   Name_Bit                            : constant Name_Id := N + 310;  -- GNAT
   Name_Bit_Order                      : constant Name_Id := N + 311;
   Name_Bit_Position                   : constant Name_Id := N + 312;  -- GNAT
   Name_Body_Version                   : constant Name_Id := N + 313;
   Name_Callable                       : constant Name_Id := N + 314;
   Name_Caller                         : constant Name_Id := N + 315;
   Name_Code_Address                   : constant Name_Id := N + 316;  -- GNAT
   Name_Component_Size                 : constant Name_Id := N + 317;
   Name_Compose                        : constant Name_Id := N + 318;
   Name_Constrained                    : constant Name_Id := N + 319;
   Name_Count                          : constant Name_Id := N + 320;
   Name_Default_Bit_Order              : constant Name_Id := N + 321; -- GNAT
   Name_Definite                       : constant Name_Id := N + 322;
   Name_Delta                          : constant Name_Id := N + 323;
   Name_Denorm                         : constant Name_Id := N + 324;
   Name_Digits                         : constant Name_Id := N + 325;
   Name_Elaborated                     : constant Name_Id := N + 326; -- GNAT
   Name_Emax                           : constant Name_Id := N + 327; -- Ada 83
   Name_Enum_Rep                       : constant Name_Id := N + 328; -- GNAT
   Name_Epsilon                        : constant Name_Id := N + 329; -- Ada 83
   Name_Exponent                       : constant Name_Id := N + 330;
   Name_External_Tag                   : constant Name_Id := N + 331;
   Name_First                          : constant Name_Id := N + 332;
   Name_First_Bit                      : constant Name_Id := N + 333;
   Name_Fixed_Value                    : constant Name_Id := N + 334; -- GNAT
   Name_Fore                           : constant Name_Id := N + 335;
   Name_Has_Discriminants              : constant Name_Id := N + 336; -- GNAT
   Name_Identity                       : constant Name_Id := N + 337;
   Name_Img                            : constant Name_Id := N + 338; -- GNAT
   Name_Integer_Value                  : constant Name_Id := N + 339; -- GNAT
   Name_Large                          : constant Name_Id := N + 340; -- Ada 83
   Name_Last                           : constant Name_Id := N + 341;
   Name_Last_Bit                       : constant Name_Id := N + 342;
   Name_Leading_Part                   : constant Name_Id := N + 343;
   Name_Length                         : constant Name_Id := N + 344;
   Name_Machine_Emax                   : constant Name_Id := N + 345;
   Name_Machine_Emin                   : constant Name_Id := N + 346;
   Name_Machine_Mantissa               : constant Name_Id := N + 347;
   Name_Machine_Overflows              : constant Name_Id := N + 348;
   Name_Machine_Radix                  : constant Name_Id := N + 349;
   Name_Machine_Rounds                 : constant Name_Id := N + 350;
   Name_Machine_Size                   : constant Name_Id := N + 351; -- GNAT
   Name_Mantissa                       : constant Name_Id := N + 352; -- Ada 83
   Name_Max_Size_In_Storage_Elements   : constant Name_Id := N + 353;
   Name_Maximum_Alignment              : constant Name_Id := N + 354; -- GNAT
   Name_Mechanism_Code                 : constant Name_Id := N + 355; -- GNAT
   Name_Model_Emin                     : constant Name_Id := N + 356;
   Name_Model_Epsilon                  : constant Name_Id := N + 357;
   Name_Model_Mantissa                 : constant Name_Id := N + 358;
   Name_Model_Small                    : constant Name_Id := N + 359;
   Name_Modulus                        : constant Name_Id := N + 360;
   Name_Null_Parameter                 : constant Name_Id := N + 361; -- GNAT
   Name_Object_Size                    : constant Name_Id := N + 362; -- GNAT
   Name_Partition_ID                   : constant Name_Id := N + 363;
   Name_Passed_By_Reference            : constant Name_Id := N + 364; -- GNAT
   ...
   Name_Subtype_Alignment              : constant Name_Id := N + 382; -- GNAT
   Name_Tag                            : constant Name_Id := N + 383;
   ...
   Name_Universal_Literal_String       : constant Name_Id := N + 390; -- GNAT
   Name_Unrestricted_Access            : constant Name_Id := N + 391; -- GNAT
   Name_VADS_Size                      : constant Name_Id := N + 392; -- GNAT
   Name_Val                            : constant Name_Id := N + 393;
   Name_Valid                          : constant Name_Id := N + 394;
   Name_Value_Size                     : constant Name_Id := N + 395; -- GNAT
   Name_Version                        : constant Name_Id := N + 396;
   Name_Wchar_T_Size                   : constant Name_Id := N + 397; -- GNAT
   Name_Wide_Width                     : constant Name_Id := N + 398;
   Name_Width                          : constant Name_Id := N + 399;
   Name_Word_Size                      : constant Name_Id := N + 400; -- GNAT

   --  Attributes that designate attributes returning renamable functions,
   --  i.e. functions that return other than a universal value.

   First_Renamable_Function_Attribute  : constant Name_Id := N + 401;
   Name_Adjacent                       : constant Name_Id := N + 401;
   Name_Ceiling                        : constant Name_Id := N + 402;
   Name_Copy_Sign                      : constant Name_Id := N + 403;
   Name_Floor                          : constant Name_Id := N + 404;
   Name_Fraction                       : constant Name_Id := N + 405;
   Name_Image                          : constant Name_Id := N + 406;
   Name_Input                          : constant Name_Id := N + 407;
   Name_Machine                        : constant Name_Id := N + 408;
   Name_Max                            : constant Name_Id := N + 409;
   Name_Min                            : constant Name_Id := N + 410;
   Name_Model                          : constant Name_Id := N + 411;
   Name_Pred                           : constant Name_Id := N + 412;
   Name_Remainder                      : constant Name_Id := N + 413;
   Name_Rounding                       : constant Name_Id := N + 414;
   Name_Succ                           : constant Name_Id := N + 415;
   Name_Truncation                     : constant Name_Id := N + 416;
   Name_Value                          : constant Name_Id := N + 417;
   Name_Wide_Image                     : constant Name_Id := N + 418;
   Name_Wide_Value                     : constant Name_Id := N + 419;
   Last_Renamable_Function_Attribute   : constant Name_Id := N + 419;

   --  Attributes that designate procedures

   First_Procedure_Attribute           : constant Name_Id := N + 420;
   Name_Output                         : constant Name_Id := N + 420;
   Name_Read                           : constant Name_Id := N + 421;
   Name_Write                          : constant Name_Id := N + 422;
   Last_Procedure_Attribute            : constant Name_Id := N + 422;

   --  Remaining attributes are ones that return entities

   First_Entity_Attribute_Name         : constant Name_Id := N + 423;
   Name_Elab_Body                      : constant Name_Id := N + 423; -- GNAT
   Name_Elab_Spec                      : constant Name_Id := N + 424; -- GNAT
   Name_Storage_Pool                   : constant Name_Id := N + 425;

   --  These attributes are the ones that return types

   First_Type_Attribute_Name           : constant Name_Id := N + 426;
   Name_Base                           : constant Name_Id := N + 426;
   Name_Class                          : constant Name_Id := N + 427;
   Last_Type_Attribute_Name            : constant Name_Id := N + 427;
   Last_Entity_Attribute_Name          : constant Name_Id := N + 427;
   Last_Attribute_Name                 : constant Name_Id := N + 427;
   ...
   First_Locking_Policy_Name           : constant Name_Id := N + 428;
   Name_Ceiling_Locking                : constant Name_Id := N + 428;
   Name_Inheritance_Locking            : constant Name_Id := N + 429;
   Last_Locking_Policy_Name            : constant Name_Id := N + 429;
   ...
   First_Queuing_Policy_Name           : constant Name_Id := N + 430;
   Name_FIFO_Queuing                   : constant Name_Id := N + 430;
   Name_Priority_Queuing               : constant Name_Id := N + 431;
   Last_Queuing_Policy_Name            : constant Name_Id := N + 431;
   ...
   First_Task_Dispatching_Policy_Name  : constant Name_Id := N + 432;
   Name_Fifo_Within_Priorities         : constant Name_Id := N + 432;
   Last_Task_Dispatching_Policy_Name   : constant Name_Id := N + 432;

   --  Names of recognized checks for pragma Suppress

   First_Check_Name                    : constant Name_Id := N + 433;
   Name_Access_Check                   : constant Name_Id := N + 433;
   Name_Accessibility_Check            : constant Name_Id := N + 434;
   Name_Discriminant_Check             : constant Name_Id := N + 435;
   Name_Division_Check                 : constant Name_Id := N + 436;
   Name_Elaboration_Check              : constant Name_Id := N + 437;
   Name_Index_Check                    : constant Name_Id := N + 438;
   Name_Length_Check                   : constant Name_Id := N + 439;
   Name_Overflow_Check                 : constant Name_Id := N + 440;
   Name_Range_Check                    : constant Name_Id := N + 441;
   Name_Storage_Check                  : constant Name_Id := N + 442;
   Name_Tag_Check                      : constant Name_Id := N + 443;
   Name_All_Checks                     : constant Name_Id := N + 444;
   Last_Check_Name                     : constant Name_Id := N + 444;

   --  Names corresponding to reserved keywords, excluding those already
   --  declared in the attribute list (Access, Delta, Digits, Range).

   Name_Abort                          : constant Name_Id := N + 445;
   Name_Abs                            : constant Name_Id := N + 446;
   Name_Accept                         : constant Name_Id := N + 447;
   Name_And                            : constant Name_Id := N + 448;
   Name_All                            : constant Name_Id := N + 449;
   Name_Array                          : constant Name_Id := N + 450;
   Name_At                             : constant Name_Id := N + 451;
   Name_Begin                          : constant Name_Id := N + 452;
   Name_Body                           : constant Name_Id := N + 453;
   Name_Case                           : constant Name_Id := N + 454;
   Name_Constant                       : constant Name_Id := N + 455;
   Name_Declare                        : constant Name_Id := N + 456;
   Name_Delay                          : constant Name_Id := N + 457;
   Name_Do                             : constant Name_Id := N + 458;
   Name_Else                           : constant Name_Id := N + 459;
   Name_Elsif                          : constant Name_Id := N + 460;
   Name_End                            : constant Name_Id := N + 461;
   Name_Entry                          : constant Name_Id := N + 462;
   Name_Exception                      : constant Name_Id := N + 463;
   Name_Exit                           : constant Name_Id := N + 464;
   Name_For                            : constant Name_Id := N + 465;
   Name_Function                       : constant Name_Id := N + 466;
   Name_Generic                        : constant Name_Id := N + 467;
   Name_Goto                           : constant Name_Id := N + 468;
   Name_If                             : constant Name_Id := N + 469;
   Name_In                             : constant Name_Id := N + 470;
   Name_Is                             : constant Name_Id := N + 471;
   Name_Limited                        : constant Name_Id := N + 472;
   Name_Loop                           : constant Name_Id := N + 473;
   Name_Mod                            : constant Name_Id := N + 474;
   Name_New                            : constant Name_Id := N + 475;
   Name_Not                            : constant Name_Id := N + 476;
   Name_Null                           : constant Name_Id := N + 477;
   Name_Of                             : constant Name_Id := N + 478;
   Name_Or                             : constant Name_Id := N + 479;
   Name_Others                         : constant Name_Id := N + 480;
   Name_Out                            : constant Name_Id := N + 481;
   Name_Package                        : constant Name_Id := N + 482;
   Name_Pragma                         : constant Name_Id := N + 483;
   Name_Private                        : constant Name_Id := N + 484;
   Name_Procedure                      : constant Name_Id := N + 485;
   Name_Raise                          : constant Name_Id := N + 486;
   Name_Record                         : constant Name_Id := N + 487;
   Name_Rem                            : constant Name_Id := N + 488;
   Name_Renames                        : constant Name_Id := N + 489;
   Name_Return                         : constant Name_Id := N + 490;
   Name_Reverse                        : constant Name_Id := N + 491;
   Name_Select                         : constant Name_Id := N + 492;
   Name_Separate                       : constant Name_Id := N + 493;
   Name_Subtype                        : constant Name_Id := N + 494;
   Name_Task                           : constant Name_Id := N + 495;
   Name_Terminate                      : constant Name_Id := N + 496;
   Name_Then                           : constant Name_Id := N + 497;
   Name_Type                           : constant Name_Id := N + 498;
   Name_Use                            : constant Name_Id := N + 499;
   Name_When                           : constant Name_Id := N + 500;
   Name_While                          : constant Name_Id := N + 501;
   Name_With                           : constant Name_Id := N + 502;
   Name_Xor                            : constant Name_Id := N + 503;
   ...
   First_Intrinsic_Name                : constant Name_Id := N + 504;
   Name_Divide                         : constant Name_Id := N + 504;
   Name_Enclosing_Entity               : constant Name_Id := N + 505;
   Name_Exception_Information          : constant Name_Id := N + 506;
   Name_Exception_Message              : constant Name_Id := N + 507;
   Name_Exception_Name                 : constant Name_Id := N + 508;
   Name_File                           : constant Name_Id := N + 509;
   Name_Import_Address                 : constant Name_Id := N + 510;
   Name_Import_Largest_Value           : constant Name_Id := N + 511;
   Name_Import_Value                   : constant Name_Id := N + 512;
   Name_Is_Negative                    : constant Name_Id := N + 513;
   Name_Line                           : constant Name_Id := N + 514;
   Name_Rotate_Left                    : constant Name_Id := N + 515;
   Name_Rotate_Right                   : constant Name_Id := N + 516;
   Name_Shift_Left                     : constant Name_Id := N + 517;
   Name_Shift_Right                    : constant Name_Id := N + 518;
   Name_Shift_Right_Arithmetic         : constant Name_Id := N + 519;
   Name_Source_Location                : constant Name_Id := N + 520;
   Name_Unchecked_Conversion           : constant Name_Id := N + 521;
   Name_Unchecked_Deallocation         : constant Name_Id := N + 522;
   Last_Intrinsic_Name                 : constant Name_Id := N + 522;

   --  Reserved words used only in Ada 95

   First_95_Reserved_Word              : constant Name_Id := N + 523;
   Name_Abstract                       : constant Name_Id := N + 523;
   Name_Aliased                        : constant Name_Id := N + 524;
   Name_Protected                      : constant Name_Id := N + 525;
   Name_Until                          : constant Name_Id := N + 526;
   Name_Requeue                        : constant Name_Id := N + 527;
   Name_Tagged                         : constant Name_Id := N + 528;
   Last_95_Reserved_Word               : constant Name_Id := N + 528;
   ...
   Name_Raise_Exception                : constant Name_Id := N + 529;

   --  Additional reserved words in GNAT Project Files
   --  Note that Name_External is already previously declared

   Name_Binder                         : constant Name_Id := N + 530;
   Name_Builder                        : constant Name_Id := N + 531;
   Name_Compiler                       : constant Name_Id := N + 532;
   Name_Cross_Reference                : constant Name_Id := N + 533;
   Name_Default_Switches               : constant Name_Id := N + 534;
   Name_Exec_Dir                       : constant Name_Id := N + 535;
   Name_Extends                        : constant Name_Id := N + 536;
   Name_Finder                         : constant Name_Id := N + 537;
   Name_Gnatls                         : constant Name_Id := N + 538;
   Name_Pretty_Printer                 : constant Name_Id := N + 539;
   Name_Implementation                 : constant Name_Id := N + 540;
   Name_Implementation_Exceptions      : constant Name_Id := N + 541;
   Name_Implementation_Suffix          : constant Name_Id := N + 542;
   Name_Languages                      : constant Name_Id := N + 543;
   Name_Library_Dir                    : constant Name_Id := N + 544;
   Name_Library_Elaboration            : constant Name_Id := N + 545;
   Name_Library_Kind                   : constant Name_Id := N + 546;
   Name_Library_Name                   : constant Name_Id := N + 547;
   Name_Library_Version                : constant Name_Id := N + 548;
   Name_Linker                         : constant Name_Id := N + 549;
   Name_Naming                         : constant Name_Id := N + 550;
   Name_Object_Dir                     : constant Name_Id := N + 551;
   Name_Project                        : constant Name_Id := N + 552;
   Name_Separate_Suffix                : constant Name_Id := N + 553;
   Name_Source_Dirs                    : constant Name_Id := N + 554;
   Name_Source_Files                   : constant Name_Id := N + 555;
   Name_Source_List_File               : constant Name_Id := N + 556;
   Name_Specification                  : constant Name_Id := N + 557;
   Name_Specification_Exceptions       : constant Name_Id := N + 558;
   Name_Specification_Suffix           : constant Name_Id := N + 559;
   Name_Switches                       : constant Name_Id := N + 560;
   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 560;
