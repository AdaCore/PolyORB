...
--  definitions in this file and must be kept properly synchronized.
   ...
   Name_Get_Active_Partition_ID        : constant Name_Id := N + 074;
   Name_Get_RCI_Package_Receiver       : constant Name_Id := N + 075;
   ...
   Name_Partition_Interface            : constant Name_Id := N + 080;
   Name_Ras                            : constant Name_Id := N + 081;
   Name_Call                           : constant Name_Id := N + 082;
   Name_RCI_Name                       : constant Name_Id := N + 083;
   Name_Receiver                       : constant Name_Id := N + 084;
   Name_Result                         : constant Name_Id := N + 085;
   Name_Rpc                            : constant Name_Id := N + 086;
   Name_Subp_Id                        : constant Name_Id := N + 087;
   Name_Operation                      : constant Name_Id := N + 088;
   Name_Argument                       : constant Name_Id := N + 089;
   Name_Arg_Modes                      : constant Name_Id := N + 090;
   Name_Handler                        : constant Name_Id := N + 091;
   Name_Target                         : constant Name_Id := N + 092;
   Name_Req                            : constant Name_Id := N + 093;
   Name_Obj_TypeCode                   : constant Name_Id := N + 094;
   ...
   Name_C_Pass_By_Copy                 : constant Name_Id := N + 116; -- GNAT
   Name_Component_Alignment            : constant Name_Id := N + 117; -- GNAT
   Name_Convention_Identifier          : constant Name_Id := N + 118; -- GNAT
   Name_Discard_Names                  : constant Name_Id := N + 119;
   Name_Elaboration_Checks             : constant Name_Id := N + 120; -- GNAT
   Name_Eliminate                      : constant Name_Id := N + 121; -- GNAT
   ...
   Name_Style_Checks                   : constant Name_Id := N + 141; -- GNAT
   Name_Suppress                       : constant Name_Id := N + 142;
   Name_Task_Dispatching_Policy        : constant Name_Id := N + 143;
   ...
   Name_Validity_Checks                : constant Name_Id := N + 147; -- GNAT
   ...
   Name_Optimize                       : constant Name_Id := N + 205;
   Name_Pack                           : constant Name_Id := N + 206;
   Name_Page                           : constant Name_Id := N + 207;
   Name_Passive                        : constant Name_Id := N + 208; -- GNAT
   Name_Preelaborate                   : constant Name_Id := N + 209;
   Name_Priority                       : constant Name_Id := N + 210;
   Name_Psect_Object                   : constant Name_Id := N + 211; -- VMS
   Name_Pure                           : constant Name_Id := N + 212;
   Name_Pure_Function                  : constant Name_Id := N + 213; -- GNAT
   Name_Remote_Call_Interface          : constant Name_Id := N + 214;
   Name_Remote_Types                   : constant Name_Id := N + 215;
   Name_Share_Generic                  : constant Name_Id := N + 216; -- GNAT
   Name_Shared                         : constant Name_Id := N + 217; -- Ada 83
   Name_Shared_Passive                 : constant Name_Id := N + 218;
   ...
   Name_Source_Reference               : constant Name_Id := N + 219; -- GNAT
   Name_Stream_Convert                 : constant Name_Id := N + 220; -- GNAT
   Name_Subtitle                       : constant Name_Id := N + 221; -- GNAT
   Name_Suppress_All                   : constant Name_Id := N + 222; -- GNAT
   Name_Suppress_Debug_Info            : constant Name_Id := N + 223; -- GNAT
   Name_Suppress_Initialization        : constant Name_Id := N + 224; -- GNAT
   Name_System_Name                    : constant Name_Id := N + 225; -- Ada 83
   Name_Task_Info                      : constant Name_Id := N + 226; -- GNAT
   Name_Task_Name                      : constant Name_Id := N + 227; -- GNAT
   Name_Task_Storage                   : constant Name_Id := N + 228; -- VMS
   Name_Time_Slice                     : constant Name_Id := N + 229; -- GNAT
   Name_Title                          : constant Name_Id := N + 230; -- GNAT
   Name_Unchecked_Union                : constant Name_Id := N + 231; -- GNAT
   Name_Unimplemented_Unit             : constant Name_Id := N + 232; -- GNAT
   Name_Universal_Data                 : constant Name_Id := N + 233; -- AAMP
   Name_Unreferenced                   : constant Name_Id := N + 234; -- GNAT
   Name_Unreserve_All_Interrupts       : constant Name_Id := N + 235; -- GNAT
   Name_Volatile                       : constant Name_Id := N + 236;
   Name_Volatile_Components            : constant Name_Id := N + 237;
   Name_Weak_External                  : constant Name_Id := N + 238; -- GNAT
   Last_Pragma_Name                    : constant Name_Id := N + 238;
   ...
   First_Convention_Name               : constant Name_Id := N + 239;
   Name_Ada                            : constant Name_Id := N + 239;
   Name_Assembler                      : constant Name_Id := N + 240;
   Name_COBOL                          : constant Name_Id := N + 241;
   Name_CPP                            : constant Name_Id := N + 242;
   Name_Fortran                        : constant Name_Id := N + 243;
   Name_Intrinsic                      : constant Name_Id := N + 244;
   Name_Java                           : constant Name_Id := N + 245;
   Name_Stdcall                        : constant Name_Id := N + 246;
   Name_Stubbed                        : constant Name_Id := N + 247;
   Last_Convention_Name                : constant Name_Id := N + 247;

   --  The following names are preset as synonyms for Assembler

   Name_Asm                            : constant Name_Id := N + 248;
   Name_Assembly                       : constant Name_Id := N + 249;

   --  The following names are preset as synonyms for C

   Name_Default                        : constant Name_Id := N + 250;
   --  Name_Exernal (previously defined as pragma)

   --  The following names are present as synonyms for Stdcall

   Name_DLL                            : constant Name_Id := N + 251;
   Name_Win32                          : constant Name_Id := N + 252;

   --  Other special names used in processing pragma arguments

   Name_As_Is                          : constant Name_Id := N + 253;
   Name_Body_File_Name                 : constant Name_Id := N + 254;
   Name_Casing                         : constant Name_Id := N + 255;
   Name_Code                           : constant Name_Id := N + 256;
   Name_Component                      : constant Name_Id := N + 257;
   Name_Component_Size_4               : constant Name_Id := N + 258;
   Name_Copy                           : constant Name_Id := N + 259;
   Name_D_Float                        : constant Name_Id := N + 260;
   Name_Descriptor                     : constant Name_Id := N + 261;
   Name_Dot_Replacement                : constant Name_Id := N + 262;
   Name_Dynamic                        : constant Name_Id := N + 263;
   Name_Entity                         : constant Name_Id := N + 264;
   Name_External_Name                  : constant Name_Id := N + 265;
   Name_First_Optional_Parameter       : constant Name_Id := N + 266;
   Name_Form                           : constant Name_Id := N + 267;
   Name_G_Float                        : constant Name_Id := N + 268;
   Name_Gcc                            : constant Name_Id := N + 269;
   Name_Gnat                           : constant Name_Id := N + 270;
   Name_GPL                            : constant Name_Id := N + 271;
   Name_IEEE_Float                     : constant Name_Id := N + 272;
   Name_Homonym_Number                 : constant Name_Id := N + 273;
   Name_Internal                       : constant Name_Id := N + 274;
   Name_Link_Name                      : constant Name_Id := N + 275;
   Name_Lowercase                      : constant Name_Id := N + 276;
   Name_Max_Size                       : constant Name_Id := N + 277;
   Name_Mechanism                      : constant Name_Id := N + 278;
   Name_Mixedcase                      : constant Name_Id := N + 279;
   Name_Modified_GPL                   : constant Name_Id := N + 280;
   Name_Name                           : constant Name_Id := N + 281;
   Name_NCA                            : constant Name_Id := N + 282;
   Name_No                             : constant Name_Id := N + 283;
   Name_On                             : constant Name_Id := N + 284;
   Name_Parameter_Types                : constant Name_Id := N + 285;
   Name_Reference                      : constant Name_Id := N + 286;
   Name_Restricted                     : constant Name_Id := N + 287;
   Name_Result_Mechanism               : constant Name_Id := N + 288;
   Name_Result_Type                    : constant Name_Id := N + 289;
   Name_Runtime                        : constant Name_Id := N + 290;
   Name_SB                             : constant Name_Id := N + 291;
   Name_Section                        : constant Name_Id := N + 292;
   Name_Semaphore                      : constant Name_Id := N + 293;
   Name_Spec_File_Name                 : constant Name_Id := N + 294;
   Name_Static                         : constant Name_Id := N + 295;
   Name_Stack_Size                     : constant Name_Id := N + 296;
   Name_Subunit_File_Name              : constant Name_Id := N + 297;
   Name_Task_Stack_Size_Default        : constant Name_Id := N + 298;
   Name_Task_Type                      : constant Name_Id := N + 299;
   Name_Time_Slicing_Enabled           : constant Name_Id := N + 300;
   Name_Top_Guard                      : constant Name_Id := N + 301;
   Name_UBA                            : constant Name_Id := N + 302;
   Name_UBS                            : constant Name_Id := N + 303;
   Name_UBSB                           : constant Name_Id := N + 304;
   Name_Unit_Name                      : constant Name_Id := N + 305;
   Name_Unknown                        : constant Name_Id := N + 306;
   Name_Unrestricted                   : constant Name_Id := N + 307;
   Name_Uppercase                      : constant Name_Id := N + 308;
   Name_User                           : constant Name_Id := N + 309;
   Name_VAX_Float                      : constant Name_Id := N + 310;
   Name_VMS                            : constant Name_Id := N + 311;
   Name_Working_Storage                : constant Name_Id := N + 312;
   ...
   First_Attribute_Name                : constant Name_Id := N + 313;
   Name_Abort_Signal                   : constant Name_Id := N + 313;  -- GNAT
   Name_Access                         : constant Name_Id := N + 314;
   Name_Address                        : constant Name_Id := N + 315;
   Name_Address_Size                   : constant Name_Id := N + 316;  -- GNAT
   Name_Aft                            : constant Name_Id := N + 317;
   Name_Alignment                      : constant Name_Id := N + 318;
   Name_Asm_Input                      : constant Name_Id := N + 319;  -- GNAT
   Name_Asm_Output                     : constant Name_Id := N + 320;  -- GNAT
   Name_AST_Entry                      : constant Name_Id := N + 321;  -- VMS
   Name_Bit                            : constant Name_Id := N + 322;  -- GNAT
   Name_Bit_Order                      : constant Name_Id := N + 323;
   Name_Bit_Position                   : constant Name_Id := N + 324;  -- GNAT
   Name_Body_Version                   : constant Name_Id := N + 325;
   Name_Callable                       : constant Name_Id := N + 326;
   Name_Caller                         : constant Name_Id := N + 327;
   Name_Code_Address                   : constant Name_Id := N + 328;  -- GNAT
   Name_Component_Size                 : constant Name_Id := N + 329;
   Name_Compose                        : constant Name_Id := N + 330;
   Name_Constrained                    : constant Name_Id := N + 331;
   Name_Count                          : constant Name_Id := N + 332;
   Name_Default_Bit_Order              : constant Name_Id := N + 333; -- GNAT
   Name_Definite                       : constant Name_Id := N + 334;
   Name_Delta                          : constant Name_Id := N + 335;
   Name_Denorm                         : constant Name_Id := N + 336;
   Name_Digits                         : constant Name_Id := N + 337;
   Name_Elaborated                     : constant Name_Id := N + 338; -- GNAT
   Name_Emax                           : constant Name_Id := N + 339; -- Ada 83
   Name_Enum_Rep                       : constant Name_Id := N + 340; -- GNAT
   Name_Epsilon                        : constant Name_Id := N + 341; -- Ada 83
   Name_Exponent                       : constant Name_Id := N + 342;
   Name_External_Tag                   : constant Name_Id := N + 343;
   Name_First                          : constant Name_Id := N + 344;
   Name_First_Bit                      : constant Name_Id := N + 345;
   Name_Fixed_Value                    : constant Name_Id := N + 346; -- GNAT
   Name_Fore                           : constant Name_Id := N + 347;
   Name_Has_Discriminants              : constant Name_Id := N + 348; -- GNAT
   Name_Identity                       : constant Name_Id := N + 349;
   Name_Img                            : constant Name_Id := N + 350; -- GNAT
   Name_Integer_Value                  : constant Name_Id := N + 351; -- GNAT
   Name_Large                          : constant Name_Id := N + 352; -- Ada 83
   Name_Last                           : constant Name_Id := N + 353;
   Name_Last_Bit                       : constant Name_Id := N + 354;
   Name_Leading_Part                   : constant Name_Id := N + 355;
   Name_Length                         : constant Name_Id := N + 356;
   Name_Machine_Emax                   : constant Name_Id := N + 357;
   Name_Machine_Emin                   : constant Name_Id := N + 358;
   Name_Machine_Mantissa               : constant Name_Id := N + 359;
   Name_Machine_Overflows              : constant Name_Id := N + 360;
   Name_Machine_Radix                  : constant Name_Id := N + 361;
   Name_Machine_Rounds                 : constant Name_Id := N + 362;
   Name_Machine_Size                   : constant Name_Id := N + 363; -- GNAT
   Name_Mantissa                       : constant Name_Id := N + 364; -- Ada 83
   Name_Max_Size_In_Storage_Elements   : constant Name_Id := N + 365;
   Name_Maximum_Alignment              : constant Name_Id := N + 366; -- GNAT
   Name_Mechanism_Code                 : constant Name_Id := N + 367; -- GNAT
   Name_Model_Emin                     : constant Name_Id := N + 368;
   Name_Model_Epsilon                  : constant Name_Id := N + 369;
   Name_Model_Mantissa                 : constant Name_Id := N + 370;
   Name_Model_Small                    : constant Name_Id := N + 371;
   Name_Modulus                        : constant Name_Id := N + 372;
   Name_Null_Parameter                 : constant Name_Id := N + 373; -- GNAT
   Name_Object_Size                    : constant Name_Id := N + 374; -- GNAT
   Name_Partition_ID                   : constant Name_Id := N + 375;
   Name_Passed_By_Reference            : constant Name_Id := N + 376; -- GNAT
   Name_Pos                            : constant Name_Id := N + 377;
   Name_Position                       : constant Name_Id := N + 378;
   Name_Range                          : constant Name_Id := N + 379;
   Name_Range_Length                   : constant Name_Id := N + 380; -- GNAT
   Name_Round                          : constant Name_Id := N + 381;
   Name_Safe_Emax                      : constant Name_Id := N + 382; -- Ada 83
   Name_Safe_First                     : constant Name_Id := N + 383;
   Name_Safe_Large                     : constant Name_Id := N + 384; -- Ada 83
   Name_Safe_Last                      : constant Name_Id := N + 385;
   Name_Safe_Small                     : constant Name_Id := N + 386; -- Ada 83
   Name_Scale                          : constant Name_Id := N + 387;
   Name_Scaling                        : constant Name_Id := N + 388;
   Name_Signed_Zeros                   : constant Name_Id := N + 389;
   Name_Size                           : constant Name_Id := N + 390;
   Name_Small                          : constant Name_Id := N + 391;
   Name_Storage_Size                   : constant Name_Id := N + 392;
   Name_Storage_Unit                   : constant Name_Id := N + 393; -- GNAT
   Name_Subtype_Alignment              : constant Name_Id := N + 394; -- GNAT
   Name_Tag                            : constant Name_Id := N + 395;
   Name_Terminated                     : constant Name_Id := N + 396;
   Name_To_Address                     : constant Name_Id := N + 397; -- GNAT
   Name_Type_Class                     : constant Name_Id := N + 398; -- GNAT
   Name_UET_Address                    : constant Name_Id := N + 399; -- GNAT
   Name_Unbiased_Rounding              : constant Name_Id := N + 400;
   Name_Unchecked_Access               : constant Name_Id := N + 401;
   ...
   Last_Intrinsic_Name                 : constant Name_Id := N + 534;

   --  Reserved words used only in Ada 95

   First_95_Reserved_Word              : constant Name_Id := N + 535;
   Name_Abstract                       : constant Name_Id := N + 535;
   Name_Aliased                        : constant Name_Id := N + 536;
   Name_Protected                      : constant Name_Id := N + 537;
   Name_Until                          : constant Name_Id := N + 538;
   Name_Requeue                        : constant Name_Id := N + 539;
   Name_Tagged                         : constant Name_Id := N + 540;
   Last_95_Reserved_Word               : constant Name_Id := N + 540;
   ...
   Name_Raise_Exception                : constant Name_Id := N + 541;

   --  Additional reserved words in GNAT Project Files
   --  Note that Name_External is already previously declared

   Name_Binder                         : constant Name_Id := N + 542;
   Name_Builder                        : constant Name_Id := N + 543;
   Name_Compiler                       : constant Name_Id := N + 544;
   Name_Cross_Reference                : constant Name_Id := N + 545;
   Name_Default_Switches               : constant Name_Id := N + 546;
   Name_Exec_Dir                       : constant Name_Id := N + 547;
   ...
   Name_Library_Elaboration            : constant Name_Id := N + 557;
   Name_Library_Kind                   : constant Name_Id := N + 558;
   Name_Library_Name                   : constant Name_Id := N + 559;
   Name_Library_Version                : constant Name_Id := N + 560;
   Name_Linker                         : constant Name_Id := N + 561;
   Name_Naming                         : constant Name_Id := N + 562;
   Name_Object_Dir                     : constant Name_Id := N + 563;
   Name_Pretty_Printer                 : constant Name_Id := N + 564;
   Name_Project                        : constant Name_Id := N + 565;
   Name_Separate_Suffix                : constant Name_Id := N + 566;
   Name_Source_Dirs                    : constant Name_Id := N + 567;
   Name_Source_Files                   : constant Name_Id := N + 568;
   Name_Source_List_File               : constant Name_Id := N + 569;
   Name_Specification                  : constant Name_Id := N + 570;
   Name_Specification_Exceptions       : constant Name_Id := N + 571;
   Name_Specification_Suffix           : constant Name_Id := N + 572;
   Name_Switches                       : constant Name_Id := N + 573;
   --  Mark last defined name for consistency check in Snames body

   Last_Predefined_Name                : constant Name_Id := N + 573;
