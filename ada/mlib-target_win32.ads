...
package MLib.Target is
   ...
   Dynamic_Option      : constant String := "-mdll";
   --  gcc option to create a dynamic library

   Base_Option         : constant String := "-Wl,--base-file";
   ...
   Def_Ext             : constant String := "def";
   --  System dependent export definition file extension

   PIC_Option          : constant String := "";
